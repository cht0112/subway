...
_xbl_JSClassDefine_window.prototype.__code__={v:{name:'_xbl_JSClassDefine_window',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'16bf09ed656e76b2ab3f981ab25630a1'};
...
_xbl_JSClassDefine_windowDialog.prototype.__code__={v:{name:'_xbl_JSClassDefine_windowDialog',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'f74916b0fcc57cd10546520461360e25'};
...
_xbl_JSClassDefine_menu.prototype.__code__={v:{name:'_xbl_JSClassDefine_menu',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'11c687ef267a34b44b163ea06b964fe6'};
...
_xbl_JSClassDefine_tableLayout.prototype.__code__={v:{name:'_xbl_JSClassDefine_tableLayout',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'4c3722c9cef463f2f87f8e0e34ec86c3'};
...
_xbl_JSClassDefine_toolbars.prototype.__code__={v:{name:'_xbl_JSClassDefine_toolbars',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'394fdece7eae07d3f9a097167700396b'};
...
_xbl_JSClassDefine_splitter.prototype.__code__={v:{name:'_xbl_JSClassDefine_splitter',key:'e6032235fb34a320c155c5894a4d1bd0',time:1528696786},m:'7a7b7bc9e7ad209996d767ca28a9e672'};
			...
			"show": function(data, callBack) {
				...
				if (filterData) {
					if (typeof(filterData.advanceFilter) != "undefined") {
						...
						if(dialog) {var frameEl = justep(this.iframeId);
							if (frameEl) {
...
new xforms.XFDialog('GLOBAL_ID_1620298459',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_8=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_N406758378');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_N406758378", "");}));xf._p(justep('GLOBAL_ID_1620298459'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_8,'GLOBAL_ID_1620298459', evt,false)});	
...
var xf_menu_newItemsMenu = new xforms.XFMenu('newItemsMenu','context');xf_menu_newItemsMenu.menu.addContextZone('8d24f792b3904882ba6e85f5dc113090');xforms.Event.attach(document.body, "click", function(){xf_menu_newItemsMenu.hide()});xf_menu_newItemsMenu.menu.setOpenMode('win');	
...
var xf_trigger_btnEdit=new xforms.XFTrigger('btnEdit',null,"/UI/SA/OPM/images/edit.gif","/UI/SA/OPM/images/un_edit.gif",false,false,false,null,null,null);	
...
var xf_trigger_btnLogicDelete=new xforms.XFTrigger('btnLogicDelete',null,"/UI/SA/OPM/images/logicDelete.gif","/UI/SA/OPM/images/un_logicDelete.gif",false,false,false,null,null,null);	
...
var xf_trigger_btnSort=new xforms.XFTrigger('btnSort',null,"/UI/SA/OPM/images/sort.gif","/UI/SA/OPM/images/un_sort.gif",false,false,false,null,null,null);	
...
var xf_trigger_btnMove=new xforms.XFTrigger('btnMove',null,"/UI/SA/OPM/images/moveOrg.gif","/UI/SA/OPM/images/un_moveOrg.gif",false,false,false,null,null,null);	
...
var xf_trigger_btnResetPassword=new xforms.XFTrigger('btnResetPassword',null,"/UI/SA/OPM/images/resetPassword.gif","/UI/SA/OPM/images/un_resetPassword.gif",false,false,false,null,null,null);	
