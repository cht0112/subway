		...
		if(checked){
			...
			for (var i = 0; i < rowIdArray.length; i++) {
				...
				if(!document.getElementById(rowid))
					html = html + "<a class='multi-select-item' id='" + rowid +"' onclick='justep.MultiList.removeRow(this.id)'><i class='icon icon-system-cancel'></i>" + label + "</a>";
			}
...
multiList.filterImgClick = function(event){
	xforms.blur();
