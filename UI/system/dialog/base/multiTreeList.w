...
<window xmlns="http://www.justep.com/xui" xmlns:xu="http://www.xmldb.org/xupdate"
  xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xui="http://www.justep.com/xui"
  xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" extends="multiList.w">  
  ...
  <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData"
    id="treeMain" is-tree="true" limit="-1" offset="0" xui:parent="model" xui:update-mode="insert"/>  
  <xui:layout id="rootLayout" style="height:100%;width:100%" xui:parent="rootView"
    ...
    <xhtml:div border-size="8px" component="/UI/system/components/borderLayout.xbl.xml#borderLayout"
      id="rootTable" style="width:100%; height:100%;"> 
      <center> 
        <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout"
          id="rootTable1" style="width:100%; height:100%;"> 
          <center> 
            <xhtml:div adjust-by-arrow="true" component="/UI/system/components/splitter.xbl.xml#splitter"
              fix-size="35%" has-arrow-button="true" has-drag-bar="true" id="splitter1"
              ...
              <xhtml:div region="right"> 
                <xhtml:div id="rightDiv" style="width:100%; height:100%;"
			        component="/UI/system/components/borderLayout.xbl.xml#borderLayout">
			        <left border-size="2px"></left> 
			        <center id="bl1-cp"> 
			          <xui:place control="toolbarGridView" id="toolbarGridPlacep"/> 
			        </center>  
			      </xhtml:div> 
              </xhtml:div> 
            </xhtml:div> 
  ...
  <xui:view auto-load="true" id="treeView" xui:parent="rootView" xui:update-mode="insert"> 
    <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="quickLocateToolbar"> 
      <xui:bar component="/UI/system/components/customBar.xbl.xml#customBar" id="customBar"> 
        <item> 
          <xhtml:div component="/UI/system/components/quickLocate.xbl.xml#treeLocate"
            data="treeMain" id="treeLocate" style="width:120px;" tree="treeGrid"/> 
        </item> 
      </xui:bar> 
    </xhtml:div>  
    <xhtml:div appearance="tree" component="/UI/system/components/grid.xbl.xml#grid"
      data="treeMain" id="treeGrid" style="border:1px solid #D3D3D3;width:100%;height:100% "> 
      <xui:column id="treeColumn" label="请指定树节点列" readonly="true" ref="" type="tree"
        width="100px"/> 
    </xhtml:div>  
