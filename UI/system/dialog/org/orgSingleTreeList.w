...
<window xmlns="http://www.justep.com/xui" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" extends="/UI/system/dialog/base/singleTreeList.w">  
 
  <data id="main" concept="SA_OPOrg" relations="sName,sParent,sFID,sFName,sValidState,sOrgKindID,sValidState"
    auto-load="false" xui:update-mode="merge"/>  
  ...
  <data id="treeMain" concept="SA_OPOrg" confirm-refresh="false" onAfterRefresh="justep.OrgDialog.refreshOrgAfter"
    relations="sName,sParent,sFID,sFName,sValidState,sOrgKindID,sValidState" auto-load="false"
