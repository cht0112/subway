...
<window xmlns="http://www.justep.com/xui" xmlns:xu="http://www.xmldb.org/xupdate" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xui="http://www.justep.com/xui" 
	xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" extends="/UI/system/dialog/org/orgMultiList.w">
	...
	<xhtml:div component="/UI/system/components/grid.xbl.xml#grid" appearance="tree" id="grid" onShowNodeImg="justep.OrgDialog.showNodeImg" style="width:100%;height:100%;border:1px solid #D3D3D3;" xui:update-mode="replace-and-replace" 
		data="main" multi-selection="true" onRowChecked="justep.MultiList._doCheckRow" onRowCheckedAll="justep.MultiList._doCheckAll">
