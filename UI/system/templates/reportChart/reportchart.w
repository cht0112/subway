  ...
  <view id="view_1" auto-load="true"> 
    <view id="toolbarView" auto-load="true"> 
      <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars_1"> 
        <bar component="/UI/system/components/reportBar.xbl.xml#printBar" report="chart" id="printBar" mode="IMG_TXT_LR"> 
          <item name="report-page-setup-item"/>  
          <item name="report-preview-item"/>  
          <item name="report-print-item"/> 
        </bar>  
        <bar component="/UI/system/components/reportBar.xbl.xml#exportBar" report="chart" id="exportBar" mode="IMG_TXT_LR"> 
    ...
    <view id="chartView" auto-load="true"> 
      <xhtml:div xmlns="" component="/UI/system/components/chart.xbl.xml#chart" id="chart" chart-name="统计图表" auto-load="true" data-list="">  
        <chart> 
          <config></config>  
          <series-set> 
      ...
      <layout id="layout1" type="flow" style="width:100%;height:100%;"> 
        <place control="chart" id="chart_c" style="width:500px;height:375px"/> 
      </layout> 
    </view>  
