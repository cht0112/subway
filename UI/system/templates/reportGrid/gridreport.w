  ...
  <view id="view_1" auto-load="true"> 
    <view id="toolbarView" auto-load="true"> 
      <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars_1"> 
        <bar component="/UI/system/components/reportBar.xbl.xml#printBar" report="gridReport"
          id="printBar" mode="IMG_TXT_LR"> 
        ...
        <bar component="/UI/system/components/reportBar.xbl.xml#exportBar"
          report="gridReport" id="exportBar" mode="IMG_TXT_LR"> 
    ...
    <view id="gridReportView" auto-load="true"> 
