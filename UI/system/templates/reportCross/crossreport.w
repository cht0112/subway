  ...
  <view id="view_1" auto-load="true"> 
    <view id="toolbarView" auto-load="true"> 
      <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars_1"> 
        <bar component="/UI/system/components/reportBar.xbl.xml#printBar" report="crossReport" id="printBar" mode="IMG_TXT_LR"> 
          <item name="report-page-setup-item"/>  
          <item name="report-preview-item"/>  
          <item name="report-print-item"/> 
        </bar>  
        <bar component="/UI/system/components/reportBar.xbl.xml#exportBar" report="crossReport" id="exportBar" mode="IMG_TXT_LR"> 
    ...
    <view id="crossReportView" auto-load="true"> 
      <xhtml:div component="/UI/system/components/report.xbl.xml#report" id="crossReport" src="reports/crossReport.xls" report-name="" auto-load="true" data-list=""/>  
      <layout id="layout1" type="flow" style="width:100%;height:100%;"> 
        <place control="crossReport" id="crossReport_c" style="width:100%;height:100%;"/> 
      </layout> 
    </view>  
    <layout style="height:100%;wight:100%;"> 
          ...
          <xhtml:div id="borderLayout_1" style="height:100%;" component="/UI/system/components/borderLayout.xbl.xml#borderLayout"> 
            ...
            <center> 
              <place control="crossReportView" style="height:100%;width:100%;"/> 
            </center>  
          </xhtml:div> 
