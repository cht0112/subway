  ...
  <xui:view id="rootView" auto-load="true"> 
    <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbar"> 
      ...
      <item> 
        ...
        <item name="separator"/>  
        <item name="filter-pro-item" id="barItem1"></item><item name="custom-page-item" page-count="0" items="pre,next,ext"/> 
      </xui:bar> 
    </xhtml:div>  
    <xhtml:div component="/UI/system/components/windowRunner.xbl.xml#windowRunner" id="detailRunner" onReceive="list.detailRunnerReceive"></xhtml:div><xhtml:div component="/UI/system/components/grid.xbl.xml#grid" id="listGrid"
      data="listData" onRowDblClick="list.listGridRowDblClick" show-header-menu="hide-column,save-layout,group-column,adjust-column"/>  
    <xui:layout style="height:100%;width:100%"> 
     ...
     <xui:place control="detailRunner" id="controlPlace1" style="top:191px;left:87px;"></xui:place>
