...
public class RelationDatasource extends PropertyDatasource {
	...
	public DataSet getDatasource(PropertyItem propertyItem) {
		...
		/*如果是data节点或data的子节点*/
		if((!"dataQ".equals(xuiElement.getName()) && !"data".equals(xuiElement.getName())) && ("data".equals(xuiElement.getConfigAttribute("base-class")) || 
				"data".equals(xuiElement.getParentElement().getConfigAttribute("base-class"))||"dataQ".equals(xuiElement.getConfigAttribute("base-class")) || 
				"dataQ".equals(xuiElement.getParentElement().getConfigAttribute("base-class")))){
