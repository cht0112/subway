...
public class ConceptActionPage extends CommonPropertyEditorPage{
	...
	public void setPropertyItem(PropertyItem propertyItem) {
		...
		if(conceptDs!=null){
			...
			MessageDialog.openInformation(StudioPlugin.getShell(), "提示", "Model加载失败, BIZ"+modelName+"不存在.");
		}
...
//    		}
	...
	public DataSet getConceptDataSet(String modelName){
		...
		try{
			Model model = ModelManager.parseModel(StudioConfig.getBizSrcPath(), modelName);
			...
			for(Model processMod :processUseList){
				...
				Model actionModel = ModelParser.parseModel(StudioConfig.getBizSrcPath(),modName,new HashMap<String,Model>(), true, true,true,null,extSpace);
