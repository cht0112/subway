...
public class CreateExcelDialog extends Composite implements IPropertyDialogPage {
	...
	private void validate() {
		...
		fileName = fileName.contains(".") ? fileName : fileName + ".xls";
...
//			updateStatus(passValidate, errMsg);
		...
		passValidate = true;
		errMsg = null;
		updateStatus(passValidate, "新建XLS文件");
	}
	...
	public void setPropertyItem(PropertyItem propertyItem) {
		...
		String uiSrcPath = StudioConfig.getUISrcPath();
		parentPath = "/UI" + parentPath.replace(uiSrcPath, "");
