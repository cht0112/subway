...
justep.design.NumberSelect = function(config){ 
	justep.design.NumberSelect.superclass.constructor.call(this,config);
}

justep.extend(justep.design.NumberSelect, justep.design.Component,{
