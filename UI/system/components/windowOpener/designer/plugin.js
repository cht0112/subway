justep.design.WindowOpener = function(config){ 
	justep.design.WindowOpener.superclass.constructor.call(this,config);
	this.resizable=false; 
}

justep.extend(justep.design.WindowOpener, justep.design.Component,{
