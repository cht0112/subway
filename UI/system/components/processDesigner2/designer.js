justep.ProcessDesigner2 = function(xblObject){
	...
	loadTemplate : function(){
		...
		dialog.open({"type": "PROCESS_TEMPLATE", "process":xblObject.getProcess()}, new justep.Message(justep.Message.JUSTEP230056).getMessage());
	}};
	this._designer = new justep.graphics.ProcessWebCanvas(param);
};

justep.ProcessDesigner2.prototype._addListener = function(name, funname, xblObject){
...
justep.ProcessDesigner2.prototype.getProcess = function(){
	return this._process;
};

justep.ProcessDesigner2.prototype._getSelectProcessTemplateDialog = function(){
	var self = this;
...
justep.ProcessDesigner2.prototype._getSelectExecutorDialog = function(container){
...
justep.ProcessDesigner2.prototype._loadProcess = function(){
	var param = new justep.Request.ActionParam();
	param.setString("process", this._process);
	var action = "queryProcessDefine2Action";
	var options = {};
...
justep.ProcessDesigner2.prototype.init = function(process){
	this._process = process;
	this._designer.initToolbox(this._getActivities());
};

justep.ProcessDesigner2.prototype.setData = function(id, data){
	if ((data[0] == null) || (data[0] == undefined) || (data[0].length==0)){
		data[0] = '<model  xmlns="http://www.justep.com/model"><template name="' + id 
			+ '" process="' + this._process.substr(this._process.lastIndexOf('/')+1) + '"/></model>';
	}
...
justep.ProcessDesigner2.prototype.getData = function(){
	return this._designer.getData();
};


justep.ProcessDesigner2.prototype._getActivities = function(){
	var param = new justep.Request.ActionParam();
	var action = "queryCustomizedRange3Action";
	param.setString("process", this._process);
