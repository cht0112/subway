...
justep.Pagination = function(config){
	...
	this.firstLabel = this.firstLabel || (new justep.Message(justep.Message.JUSTEP231064)).getMessage(); 
	this.preLabel = this.preLabel || (new justep.Message(justep.Message.JUSTEP231015)).getMessage(); 
	this.nextLabel = this.nextLabel || (new justep.Message(justep.Message.JUSTEP231014)).getMessage(); 
	this.lastLabel = this.lastLabel || (new justep.Message(justep.Message.JUSTEP231065)).getMessage();
