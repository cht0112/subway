...
(function () {
    ...
    function loadNextPageImages(){
        var list = g("imageList");
        list.style.display = "";

        ajax.request(editor.options.imageManagerUrl+'&index='+list.pageIndex++, {
        	timeout:100000,
        	action:"get",
        	onsuccess:function (xhr) {
        		...
        		if(!list.children.length) g("imageList").innerHTML = !length ? "&nbsp;&nbsp;" + lang.noUploadImage : "";
        		if(length!=20) g("imgNextPageBtn").disabled = true;
    ...
    function addSearchListener() {
        g("imgNextPageBtn").onclick = function () {
            loadNextPageImages();
        };
