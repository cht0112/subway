...
//    }
    ...
    me.addInputRule(function(root){
        utils.each(root.getNodesByTagName('u s del'),function(node){
    ...
    UE.commands['inserttable'] = {
        ...
        execCommand: function (cmd, opt) {
            function createTable(opt, tableWidth, tdWidth) {
                ...
                return '<table class="default-border" width="' + tableWidth + '"   ><tbody>' + html.join('') + '</tbody></table>'
            }
