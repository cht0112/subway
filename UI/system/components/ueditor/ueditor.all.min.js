...
Db)},setShow:function(noFocus){var a=this.selection.getRange();if("none"==this.container.style.display){try{a.moveToBookmark(this.lastBk),delete this.lastBk}catch(b){a.setStartAtFirst(this.body).collapse(!0)}if(!noFocus){setTimeout(function(){a.select(!0)},100);};this.container.style.display=""}},show:function(noFocus){return this.setShow(noFocus)},setHide:function(){this.lastBk||(this.lastBk=this.selection.getRange().createBookmark(!0));this.container.style.display="none"},hide:function(){return this.setHide()},getLang:function(a){var b=
...
!0),c=O.getDefaultValue(this,void 0),d=Kb(this,!0,c)-(d?parseInt(f.getXY(d).x,10):0),c=Math.floor(d/b.numCols-2*c.tdPadding-c.tdBorder);!b.tdvalign&&(b.tdvalign=this.options.tdvalign);this.execCommand("inserthtml",function(a,b,c){for(var d=[],l=a.numRows,k=a.numCols,m=0;m<l;m++){d.push("<tr>");for(var p=0;p<k;p++)d.push('<td width="'+c+'"  vAlign="'+a.tdvalign+'" >'+(n.ie?f.fillChar:"<br/>")+"</td>");d.push("</tr>")}return'<table class="default-border" width="'+b+'"   ><tbody>'+d.join("")+"</tbody></table>"}(b,d,c))}};
...
0});this.editor.setHeight(a.height-this.getDom("toolbarbox").offsetHeight-this.getDom("bottombar").offsetHeight-(this.editor.options.topOffset||0));if(n.gecko)try{window.onresize()}catch(e){}}},_updateElementPath:function(){var a=this.getDom("elementpath"),b;if(this.elementPathEnabled&&(b=this.editor.queryCommandValue("elementpath"))){for(var c=[],d=0,e;e=b[d];d++)c[d]=this.formatHtml('<span unselectable="on" onclick="$$.editor.execCommand(&quot;elementpath&quot;, &quot;'+d+'&quot;);">'+e+"</span>");a.innerHTML=
