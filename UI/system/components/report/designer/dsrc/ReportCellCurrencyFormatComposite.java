...
private void showSample(){
		...
		String str = "12,345.123456789012345678901234567890";
		
		str = str.substring(0,7+(this.decimal==0?(-1):this.decimal));
		...
		if(unitStr.equals("￥")||unitStr.equals("$")){
			str= unitStr+str;
		}else{
			str = unitStr+" "+str;
		}
		
		if(negativeIndex==2||negativeIndex==3){
			str = "("+str+")";
		}
		if(negativeIndex==1||negativeIndex==3||negativeIndex==4){
			simpleLabel.setForeground(new org.eclipse.swt.graphics.Color(this.getDisplay(), 255,0,0));
		}else{
			simpleLabel.setForeground(new org.eclipse.swt.graphics.Color(this.getDisplay(), 0,0,0));
		}
