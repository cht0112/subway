...
justep.design.DateFilter = function(config){ 
	justep.design.DateFilter.superclass.constructor.call(this,config);
}

justep.extend(justep.design.DateFilter, justep.design.Component,{
