...
public class ChartBarDataComposite extends Composite implements IChartComposite{
	...
	public ChartBarDataComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		label.setLayoutData(new GridData(521, 23));
		label.setText("数据轴");
		...
		gd_text_serie_title.widthHint = 249;
		...
		gd_combo_serie_title_fontName.widthHint = 53;
		...
		gd_combo_serie_title_fontSize.widthHint = 34;
		...
		gd_text_serie_title_color.widthHint = 40;
		...
		button_text_serie_title_color.setLayoutData(new GridData());
		...
		gd_combo_serie_tick_label_fontName.widthHint = 63;
		...
		gd_combo_serie_tick_label_fontStyle.widthHint = 40;
		...
		gd_combo_serie_tick_label_fontSize.widthHint = 25;
		...
		label_16.setText("数值格式：");

		text_serie_number_format = new Text(group_3, SWT.BORDER);
		text_serie_number_format.setToolTipText("刻度值数据格式");
	...
	public void registerEvent() {
		...
		button_text_serie_tick_label_fontColor.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				ColorDialog dlg = new ColorDialog(shell);
				dlg.setRGB(text_serie_tick_label_fontColor.getBackground().getRGB());
				dlg.setText("颜色选择框");
				RGB rgb = dlg.open();
				if (rgb != null) {
					Color color = new Color(shell.getDisplay(), rgb);
