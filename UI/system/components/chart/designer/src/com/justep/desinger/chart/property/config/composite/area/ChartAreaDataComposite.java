...
public class ChartAreaDataComposite extends Composite implements IChartComposite{
	...
	public ChartAreaDataComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		gd_combo_serie_title_fontName.widthHint = 62;
		...
		button_serie_number_auto_visible.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 6, 1));
		...
		gd_combo_serie_tick_label_fontName.widthHint = 57;
