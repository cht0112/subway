...
public class ChartLineClassComposite extends Composite implements IChartComposite{
	...
	public ChartLineClassComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		label.setLayoutData(new GridData(476, 21));
		label.setText("分类轴");
		...
		gd_combo_category_title_fontName.widthHint = 56;
		...
		gd_combo_category_title_fontStyle.widthHint = 37;
		...
		gd_text_category_title_color.widthHint = 32;
		...
		final GridData gd_group_2 = new GridData(SWT.FILL, SWT.CENTER, false, false);
		gd_group_2.heightHint = 76;
		...
		gd_combo_category_margin.widthHint = 61;
		...
		gd_combo_category_upper_margin.widthHint = 36;
		...
		gd_text_category_label_max_width.widthHint = 24;
		...
		gd_combo_tick_label_fontName.widthHint = 47;
		...
		gd_combo_tick_label_fontStyle.widthHint = 25;
		...
		gd_combo_tick_label_fontColor.widthHint = 29;
		...
		gd_combo_category_item_label_fontName.widthHint = 56;
		...
		combo_category_item_label_fontSize.select(5);
		final GridData gd_combo_category_item_label_fontSize = new GridData(SWT.FILL, SWT.CENTER, true, false);
		gd_combo_category_item_label_fontSize.widthHint = 39;
		combo_category_item_label_fontSize.setLayoutData(gd_combo_category_item_label_fontSize);
