...
public class ChartLineDataComposite extends Composite implements IChartComposite{
	...
	public ChartLineDataComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		gd_combo_serie_title_fontName.widthHint = 65;
		...
		gd_text_serie_title_color.widthHint = 32;
		...
		gd_combo_serie_tick_label_fontName.widthHint = 54;
