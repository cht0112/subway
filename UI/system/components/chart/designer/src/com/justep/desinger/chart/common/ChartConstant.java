...
public class ChartConstant {
	...
	private final static String PIE_IMAGE_PATH[][] = {
		{"/images/pie/pie.gif","pie"},
		{"/images/pie/pie3d.gif","pie-3d"}
	};
	private final static String BAR_IMAGE_PATH[][] = {
		{"/images/bar/vertical_bar.gif","vertical-bar"},
		{"/images/bar/vertical_bar_3d.gif","vertical-bar-3d"},
		{"/images/bar/stacked_vertical_bar.gif","stacked-vertical-bar"},
		{"/images/bar/stacked_vertical_bar_3d.gif","stacked-vertical-bar-3d"},
		{"/images/bar/cylinder_vertical_bar.gif","cylinder-vertical-bar"},
		{"/images/bar/cylinder_vertical_bar_3d.gif","cylinder-vertical-bar-3d"},
		{"/images/bar/horizontal_bar.gif","horizontal-bar"},
		{"/images/bar/horizontal_bar_3d.gif","horizontal-bar-3d"},
		{"/images/bar/stacked_horizontal_bar.gif","stacked-horizontal-bar"},
		{"/images/bar/stacked_horizontal_bar_3d.gif","stacked-horizontal-bar-3d"},
		{"/images/bar/cylinder_horizontal_bar.gif","cylinder-horizontal-bar"},
		{"/images/bar/cylinder_horizontal_bar_3d.gif","cylinder-horizontal-bar-3d"}
	};
	private final static String LINE_IMAGE_PATH[][] = {
		{"/images/line/vertical_line.gif","vertical-line"},
		{"/images/line/vertical_line_3d.gif","vertical-line-3d"},
		{"/images/line/horizontal_line.gif","horizontal-line"},
		{"/images/line/horizontal_line_3d.gif","horizontal-line-3d"}
	};
	private final static String XYLINE_IMAGE_PATH[][] = {
		{"/images/xyline/vertical_xyline.gif","vertical-xy-line"},
		{"/images/xyline/horizontal_xyline.gif","horizontal-xy-line"}
	};
	private final static String AREA_IMAGE_PATH[][] = {
		{"/images/area/vertical_area.gif","vertical-area"},
		{"/images/area/horizontal_area.gif","horizontal-area"}		
	};
	private final static String TIME_IMAGE_PATH[][] = {
		{"/images/time/time_series.gif","time-series"}
	};
	private final static String METER_IMAGE_PATH[][] = {
		{"/images/meter/simple_meter.gif","simple-meter"},
		{"/images/meter/dial_meter.gif","dial-meter"},
		{"/images/meter/arc_dial_meter.gif","arc-dial-meter"},
		{"/images/meter/thermometer_meter.gif","thermometer-meter"}
	};
	private final static String GANTT_IMAGE_PATH[][] = {
		{"/images/gantt/vertical_gantt.gif","horizontal-gantt"},
		{"/images/gantt/horizontal_gantt.gif","vertical-gantt"}
	};
	private final static String RADAR_IMAGE_PATH[][] = {
		{"/images/radar/radar.gif","radar"}
	};
	...
	public static void initImages(){
		...
		pieImage = new Image(null,basePath + "/images/nav/pie.gif");
		barImage = new Image(null, basePath + "/images/nav/bar.gif");
		lineImage = new Image(null, basePath + "/images/nav/line.gif");
		xyLineImage = new Image(null, basePath + "/images/nav/xy-line.gif");
		areaImage = new Image(null, basePath + "/images/nav/area.gif");
		timeImage = new Image(null, basePath + "/images/nav/time.gif");
		meterImage = new Image(null, basePath + "/images/nav/meter.gif");
		ganttImage = new Image(null, basePath + "/images/nav/gantt.gif");
		radarImage = new Image(null, basePath + "/images/nav/radar.gif");
	}
