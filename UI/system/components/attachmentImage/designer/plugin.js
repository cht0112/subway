...
justep.design.attachmentImage = function(config){   
	justep.design.attachmentImage.superclass.constructor.call(this,config);
}

justep.extend(justep.design.attachmentImage, justep.design.Component,{
	 paintContent:function(xmlNode){
	 	...
	 	this.createElement("<table id='"+this.id+"' class='xui-attachmentImage'><tr>" +
	 							"<td align='center'>" +
	...
	setProperty:function(name,value,s,u){
		justep.design.attachmentImage.superclass.setProperty.call(this,name,value,s,u);
		if("show-button" == name){
