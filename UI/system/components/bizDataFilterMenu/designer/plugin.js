justep.design.BizDataFilterMenu = function(config){ 
	justep.design.BizDataFilterMenu.superclass.constructor.call(this,config);
	this.resizable=false;
}

justep.extend(justep.design.BizDataFilterMenu, justep.design.Component,{
