...
public class TreeFilter implements JavaTemplate {
	...
	private String onShowNodeImg;
	private String onRowExpand;
	...
	private void init(Element bound) throws XBLException {
		...
		this.cascade = ComponentUtils.getAttributeOfDefault(bound, "cascade", "false");
		...
		this.delay = ComponentUtils.getAttributeOfDefault(bound, "delay", "false");
		...
		this.onShowNodeImg = bound.attributeValue("onShowNodeImg");
		this.onRowExpand = bound.attributeValue("onRowExpand");
	...
	private Element createSelect() {
		Element g = ComponentUtils.createComponentDiv(ComponentUtils.TREE_SELECT_COMPONENT, selectID);
		...
		g.addAttribute("cascade", this.cascade);
		...
		g.addAttribute("delay", this.delay);
		...
		g.addAttribute("onShowNodeImg", this.onShowNodeImg);
		g.addAttribute("onRowExpand", this.onRowExpand);
