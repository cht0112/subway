...
justep.Blob.prototype = {
	...
	deleteAction : function() {
		...
		param.setString('dataModel', this.getDataModel());
		param.setString('id', this.getRowId());
		param.setString('relation', this.getAttributeValue('relation'));
	...
	readySubmit : function(f) {
		...
		$f.children("input[name='dataModel']").val(this.getDataModel());
		$f.children("input[name='concept']").val(this.getConcept());
		$f.children("input[name='relation']").val(
		...
		$f.children("input[name='id']").val(this.getRowId());
		$f.children("input[name='size']").val(this.size?this.size:'');
	},
	getRowId : function(){
		var data = this.getData();
		if (data) {
