justep.design.BizDataFilterDialog = function(config){ 
	justep.design.BizDataFilterDialog.superclass.constructor.call(this,config);
	this.resizable=false;
}

justep.extend(justep.design.BizDataFilterDialog, justep.design.Component,{
