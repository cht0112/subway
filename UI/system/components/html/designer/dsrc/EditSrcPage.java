...
public class EditSrcPage implements IPropertyDialog{
	...
	private void createDialog(){
		...
		this.dlg.setFilterPath(StudioConfig.getUISrcPath());
	}
	...
	public void open() {
		...
		if(this.fileName.indexOf(StudioConfig.getUISrcPath())==-1){
			this.errMsg = "请选择UI目录下文件";
			return;
		}
		this.fileName=this.fileName.replace(StudioConfig.getUIServerResourcePath().replaceAll("\\\\", "/"), "");				
	}
