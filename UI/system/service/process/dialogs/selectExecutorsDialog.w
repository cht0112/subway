...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model" style="top:282px;height:auto;left:148px;"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#data" columns="sName,sFID,sFName,sOrgKindID,sParent,responsible,calcIndex"
  ...
  <xui:place control="btnAllPage" id="controlPlace18"></xui:place></xhtml:div></xhtml:div> 
    ...
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" id="gridSelected"
      ...
      <xui:column id="gridColumn6" ref="sOrgKindID" label="类型" type="html" width="40"
        align="center" onRender="selectExecutorsDialog.grid_sOrgKindIDRender"/>
      <xui:column id="gridColumn8" ref="responsible" label="管理者" type="ch" width="45"
        align="center" checked-value="true" unchecked-value="false"/> 
    </xhtml:div>  
