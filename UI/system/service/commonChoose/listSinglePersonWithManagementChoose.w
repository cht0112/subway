<window xmlns="http://www.justep.com/xui"
	...
	extends="/UI/system/service/commonChoose/listSinglePersonChoose.w">
	<reader action="/SA/OPM/logic/action/queryPersonManagementGAction" id="readerAction" xui:update-mode="merge"/>
</window>