...
<window xmlns="http://www.justep.com/xui" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xforms="http://www.justep.com/xforms" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:f="http://orbeon.org/oxf/xml/formatting" xmlns:justep="http://www.justep.com/x5#" xmlns:data="http://www.justep.com/x5/xui/data#" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xui="http://www.justep.com/xui" component="/UI/system/components/window.xbl.xml#window">  
  <xforms:model id="listMultiChooseModel" style="top:97px;height:auto;left:123px;"> 
  ...
  <view id="topView"> 
    ...
    <view id="toolbarView"> 
      ...
      <layout> 
        ...
        <xui:place control="wr" id="controlPlace1" style="top:106px;left:38px;"/> 
      </layout> 
    </view>  
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="main" id="listGrid" style="height:100%;width:100%" multi-selection="true" onRowChecked="chooseData.checkSelectRow" onRowCheckedAll="chooseData.checkSelectRows"> 
      ...
      <xhtml:div id="selectBarViewDiv" style="height:26px;filter:progid:DXImageTransform.Microsoft.Gradient(startColorStr='#98B2E6', endColorStr='#FFFFFF', gradientType='1');"> 
        <xhtml:table style="font-size:12px;"> 
          <xhtml:tr> 
            ...
            <xhtml:td> 
              <xhtml:span style="width:18;MARGIN-RIGHT:auto; MARGIN-LEFT:auto;border:solid 0px #dfe8f6;display:inline;" onmouseover="this.style.border='1px ridge #dfe8f6';" onmouseout="this.style.border='1px solid #dfe8f6'" onmousedown="this.style.border='1px groove'" onmouseup="this.style.border='1px ridge'"> 
