<window 
  ...
  extends="templete/listMultiTemplete.w" >

  <div id="quickSearch" xui:update-mode="delete"/>
   <data id="main" concept="SA_OPRole" relations="sValidState,sName,sCode,sCatalog,sRoleKind,sDescription,sSequence,sParentRolesNames"  xui:update-mode="merge"/>
