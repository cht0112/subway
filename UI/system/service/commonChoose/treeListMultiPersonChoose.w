<window xmlns="http://www.justep.com/xui"
	...
	extends="/UI/system/service/commonChoose/templete/treeListMultiTemplete.w">
...
<!--	</xhtml:td>-->
	...
	<xhtml:div id="listGrid" xui:update-mode="merge-and-append">
		...
		<column ref="sName" width="100px" visable="false"/>
		<column ref="sCode" width="120px" visable="false"/>
	</xhtml:div>
</window>