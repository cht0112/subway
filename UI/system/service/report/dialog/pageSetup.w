...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="pageSetupDialog" style="top:10px;height:auto;left:10px;"> 
    ...
    <data id="pageInfo" columns="fid,displayName,paperType,pageWidth,pageHeight,orientation,marginTop,marginBottom,marginLeft,marginRight,marginHeader,marginFootter"
    ...
    <xui:layout style="width:100%;height:100%;">
      ...
      <xhtml:table border="0" cellspacing="8" cellpadding="0" style="width:100%;height:100%;table-layout:fixed"
                ...
                <xhtml:tr class="tr30"> 
                  ...
                  <xhtml:td class="td140"> 
                    <xforms:input id="iptmarginBottom" class="xui-input" data="pageInfo"
                      ref="data('pageInfo')/marginBottom"/> 
                  </xhtml:td> 
                </xhtml:tr>  
                <xhtml:tr class="tr30"> 
                  <xhtml:td class="td70">左页边距：</xhtml:td>  
                  <xhtml:td class="td140"> 
                    <xforms:input id="iptmarginLeft" class="xui-input" data="pageInfo"
                      ref="data('pageInfo')/marginLeft"/> 
                  </xhtml:td>  
                  <xhtml:td class="td70">右页边距：</xhtml:td>  
                  <xhtml:td class="td140"> 
                    <xforms:input id="iptmarginRight" class="xui-input" data="pageInfo"
                      ref="data('pageInfo')/marginRight"/> 
                  </xhtml:td> 
                </xhtml:tr> 
              </xhtml:table> 
            </xhtml:fieldset>  
            ...
            <xhtml:fieldset> 
              ...
              <xforms:select1 ref="data('pageInfo')/orientation" id="selectOrientation"> 
                <xforms:item id="selectItem1"> 
                  ...
                  <xforms:value id="default3">Landscape</xforms:value>
                </xforms:item>  
                <xforms:item id="selectItem2"> 
                  <xforms:label id="xuiLabel3">纵向</xforms:label>  
                  <xforms:value id="default4"></xforms:value> 
                </xforms:item> 
              </xforms:select1> 
            </xhtml:fieldset>  
            <xhtml:div style="height:1px;"/>  
            <xhtml:fieldset> 
              <xhtml:legend>页眉页脚</xhtml:legend>  
              <xhtml:table> 
                <xhtml:tr class="tr30"> 
                  <xhtml:td class="td70">页眉：</xhtml:td>  
                  <xhtml:td class="td140"> 
                    <xforms:input id="iptmarginHeader" class="xui-input" data="pageInfo"
                      ref="data('pageInfo')/marginHeader"/> 
                  </xhtml:td>  
                  <xhtml:td class="td70">页脚：</xhtml:td>  
                  <xhtml:td class="td140"> 
                    <xforms:input id="iptmarginFootter" class="xui-input" data="pageInfo"
                      ref="data('pageInfo')/marginFootter"/> 
                  </xhtml:td> 
                </xhtml:tr> 
              </xhtml:table> 
            </xhtml:fieldset> 
        ...
        <xhtml:tr height="22px"> 
          <xhtml:td> 
            <xui:place control="trigger1" id="controlPlace2" style="float:right;"></xui:place>
  <xui:place control="trigger2" id="controlPlace3" style="float:right;margin-right:16px;"></xui:place></xhtml:td> 
        </xhtml:tr> 
      </xhtml:table> 
    </xui:layout>  
  ...
  <xforms:action id="action2" ev:event="DOMActivate"><xforms:script id="xformsScript2"><![CDATA[justep.windowReceiver.windowCancel()]]></xforms:script></xforms:action></xforms:trigger>
  <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="trigger2" class="button-green">
   <xforms:label id="default6"><![CDATA[确定]]></xforms:label>
  <xforms:action id="action1" ev:event="DOMActivate"><xforms:script id="xformsScript1"><![CDATA[justep.windowReceiver.windowEnsure(getPageInfoData())]]></xforms:script></xforms:action></xforms:trigger></view>  
  <resource> 
    ...
    <xhtml:script> <![CDATA[
			justep.windowReceiver.acceptParentParamsFun = function(event){
				...
				try{
					...
					pageInfo.setValue('marginBottom',data.marginBottom);
					pageInfo.setValue('marginLeft',data.marginLeft);
					pageInfo.setValue('marginRight',data.marginRight);
					pageInfo.setValue('marginHeader',data.marginHeader);
					pageInfo.setValue('marginFootter',data.marginFootter);
				}finally{
					pageSetup.changeCount--;
				}
				/**
