...
//	email :	fuushikaden@yahoo.com
	...
	var baseDir = "/UIServer/3.1415/UI/system/service/report/runtime/calendar/"	
	var imgDir = "/UIServer/3.1415/UI/system/service/report/runtime/calendar/img/"					// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><div onclick='hideCalendar()'><IMG SRC='"+imgDir+"close.gif' name=close WIDTH='15' HEIGHT='13' BORDER='0' ALT='" + altCloseCalendar + "'></div></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
			
		if (showToday==1)
		{
			document.write ("<tr bgcolor=#f0f0f0><td style='padding:1px' align=center  valign=middle><span style='float:left;'><iframe name=stime id=stime src='"+baseDir+"timeS.html' frameborder=0 width=90 height=20 scrolling=no allowtransparency=true></iframe></span> <span id='lblToday'></span></td></tr>")
		}
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(ctl,ctl2,weeks,feastS,turn_date,week_date,showTime ,format) {		
