...
appCommon.ProcessBar={};
appCommon.ProcessBar.conf = null;
appCommon.ProcessBar.back = null;
appCommon.ProcessBar.advance = null;
appCommon.ProcessBar.transfer = null;
appCommon.ProcessBar.suspend = null;
appCommon.ProcessBar.abort = null;
appCommon.ProcessBar.customized = null;
appCommon.ProcessBar.processChart = null;
appCommon.ProcessBar.executeList = null;
appCommon.ProcessBar.getConfig= function(){
	this.conf = appCommon.ConfigUtils.getCurrentProcessBizConfig(appCommon.ProcessExecute.PROCESS_EXECUTE_CONFIG_FILE);	
	this.back = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/back-enabled", true);					
	this.advance = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/advance-enabled", true);					
	this.transfer = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/transfer-enabled", true);					
	this.abort = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/abort-enabled", true);	
	
	this.suspend = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/suspend-enabled", false);	
	this.customized = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/customized-enabled", false);	
	this.processChart = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/processChart-enabled", false);	
	this.executeList = appCommon.ConfigUtils.getActivityConfigItem(this.conf,"//execute-dialog/executeList-enabled", false);	
};
appCommon.ProcessBar.getProcessBarItemRelevant = function(item){
	if(this.conf==null){
		appCommon.ProcessBar.getConfig();
	}
	if(item=="back"){
		return this.back;
	}
