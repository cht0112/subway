...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdMain" style="top:108px;left:231px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" offset="1"
      ...
      <rule concept="OA_MT_BOARDROOM" readonly="true()"/> 
    </data>  
    <data component="/UI/system/components/data.xbl.xml#bizData" offset="1"
  ...
  <xui:view id="rootView" auto-load="true"> 
    <xui:view auto-load="true" id="vBoardroom"> 
      ...
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" style="width:100%;height:100%"
        id="gridSelect1" ref="data('dBoardroom')/fType" dropdown-height="100"> 
      ...
      <xhtml:div component="/UI/system/components/orgSelect.xbl.xml#orgSelect" style="width:100%;height:100%"
        ...
        <xhtml:div component="/UI/system/components/select.xbl.xml#treeSelect" id="treeDeptSelect"
          data-ref="bizData2" ref="data('dBoardroom')/fDutyDeptID" label-ref="data('dBoardroom')/fDutyDeptName"> 
      ...
      <xhtml:div component="/UI/system/components/orgSelect.xbl.xml#orgSelect" style="width:100%;height:100%"
        ...
        <xhtml:div component="/UI/system/components/select.xbl.xml#treeSelect" id="treePsmSelect"
          ...
          onDropdown="treePsmSelectDropdown"> 
      ...
      <xforms:output style="width:100%;height:100%" id="fHoldNum" ref="data('dBoardroom')/fHoldNum"/>  
      <xforms:output style="width:100%;height:100%" id="fUse" ref="data('dBoardroom')/fUse"/>  
      <xforms:output style="width:100%;height:100%" id="fAddress" ref="data('dBoardroom')/fAddress"/>  
      <xforms:output style="width:100%;height:100%" id="fFloor" ref="data('dBoardroom')/fFloor"/>  
      <xforms:output style="width:100%;height:100%" id="fBaseConfig" ref="data('dBoardroom')/fBaseConfig"/>  
      <xforms:input style="width:100%;height:100%" id="fEquipment" ref="data('dBoardroom')/fEquipment"/>  
      ...
      <xforms:trigger id="triEnsure" ref="data('selectFilter')/canSelect" style="height:100%;width:60px;"> 
      ...
      <layout style="height:100%;" id="layout1" type="excel" src="boardroomDetail.xls"/> 
    </xui:view>  
