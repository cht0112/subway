...
<window xmlns="http://www.justep.com/xui" xmlns:data="http://www.justep.com/x5/xui/data#" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:f="http://orbeon.org/oxf/xml/formatting" xmlns:justep="http://www.justep.com/x5#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xforms="http://www.justep.com/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xui="http://www.justep.com/xui" component="/UI/system/components/window.xbl.xml#window">  
  <xforms:model id="mdDefault" style="top:88px;left:187px;"> 
    <data auto-load="false" auto-new="false" component="/UI/system/components/data.xbl.xml#bizData" concept="OA_GZJH" id="dataMain" limit="20" offset="0" store-type="simple" update-mode="whereVersion" onValueChanged="dataMainValueChanged" onBeforeSave="dataMainBeforeSave"> 
      ...
      <rule id="dataBizRule2" relation="fGZJHLX" default-value="'部工作计划'"/>  
    ...
    <data auto-load="true" auto-new="false" component="/UI/system/components/data.xbl.xml#bizData" concept="OA_GZNR" id="dGZNR" limit="-1" offset="0" store-type="grid" update-mode="whereVersion" order-by="fPlanTime:desc"> 
      ...
      <rule id="dataBizRule8" concept="OA_GZNR" readonly="not(contains('deptEdActivity,mainActivity', call('justep.Context.getCurrentActivity')))"/> 
    </data>  
  ...
  <data component="/UI/system/components/data.xbl.xml#data" columns="insertBtn" src="" auto-load="true" id="dBtn" store-type="simple"><rows xmlns="" id="default3">
   <row id="default4">
    <cell id="default7"></cell></row> </rows>
  <rule id="dataRule1" column="insertBtn" readonly="(call('justep.Context.getRequestParameter', 'activity-pattern') = 'detail') or
not(contains('deptEdActivity,mainActivity', call('justep.Context.getCurrentActivity')))"></rule></data></xforms:model>  
    ...
    <xui:view auto-load="true" id="vDetail"> 
      <xui:view id="vTbrGZNR" auto-load="true"> 
        <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="tbsDetail"> 
          <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dGZNR" id="ngtbDetail">
            <!-- 
            <item id="insertItem" name="insert-item" readonly="not(contains('deptEdActivity,mainActivity', call('justep.Context.getCurrentActivity')))">
            ...
            <item id="customBarItem1"> 
              ...
              <xforms:action id="action2" ev:event="DOMActivate" if="(contains('deptEdActivity,mainActivity', call('justep.Context.getCurrentActivity')))"> 
                <xforms:script id="xformsScript2">mainActivity.insertItemClick(event)</xforms:script> 
              </xforms:action> 
            </item>  
            <item id="barItem4" name="delete-item" readonly="not(contains('deptEdActivity,mainActivity', call('justep.Context.getCurrentActivity')))"/>  
            </xui:bar> 
        </xhtml:div>  
      ...
      <xui:view id="vgrdGZNR" auto-load="true"> 
        <!--<xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dGZNR"
          ...
          <column ref="序号" type="ro" width="40" show-index="true"/>  
          <column id="default11" label="计划时间" ref="fPlanTime" type="dateTime"
            width="120"/>  
          <column id="default12" label="工作内容" ref="fWorkContent" type="ed" width="320"/>  
          <column id="default13" label="承办单位" ref="fSponsor" type="ed" width="80"/>  
          <column id="default16" label="负责人" ref="fChargePersonName" type="ed"
            width="100"/>  
          <column label="地点" ref="fAddress" type="ed" width="120"/>  
          <column id="default18" label="描述" ref="fRemark" type="ed" width="80"/> 
        </xhtml:div>-->  
        <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dGZNR" id="grdDetail" show-header-menu="hide-column,save-layout,group-column,adjust-column"> 
          ...
          <column id="default11" label="完成时限" ref="fPlanTime" type="ed" width="120" align="center" format="yyyy-MM-dd"/>  
      ...
      <xforms:input id="fCBR" ref="data('dataMain')/fCreatePsnName" auto-size="true" readonly="true"/>  
      <xforms:input id="fFZR" ref="data('dataMain')/fFZR" auto-size="true"/>  
      <xhtml:div component="/UI/system/components/orgSelect.xbl.xml#orgSelect" id="fCBBM" show-org-types="ogn"> 
        <xforms:model id="model2"> 
          <xui:data component="/UI/system/components/data.xbl.xml#bizData" id="dOrgDept"/> 
        </xforms:model>  
        <xhtml:div component="/UI/system/components/select.xbl.xml#treeSelect" id="treeSelect1" data-ref="dOrgDept" ref="data('dataMain')/fCreateDeptID" label-ref="data('dataMain')/fCreateDeptName"> 
      ...
      <xforms:input ref="data('dataMain')/fJHKSRQ" id="fJHKSRQ" format="format-date('yyyy-MM-dd')" auto-size="true"/>  
      <xforms:input ref="data('dataMain')/fJHJSRQ" id="fJHJSRQ" format="format-date('yyyy-MM-dd')" auto-size="true"/>  
      ...
      <xui:layout style="height:100%;" type="excel" src="mainActivity.xls"> 
        ...
        <place control="fCBBM"/>  
        <place control="vgrdGZNR"/>  
        <place control="vTbrGZNR"/>  
      ...
      <xhtml:div component="/UI/system/components/tabs.xbl.xml#tabs" id="tabpanel1" style="height:100%;width:100%;;"> 
        <xui:tab id="tabDetail"> 
          ...
          <xhtml:table cellpadding="0" cellspacing="0" id="table3" align="center"> 
            ...
            <!--<xhtml:tr id="default25"> 
              <xhtml:td style="width:98%;height:40px;font-size:20;font-weight:bold"
            		align="center">部工作计划编制</xhtml:td> 
            </xhtml:tr>-->  
            ...
            <xhtml:tr id="default2"> 
              <xhtml:td id="td1"> 
                <xui:place control="standardProcessExecuteList2" id="controlPlace2" style="width:745px"/> 
              </xhtml:td> 
            </xhtml:tr> 
          </xhtml:table> 
        </xui:tab>  
