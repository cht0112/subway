  ...
  <xui:view id="rootView" auto-load="true"> 
    ...
    <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars1"> 
      ...
      <xui:bar component="/UI/system/components/customBar.xbl.xml#customBar" id="customBar1"> 
        <item id="barItem1"> 
          <xhtml:div component="/UI/appCommon/components/extDateFilter.xbl.xml#extDateFilter" style="width:100px;" id="extDateFilter1" filter-data="bizData1" filter-date-mode="single" filter-date-relation1="fCreateTime"/> 
        </item>  
        <item id="barItem2"> 
