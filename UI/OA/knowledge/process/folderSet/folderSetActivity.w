...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events" component="/UI/system/components/window.xbl.xml#window">  
  <xui:resource> 
    <xhtml:script src="folderSetActivity.js"/> 
  </xui:resource>  
  <xforms:model id="mdMain" style="top:365px;left:16px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" offset="1" update-mode="whereVersion" auto-load="true" id="dFolder" concept="OA_KM_Folder" order-by="fName:asc" is-tree="true" onValueChanged="dFolderValueChanged"> 
      <tree-option parent-relation="fParent" root-filter="OA_KM_Folder = 'public'"/>  
  ...
  <xui:view id="rootView" auto-load="true"> 
    ...
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="管理员设置" width="630px" height="400px" modal="true" id="dlgManagerSet" url="/OA/knowledge/process/dialog/folderManagerSet/folderManagerSet.w" onSend="dlgManagerSetSend" onReceive="dlgManagerSetReceive" reload-on-open="true"/>  
    ...
    <xui:view id="vDetail"> 
      ...
      <xui:layout style="height:100%;" type="excel" src="folderSet.xls"/> 
    </xui:view>  
