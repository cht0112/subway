...
public class TextAndPicPortlet implements JProcessor  {
	private static final String GET_PORTLET_DATA_ACTION = "getPortletDataAction";
	private static final String VIEW = "/UI/OA/knowledge/process/knowledgePortlet/textAndPicPortlet.xhtml";
	private static final String PROCESS = "/OA/knowledge/process/knowledgePortlet/knowledgePortletProcess";
	private static final String ACTIVITY = "textAndPicPortletActivity";
	...
	private Document getPortletData(HttpServletRequest request){
		...
		String displayCount = request.getParameter("displayCount_pic");
