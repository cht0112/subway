...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events" component="/UI/system/components/window.xbl.xml#window">  
  ...
  <xui:view id="rootView" auto-load="true"> 
    ...
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="知识权限" width="700px" height="430px" modal="true" id="dlgRights" url="/OA/knowledge/process/dialog/knowledgeRightsSet/knowledgeRightsSet.w" onSend="dlgRightsSend"/>  
    ...
    <xui:view auto-load="true" id="vDetail"> 
      ...
      <xhtml:div component="/UI/system/components/attachmentImage.xbl.xml#attachmentImage" style="width:100%;height:100%;;width:100%;height:100%" model="mdKnowledge" ref="data('dKnowledge')/fPicture1" root-path="/root" limit-size="0" id="fPicture1" auto-load="true" sub-path="concat('业务附件/OA/知识中心',toString(yearOf(currentDate())),'/',toString(monthOf(currentDate())))"/>  
      <xhtml:div component="/UI/system/components/attachmentImage.xbl.xml#attachmentImage" model="mdKnowledge" ref="data('dKnowledge')/fPicture2" root-path="/root" limit-size="0" id="fPicture2" auto-load="true" style="width:100%;height:100%;;width:100%;height:100%" sub-path="concat('业务附件/OA/知识中心',toString(yearOf(currentDate())),'/',toString(monthOf(currentDate())))"/>  
      <xhtml:div component="/UI/system/components/attachmentImage.xbl.xml#attachmentImage" style="width:100%;height:100%;;width:100%;height:100%" model="mdKnowledge" ref="data('dKnowledge')/fPicture3" root-path="/root" limit-size="0" id="fPicture3" auto-load="true" sub-path="concat('业务附件/OA/知识中心',toString(yearOf(currentDate())),'/',toString(monthOf(currentDate())))"/>  
      ...
      <layout style="height:100%;width:100%;"> 
        <xhtml:table width="100%" height="100%" component="/UI/system/components/tableLayout.xbl.xml#tableLayout"> 
          <xhtml:tr> 
            ...
            <xhtml:td width="70px" valign="center"> 
              <xforms:trigger ref="data('dTemp')/canRelease"> 
            ...
            <xhtml:td width="70px"> 
              <xforms:trigger ref="data('dTemp')/needApprove"> 
            ...
            <xhtml:td width="70px" valign="center"> 
              <xforms:trigger ref="data('dTemp')/canUnrelease"> 
      ...
      <xhtml:table align="center"> 
        ...
        <xhtml:tr> 
          <xhtml:td> 
            ...
            <xui:place control="wDlgKeyWord" id="controlPlace1" style="top:238px;left:354px;"/> 
          </xhtml:td> 
        </xhtml:tr>  
        <xhtml:tr> 
          <xhtml:td> 
            <xhtml:div fixed="true" component="/UI/system/components/collapsePanel.xbl.xml#collapsePanel" id="collapsePanel1" title="附件" state="collapsed" status="collapsed"> 
    ...
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="主题词选择向导" width="690px" height="470px" modal="true" id="wDlgKeyWord" url="/OA/common/process/keyWordSelect/keyWordSelect.w" reload-on-open="true" onSend="wDlgKeyWordSend" onReceive="wDlgKeyWordReceive"/> 
  </xui:view> 
</xui:window>
