...
//	this.timePan = document.createElement("TABLE");
  ...
  dhtmlxEventable(this);
	...
	window.dhtmlxCalendarLangModules['zh-cn'] = defLeng_cn;
  ...
  if (!this.entObj.className)
    ...
    if (typeof(JustepGC) != "undefined") {
    	if (typeof(JustepGC.addRef) == "function") {
    		JustepGC.addEventOwner(this.daysPan);
    		JustepGC.addEventOwner(this.entObj);
    	}
    }
...
dhtmlxCalendarObject.prototype.drawMonth = function(){
	...
	if (this.options.isMonthEditable) {
	    ...
	    if (typeof(JustepGC) != "undefined") {
	    	if (typeof(JustepGC.addRef) == "function") {
	    		JustepGC.addRef(this.editorMonth, "_c");
	    	}
	    }
	}
	...
	if (this.options.isYearEditable) {
	    ...
	    if (typeof(JustepGC) != "undefined") {
	    	if (typeof(JustepGC.addRef) == "function") {
	    		JustepGC.addRef(this.editorYear, "_c");
	    	}
	    }
	}
    ...
    if (typeof(JustepGC) != "undefined") {
    	if (typeof(JustepGC.addRef) == "function") {
    		JustepGC.addRef(this.planeYear, "_c");
    		JustepGC.addRef(this.planeMonth, "_c");
    	}
    }
}
...
dhtmlxCalendarObject.prototype.loadUserLanguage = function(language, userCBfunction){ 
	...
	if (!language){
		language="en-us";
		if (window.navigator.language && __lm[window.navigator.language])
			language = window.navigator.language;
		else if (window.navigator.userLanguage && __lm[window.navigator.userLanguage])
...
function dhtmlxRichSelector(parametres) {
	...
	if (this.valueList)
		for (var i = 0; i < this.valueList.length; i++) {
        	...
        	curOption.text = this.titleList[i];
        	curOption.value = this.valueList[i];
			this.selector.options.add(curOption);
		}
    ...
    if (typeof(JustepGC) != "undefined") {
    	if (typeof(JustepGC.addRef) == "function") {
    		JustepGC.addRef(this.nodeBefore, "onclick");

    		JustepGC.addRef(this.editor, "_s");
    		JustepGC.addRef(this.editor, "onfocus");
    		JustepGC.addRef(this.editor, "onblur");
    		JustepGC.addRef(this.editor, "onkeydown");
    		JustepGC.addRef(this.editor, "onkeyup");
    		
    		JustepGC.addRef(this.selector, "_s");
    		JustepGC.addRef(this.selector, "onfocus");
    		JustepGC.addRef(this.selector, "onblur");
    		JustepGC.addRef(this.selector, "onclick");
    		JustepGC.addRef(this.selector, this.selector.options);
    	}
    }
