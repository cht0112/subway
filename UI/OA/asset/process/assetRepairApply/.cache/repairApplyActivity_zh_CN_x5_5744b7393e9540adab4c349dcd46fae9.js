...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'dc4ecc95b20f40fc8b330620428b734f', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrRepairApply', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'8720e73ef6cd4badaaa7f962cbe182a2', name:'xforms:label'},{id:'2d3d63de4c1c467e85574dc916210c8c', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'2d66b9fd271748abbe230fee7200d7f5', name:'xforms:value'},{id:'71ed6671727f4abc9bf3254788ddfc5b', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'optCode', name:'xforms:output'},{id:'trgSelectAsset', name:'xforms:trigger', children:[{id:'xuiLabel4', name:'xforms:label'}]},{id:'optKind', name:'xforms:output'},{id:'optName', name:'xforms:output'},{id:'optSpecType', name:'xforms:output'},{id:'grdSltRepairType', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default4', name:'xforms:value'}]},{id:'optServiceYear', name:'xforms:output'},{id:'iptUsedYear', name:'xforms:output'},{id:'optRemainValue', name:'xforms:output'},{id:'taDescription', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_929592386', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_929592386', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'assetRepairApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetRepairApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetRepairApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetRepairApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'8e19ada65ce54ac0a454e0fd2b5d21d5', name:'xforms:trigger', children:[{id:'ddb582362d5c456a8e3b2176af61c9c6', name:'xforms:label'}]},{id:'c09fdbb28f6b42978c1caf0b7aa2cc23', name:'xforms:trigger', children:[{id:'4409be897ab14b0ba6ccf6b61e400635', name:'xforms:label'}]}]},{id:'assetRepairApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'wDlgAssetCard', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_N1271020832', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_N1018363042', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_N1971414604', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','8720e73ef6cd4badaaa7f962cbe182a2');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','71ed6671727f4abc9bf3254788ddfc5b');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'optCode');xf._a(null,'trgSelectAsset');xf._a('trgSelectAsset','xuiLabel4');xf._a(null,'optKind');xf._a(null,'optName');xf._a(null,'optSpecType');xf._a(null,'grdSltRepairType');xf._a('grdSltRepairType','xuiLabel3');xf._a('grdSltRepairType','default5');xf._a(null,'optServiceYear');xf._a(null,'iptUsedYear');xf._a(null,'optRemainValue');xf._a(null,'taDescription');xf._a(null,'taRemark');xf._a(null,'8e19ada65ce54ac0a454e0fd2b5d21d5');xf._a('8e19ada65ce54ac0a454e0fd2b5d21d5','ddb582362d5c456a8e3b2176af61c9c6');xf._a(null,'c09fdbb28f6b42978c1caf0b7aa2cc23');xf._a('c09fdbb28f6b42978c1caf0b7aa2cc23','4409be897ab14b0ba6ccf6b61e400635');function init() {	
var begin = new Date().getTime();	
xf._b("instance('dRepairApply')/fApplyDeptID",xf._g(xf._f('instance',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyDeptID')))));	
xf._b("true()",xf._f('true'));	
xf._b("'申请部门不能为空!'",xf._i("申请部门不能为空!"));	
xf._b("instance('dRepairApply')/fApplyPsnID",xf._g(xf._f('instance',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyPsnID')))));	
...
xf._b("instance('dRepairApply')",xf._f('instance',xf._i("dRepairApply")));	
...
xf._b("instance('dRepairType')/version",xf._g(xf._f('instance',xf._i("dRepairType")),xf._h(false, xf._k("child",xf._j('','version')))));	
xf._b("instance('dRepairType')/fLevel",xf._g(xf._f('instance',xf._i("dRepairType")),xf._h(false, xf._k("child",xf._j('','fLevel')))));	
xf._b("instance('dRepairType')/fCreateTime",xf._g(xf._f('instance',xf._i("dRepairType")),xf._h(false, xf._k("child",xf._j('','fCreateTime')))));	
xf._b("instance('dRepairType')/fUpdateTime",xf._g(xf._f('instance',xf._i("dRepairType")),xf._h(false, xf._k("child",xf._j('','fUpdateTime')))));	
...
xf._b("data('dRepairApply')/fNO",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fNO')))));	
...
xf._b("data('dRepairApply')/fApplyDeptID",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyDeptID')))));	
xf._b("data('dRepairApply')/fApplyDeptName",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyDeptName')))));	
...
xf._b("data('dRepairApply')/fApplyPsnID",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyPsnID')))));	
xf._b("data('dRepairApply')/fApplyPsnName",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyPsnName')))));	
xf._b("data('dRepairApply')/fApplyDate",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fApplyDate')))));	
xf._b("data('dRepairApply')/fCode",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fCode')))));	
xf._b("data('dSelectTrg')/selectAssetCard",xf._g(xf._f('data',xf._i("dSelectTrg")),xf._h(false, xf._k("child",xf._j('','selectAssetCard')))));	
xf._b("data('dRepairApply')/fKind",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fKind')))));	
xf._b("data('dRepairApply')/fName",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fName')))));	
xf._b("data('dRepairApply')/fSpecType",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fSpecType')))));	
xf._b("data('dRepairApply')/fRepairTypeID",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fRepairTypeID')))));	
xf._b("data('dRepairApply')/fRepairType",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fRepairType')))));	
xf._b("fName",xf._h(false, xf._k("child",xf._j('','fName'))));	
xf._b("OA_AS_RepairType",xf._h(false, xf._k("child",xf._j('','OA_AS_RepairType'))));	
...
xf._b("data('dRepairApply')/fServiceYear",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fServiceYear')))));	
xf._b("data('dRepairApply')/fUsedYear",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fUsedYear')))));	
xf._b("data('dRepairApply')/fRemainValue",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fRemainValue')))));	
xf._b("data('dRepairApply')/fDescription",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fDescription')))));	
xf._b("data('dRepairApply')/fRemark",xf._g(xf._f('data',xf._i("dRepairApply")),xf._h(false, xf._k("child",xf._j('','fRemark')))));	
xf._b("not(call('justep.XData.canDo','dRepairApply','Save'))",xf._f('not',xf._f('call',xf._i("justep.XData.canDo"),xf._i("dRepairApply"),xf._i("Save"))));	
...
new xforms.XFInstance2('dSelectTrg','mdMain',null,'<rows id="default13"><row id="default14"><cell id="default15"></cell></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('dSelectTrg','selectAssetCard');	
xf._c('xf-bind-28','mdMain',"instance('dSelectTrg')/selectAssetCard",null,"(call('justep.Context.getRequestParameter', 'activity-pattern') = 'detail')",null,null,null,null,null);	
...
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var data = justep.xbl('dRepairApply'); var p = justep.xbl('assetRepairApplyProcess'); if (data){ data.attachEvent(justep.XData.EVENT_REFRESHDATA_BEFORE, function(event){ /*if (p.isAutoFilter()){*/ var conceptName = event.source.getConceptAliasName(); var value = justep.Context.getProcessData1(); var condition = null; if (value){ condition = conceptName + "='" + value + "'"; }else{ condition = "1=0"; } event.source.setFilter("_process-filter_", condition); /*}else{ event.source.setFilter("_process-filter_", "1=1"); }*/ }, data); }else{ var msg = new justep.Message(justep.Message.JUSTEP230001, "'dRepairApply'"); throw justep.Error.create(msg); }}));xf._p(justep('xf-model-3'),"xforms-model-construct",null,function(evt) { xforms.run(xf_action_xf_action_2,'xf-model-3', evt,false)});	
new xforms.XFDialog('assetRepairApplyProcess_processControlDialog',"流转信息",'modal',true,false,true,true,false,"",'700','465',null,null,null,null);	
var xf_script_xf_script_3=xf._o(null,null,function(element, ctx, event){var processControlDialog = justep('assetRepairApplyProcess_processControlDialog').xformsObject; var isOk = processControlDialog._isOk; var processControl = processControlDialog._processControl; var task = processControlDialog._task; var callback = processControlDialog._callback; var options = processControlDialog._options; processControlDialog._isOk = false; processControlDialog._processControl = null; processControlDialog._task = null; processControlDialog._callback = null; processControlDialog._options = null; if (isOk){ var process = justep.xbl('assetRepairApplyProcess'); process[callback](task, processControl, options); } justep('assetRepairApplyProcess_processControlDialogIFrame').src="";});xf._p(justep('assetRepairApplyProcess_processControlDialog'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_script_xf_script_3,'assetRepairApplyProcess_processControlDialog', evt,false)});	
new xforms.XFDialog('assetRepairApplyProcess_processChartDialogID',"流程图",'modal',true,false,true,true,false,"",'700','445',null,null,null,'maximize');	
var xf_script_xf_script_4=xf._o(null,null,function(element, ctx, event){justep('assetRepairApplyProcess_processChartDialogIFrame').src="";});xf._p(justep('assetRepairApplyProcess_processChartDialogID'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_script_xf_script_4,'assetRepairApplyProcess_processChartDialogID', evt,false)});	
var xf_script_xf_script_5=xf._o(null,null,function(element, ctx, event){var url = "/UI/system/service/process/processChart.w?process=" + justep.Context.getCurrentProcess() + "&activity=" + justep.Context.getCurrentActivity(); var task = justep.Context.getTask(); if (task != null){ url = url + "&task=" + task; } url = justep.Request.convertURL(url); justep('assetRepairApplyProcess_processChartDialogIFrame').src=url;});xf._p(justep('assetRepairApplyProcess_processChartDialogID'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_script_xf_script_5,'assetRepairApplyProcess_processChartDialogID', evt,false)});	
new xforms.XFDialog('assetRepairApplyProcess_processConfirmDialog',null,'modal',true,false,true,true,false,"",'250','90',null,null,null,null);	
var xf_script_xf_script_6=xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetRepairApplyProcess_processConfirmDialog').xformsObject; var isOk = processConfirmDialog._isOk; var processControl = processConfirmDialog._processControl; var task = processConfirmDialog._task; var callback = processConfirmDialog._callback; var options = processConfirmDialog._options; processConfirmDialog._isOk = false; processConfirmDialog._task = null; processConfirmDialog._processControl = null; processConfirmDialog._callback = null; processConfirmDialog._options = null; if (isOk && processControl.isOk()){ var process = justep.xbl('assetRepairApplyProcess'); process[callback](task, processControl, options); }});xf._p(justep('assetRepairApplyProcess_processConfirmDialog'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_script_xf_script_6,'assetRepairApplyProcess_processConfirmDialog', evt,false)});	
var xf_trigger_8e19ada65ce54ac0a454e0fd2b5d21d5=new xforms.XFTrigger('8e19ada65ce54ac0a454e0fd2b5d21d5',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetRepairApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetRepairApplyProcess_processConfirmDialog').close();}));xf._p(justep('8e19ada65ce54ac0a454e0fd2b5d21d5'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'8e19ada65ce54ac0a454e0fd2b5d21d5', evt,false)});	
var xf_trigger_c09fdbb28f6b42978c1caf0b7aa2cc23=new xforms.XFTrigger('c09fdbb28f6b42978c1caf0b7aa2cc23',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetRepairApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetRepairApplyProcess_processConfirmDialog').close();}));xf._p(justep('c09fdbb28f6b42978c1caf0b7aa2cc23'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'c09fdbb28f6b42978c1caf0b7aa2cc23', evt,false)});	
...
new xforms.XFInstance2('dRepairApply','mdMain',null,null,null,null,null,null,null,null,null,null,'whereVersion');new SimpleStore('dRepairApply',null);	
xf._c('xf-bind-0','mdMain',"instance('dRepairApply')/fApplyDeptID",null,null,"true()",null,null,null,"'申请部门不能为空!'");	
xf._c('xf-bind-1','mdMain',"instance('dRepairApply')/fApplyPsnID",null,null,"true()",null,null,null,"'申请人不能为空!'");	
xf._c('xf-bind-2','mdMain',"instance('dRepairApply')/fApplyDate",null,null,"true()",null,null,null,"'申请日期不能为空!'");	
xf._c('xf-bind-3','mdMain',"instance('dRepairApply')",null,"(call('justep.Context.getRequestParameter', 'activity-pattern') = 'detail')",null,null,null,null,null);	
xf._c('xf-bind-4','mdMain',"instance('dRepairApply')/version","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-5','mdMain',"instance('dRepairApply')/fApplyDate","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-6','mdMain',"instance('dRepairApply')/fServiceYear","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-7','mdMain',"instance('dRepairApply')/fUsedYear","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-8','mdMain',"instance('dRepairApply')/fRemainValue","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-9','mdMain',"instance('dRepairApply')/fRepairDate","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-10','mdMain',"instance('dRepairApply')/fReturnDate","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-11','mdMain',"instance('dRepairApply')/fRepairAmount","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-12','mdMain',"instance('dRepairApply')/fCreateTime","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-13','mdMain',"instance('dRepairApply')/fUpdateTime","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-14','mdMain',"instance('dRepairApply')/fExtendDate1","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-15','mdMain',"instance('dRepairApply')/fExtendDate2","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-16','mdMain',"instance('dRepairApply')/fExtendDate3","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-17','mdMain',"instance('dRepairApply')/fExtendDate4","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-18','mdMain',"instance('dRepairApply')/fExtendDate5","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-19','mdMain',"instance('dRepairApply')/fExtendNum1","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-20','mdMain',"instance('dRepairApply')/fExtendNum2","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-21','mdMain',"instance('dRepairApply')/fExtendNum3","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-22','mdMain',"instance('dRepairApply')/fExtendNum4","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-23','mdMain',"instance('dRepairApply')/fExtendNum5","xsd:float",null,null,null,null,null,null);	
...
var dRepairType_part_loaded = false;	
function load_dRepairType_part(callback){if (dRepairType_part_loaded) return;dRepairType_part_loaded = true;	
new xforms.XFInstance2('dRepairType','mdMain',null,null,null,null,null,null,null,null,null,null,'whereVersion');new SimpleStore('dRepairType',null);	
xf._c('xf-bind-24','mdMain',"instance('dRepairType')/version","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-25','mdMain',"instance('dRepairType')/fLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-26','mdMain',"instance('dRepairType')/fCreateTime","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-27','mdMain',"instance('dRepairType')/fUpdateTime","xsd:dateTime",null,null,null,null,null,null);	
if(callback)callback();}	
var dRepairType_part_init_loaded = false;	
function load_dRepairType_part_init(){if (dRepairType_part_init_loaded) return;dRepairType_part_init_loaded = true;	
if(xforms.ready)justep('mdMain').xformsObject.construct_part();}	
...
var xf_output_optKind=new xforms.XFOutput('optKind',xf._q("data('dRepairApply')/fKind"),null,null);	
var xf_output_optName=new xforms.XFOutput('optName',xf._q("data('dRepairApply')/fName"),null,null);	
var xf_output_optSpecType=new xforms.XFOutput('optSpecType',xf._q("data('dRepairApply')/fSpecType"),null,null);	
new xforms.XFExtSelect({id:'grdSltRepairType',type:'gridselect1',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('dRepairApply')/fRepairTypeID"),labelRef:xf._q("data('dRepairApply')/fRepairType"),extRef:null,valueSeparator:null,labelSeparator:null,extSeparator:null,dataId:'dRepairType',columns:'OA_AS_RepairType,fName,__c_,version,fCode,fDescription,fSequence,fUseStatus,fUseStatusName,fParentCode,fLevel,fURL,fCreateOgnID,fCreateOgnName,fCreateDeptID,fCreateDeptName,fCreatePsnID,fCreatePsnName,fCreatePsnFID,fCreateTime,fUpdatePsnID,fUpdatePsnName,fUpdateTime',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'OA_AS_RepairType,version,fCode,fDescription,fSequence,fUseStatus,fUseStatusName,fParentCode,fLevel,fURL,fCreateOgnID,fCreateOgnName,fCreateDeptID,fCreateDeptName,fCreatePsnID,fCreatePsnName,fCreatePsnFID,fCreateTime,fUpdatePsnID,fUpdatePsnName,fUpdateTime',valueColumn:'OA_AS_RepairType',labelColumn:'fName',extColumn:null,labels:',,,,,,,,,,,,,,,,,,,,,,',aligns:',,,,,,,,,,,,,,,,,,,,,,',types:'ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro',widths:{widths:"#,#,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*",total:0},height:'200px',dropdownWidth:'',appearance:null,delay:false,autoLoadData:true,independence:false,delayCreateGrid:false,cascade:false,dataXML:null,inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:null});	
var xf_output_optServiceYear=new xforms.XFOutput('optServiceYear',xf._q("data('dRepairApply')/fServiceYear"),null,null);	
var xf_output_iptUsedYear=new xforms.XFOutput('iptUsedYear',xf._q("data('dRepairApply')/fUsedYear"),null,null);	
var xf_output_optRemainValue=new xforms.XFOutput('optRemainValue',xf._q("data('dRepairApply')/fRemainValue"),null,'format-number(\'0,000.00\')');	
xf._d('taDescription','textarea',xf._q("data('dRepairApply')/fDescription"),null,null,null,null,false,false);	
xf._d('taRemark','textarea',xf._q("data('dRepairApply')/fRemark"),null,null,null,null,false,false);	
}	
...
xf._c('xf-bind-29','mdOrg',"instance('dOrg')/sValidState","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-30','mdOrg',"instance('dOrg')/sLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-31','mdOrg',"instance('dOrg')/version","xsd:integer",null,null,null,null,null,null);	
if(callback)callback();}	
...
xf._c('xf-bind-32','mdPsm',"instance('dPsm')/sValidState","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-33','mdPsm',"instance('dPsm')/sLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-34','mdPsm',"instance('dPsm')/version","xsd:integer",null,null,null,null,null,null);	
if(callback)callback();}	
