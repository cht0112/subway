...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'021718bd802e4623a7f568b606a3aa5c', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrRepairApply', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'4c7379d47db647a8aa0f3d0024ead5e7', name:'xforms:label'},{id:'a825797258ff42dfa4cd1c8662b13b04', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'52d3007f61e449329f4b1af229f9a8f2', name:'xforms:value'},{id:'9132880836874e42aa04631593b7fe35', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'optCode', name:'xforms:output'},{id:'trgSelectAsset', name:'xforms:trigger', children:[{id:'xuiLabel4', name:'xforms:label'}]},{id:'optKind', name:'xforms:output'},{id:'optName', name:'xforms:output'},{id:'optSpecType', name:'xforms:output'},{id:'grdSltRepairType', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default4', name:'xforms:value'}]},{id:'optServiceYear', name:'xforms:output'},{id:'iptUsedYear', name:'xforms:output'},{id:'optRemainValue', name:'xforms:output'},{id:'taDescription', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_1292260925', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_1292260925', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'assetRepairApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetRepairApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetRepairApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetRepairApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'df54f7868e3340eaa2e201c42bd823aa', name:'xforms:trigger', children:[{id:'9246ab5a81ee429ebe30b4bcbc892a84', name:'xforms:label'}]},{id:'85d5f689a59b4bc2b9ad29e724b004ae', name:'xforms:trigger', children:[{id:'15a96ad2887d4f71a330f560ae10ceeb', name:'xforms:label'}]}]},{id:'assetRepairApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'wDlgAssetCard', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_N608871938', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_214809411', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_N1627357797', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','4c7379d47db647a8aa0f3d0024ead5e7');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','9132880836874e42aa04631593b7fe35');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'optCode');xf._a(null,'trgSelectAsset');xf._a('trgSelectAsset','xuiLabel4');xf._a(null,'optKind');xf._a(null,'optName');xf._a(null,'optSpecType');xf._a(null,'grdSltRepairType');xf._a('grdSltRepairType','xuiLabel3');xf._a('grdSltRepairType','default5');xf._a(null,'optServiceYear');xf._a(null,'iptUsedYear');xf._a(null,'optRemainValue');xf._a(null,'taDescription');xf._a(null,'taRemark');xf._a(null,'df54f7868e3340eaa2e201c42bd823aa');xf._a('df54f7868e3340eaa2e201c42bd823aa','9246ab5a81ee429ebe30b4bcbc892a84');xf._a(null,'85d5f689a59b4bc2b9ad29e724b004ae');xf._a('85d5f689a59b4bc2b9ad29e724b004ae','15a96ad2887d4f71a330f560ae10ceeb');function init() {	
...
var xf_trigger_df54f7868e3340eaa2e201c42bd823aa=new xforms.XFTrigger('df54f7868e3340eaa2e201c42bd823aa',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetRepairApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetRepairApplyProcess_processConfirmDialog').close();}));xf._p(justep('df54f7868e3340eaa2e201c42bd823aa'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'df54f7868e3340eaa2e201c42bd823aa', evt,false)});	
var xf_trigger_85d5f689a59b4bc2b9ad29e724b004ae=new xforms.XFTrigger('85d5f689a59b4bc2b9ad29e724b004ae',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetRepairApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetRepairApplyProcess_processConfirmDialog').close();}));xf._p(justep('85d5f689a59b4bc2b9ad29e724b004ae'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'85d5f689a59b4bc2b9ad29e724b004ae', evt,false)});	
