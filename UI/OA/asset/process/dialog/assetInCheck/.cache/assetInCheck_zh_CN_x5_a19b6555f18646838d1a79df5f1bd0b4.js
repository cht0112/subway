						...
						if (info.readonly){
							...
							if(0!=img.size()){
								if (!info.enImg){
									...
									if(info.enImg.indexOf(justep.Request.BASE_URL.substr(0, 7)) == -1)						info.enImg = justep.Request.convertURL(info.enImg, true);
								}
								if (!info.disImg){
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'7cc622c94bd340ad9695780cbbb77618', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'iptDate', name:'xforms:input'},{id:'optNO', name:'xforms:output'},{id:'taCheckDepts', name:'xforms:textarea'},{id:'taCheckPsns', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'tbrAssetCheck', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'9dc5188192374f00ad10dc02b76950d0', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'grdAssetCheck', name:'xforms:grid'},{id:'trgOK', name:'xforms:trigger', children:[{id:'3b60498bfd4a43c2aa4cd4ffb183de53', name:'xforms:label'}]},{id:'trgCancel', name:'xforms:trigger', children:[{id:'6a0588ac17ba451bafcff00a11a16a0e', name:'xforms:label'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'iptDate');xf._a(null,'optNO');xf._a(null,'taCheckDepts');xf._a(null,'taCheckPsns');xf._a(null,'taRemark');xf._a(null,'grdAssetCheck');xf._a(null,'trgOK');xf._a('trgOK','3b60498bfd4a43c2aa4cd4ffb183de53');xf._a(null,'trgCancel');xf._a('trgCancel','6a0588ac17ba451bafcff00a11a16a0e');function init() {	
...
new xforms.XFGrid({id:'grdAssetCheck',instance:'subData',systemColumnsPro:'version,fCheckPsnID',onInit:null,type:'grid',smartRender:null,delay:false,ids:'recNo,fCheckItem,fCheckPsn,fDescription,fRemark,fMasterID,space-column',headNames:'序号,验收项,验收人,情况说明,备注,fMasterID,&nbsp;',widths:'30,120,80,150,144,*,*',types:'cntr,ed,ro,ed,ed,ro,ro',hiddenColumns:'fMasterID',aligns:'center,,,,,,',serverSort:true,sorts:'na,na,na,na,na,na,na',fixColumnSize:null,nodeImgCallback:'',multiSelection:'',checkedRef:'',filters:'\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0',sysColumns:'',treeColumnReadonly:true,showTreeIndex:null,editMode:null,filterColumn:true,drag:null,beforeDragCallback:null,afterDragCallback:null,afterFillRowCallback:null,beforeIndexChangedCallback:null,afterIndexChangedCallback:null,contextMenuId:null,rightClickSelected:'true',rightClickCallback:null,allowCheckCallback:null,rowHeight:null,hdrRowH:null,hdrFilterH:null,moveColumn:null,rowValueChangedCallback:null,groupColumn:true,adjustColumn:true,saveColumn:true,showHeaderMenu:'hide-column,save-layout,group-column,adjust-column',hintCallback:null,cascade:null,hasChildrenCallback1:null,onRowCheck:null,onRowChecked:null,onRowCheckedAll:null,onRowExpand:null,onRowClick:null,onRowDblClick:null,onLastEditorPressEnter:null,initFun:function(){}});	
