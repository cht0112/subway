...
_xbl_JSClassDefine_windowFrame.prototype = justep.Object.extend(new justep.XBLObject(), eval({
			"initXBL" : function() {	var windowFrame = new justep.WindowFrame(this.domNode.id, this.domNode.getAttribute("url")||"", this.domNode.getAttribute("auto-load"), 
...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
			...
			"modelRefreshcb" : function(){
				for(var model in this.xformInfo){
					...
					for(var i in infos){				var info = infos[i];
						if (info.readonly){
	...
	var ids=[{id:'wMain', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabBuyApply', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrBuyApplyM', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'assetBuyApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetBuyApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetBuyApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetBuyApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'b2f9e8cfb3ba415b899e4ddeb940d115', name:'xforms:trigger', children:[{id:'57d7c4314eed472b8298ae3e720cb747', name:'xforms:label'}]},{id:'676db5cd4e314d6a82c815cb4fae5d17', name:'xforms:trigger', children:[{id:'deb37af059a94ba984d988d228b6ad66', name:'xforms:label'}]}]},{id:'assetBuyApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'9bc1403dc0dc4ae5abf8400ef6cbaeb6', name:'xforms:label'},{id:'175f68d87e6547839fa706ab983bcafe', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'bb75ffb8887a4ea2bfc0e5d86bc934e0', name:'xforms:value'},{id:'fa92dda7297d4b3683ffb3e9dcb4aee9', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'taApplyReason', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'tbrBuyApplyD', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'grdBuyApplyD', name:'xforms:grid'},{id:'optAmount', name:'xforms:output'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_1356613724', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_1356613724', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_N2033105380', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_180703808', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_239993629', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]},{id:'gsAssetUnit', name:'xforms:gridselect1', children:[{id:'fcf5fb0ab50c4897878e08ae89e9116f', name:'xforms:label'},{id:'359d919eaa3d4fd28e323d82e9c1d98e', name:'xforms:value'}]},{id:'gsAssetKind', name:'xforms:gridselect1', children:[{id:'a140690af4394a96a9b4de6924e5827c', name:'xforms:label'},{id:'6801aa00966c4ddb9e97d521232596b1', name:'xforms:value'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'b2f9e8cfb3ba415b899e4ddeb940d115');xf._a('b2f9e8cfb3ba415b899e4ddeb940d115','57d7c4314eed472b8298ae3e720cb747');xf._a(null,'676db5cd4e314d6a82c815cb4fae5d17');xf._a('676db5cd4e314d6a82c815cb4fae5d17','deb37af059a94ba984d988d228b6ad66');xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','9bc1403dc0dc4ae5abf8400ef6cbaeb6');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','fa92dda7297d4b3683ffb3e9dcb4aee9');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'taApplyReason');xf._a(null,'taRemark');xf._a(null,'grdBuyApplyD');xf._a(null,'optAmount');xf._a(null,'gsAssetUnit');xf._a('gsAssetUnit','fcf5fb0ab50c4897878e08ae89e9116f');xf._a('gsAssetUnit','xf-itemset-2');xf._a(null,'gsAssetKind');xf._a('gsAssetKind','a140690af4394a96a9b4de6924e5827c');xf._a('gsAssetKind','xf-itemset-3');function init() {	
...
var xf_action_xf_action_1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var data = justep.xbl('dBuyApplyM'); if (data){ data.attachEvent(justep.XData.EVENT_REFRESHDATA_BEFORE, function(event){ var conceptName = event.source.getConceptAliasName(); var value = justep.Context.getProcessData1(); var condition = null; if (value){ condition = conceptName + "='" + value + "'"; }else{ condition = "1=0"; } event.source.setFilter("_process-filter_", condition); }, data); }else{ throw new Error("[process组件定义出错]: data属性(" + 'dBuyApplyM' + ")引用的不是xbl组件!"); }}));xf._p(justep('xf-model-1'),"xforms-model-construct",null,function(evt) { xforms.run(xf_action_xf_action_1,'xf-model-1', evt,false)});	
new xforms.XFDialog('assetBuyApplyProcess_processControlDialog',"流转信息",'modal',true,false,true,true,false,"",'700','445',null,null,null,null);	
...
var xf_trigger_b2f9e8cfb3ba415b899e4ddeb940d115=new xforms.XFTrigger('b2f9e8cfb3ba415b899e4ddeb940d115',null,null,null,false,false);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetBuyApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetBuyApplyProcess_processConfirmDialog').close();}));xf._p(justep('b2f9e8cfb3ba415b899e4ddeb940d115'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'b2f9e8cfb3ba415b899e4ddeb940d115', evt,false)});	
var xf_trigger_676db5cd4e314d6a82c815cb4fae5d17=new xforms.XFTrigger('676db5cd4e314d6a82c815cb4fae5d17',null,null,null,false,false);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetBuyApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetBuyApplyProcess_processConfirmDialog').close();}));xf._p(justep('676db5cd4e314d6a82c815cb4fae5d17'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'676db5cd4e314d6a82c815cb4fae5d17', evt,false)});	
...
new xforms.XFExtSelect({id:'treeSltDept',type:'treeselect1',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('dBuyApplyM')/fApplyDeptID"),labelRef:xf._q("data('dBuyApplyM')/fApplyDeptName"),extRef:null,valueSeparator:null,labelSeparator:null,extSeparator:null,dataId:'dOrg',columns:'sName,sCode,sLongName,sFName,sFCode,sFID,sOrgKindID,sSequence,sValidState,sParent,sLevel,sPhone,sFax,sAddress,sZip,sDescription,sPersonID,sNodeKind,version',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'sCode,sLongName,sFName,sFCode,sFID,sOrgKindID,sSequence,sValidState,sParent,sLevel,sPhone,sFax,sAddress,sZip,sDescription,sPersonID,sNodeKind,version',valueColumn:'rowid',labelColumn:'sName',extColumn:null,labels:',,,,,,,,,,,,,,,,,,',aligns:',,,,,,,,,,,,,,,,,,',types:'tree,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro',widths:{widths:"*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*",total:0},height:'',dropdownWidth:'',appearance:null,delay:true,autoLoadData:false,independence:false,delayCreateGrid:false,cascade:false,dataXML:null,inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:'func_155091534',onRowHasChildren:func_1340636408,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:null});	
var xf_model_mdPsm = new xforms.XFModel('mdPsm',null);	
new xforms.XFExtSelect({id:'treeSltPsm',type:'treeselect1',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('dBuyApplyM')/fApplyPsnID"),labelRef:xf._q("data('dBuyApplyM')/fApplyPsnName"),extRef:null,valueSeparator:null,labelSeparator:null,extSeparator:null,dataId:'dPsm',columns:'sName,sCode,sLongName,sFName,sFCode,sFID,sOrgKindID,sSequence,sValidState,sParent,sLevel,sPhone,sFax,sAddress,sZip,sDescription,sPersonID,sNodeKind,version',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'sCode,sLongName,sFName,sFCode,sFID,sOrgKindID,sSequence,sValidState,sParent,sLevel,sPhone,sFax,sAddress,sZip,sDescription,sPersonID,sNodeKind,version',valueColumn:'sPersonID',labelColumn:'sName',extColumn:null,labels:',,,,,,,,,,,,,,,,,,',aligns:',,,,,,,,,,,,,,,,,,',types:'tree,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro',widths:{widths:"*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*,*",total:0},height:'',dropdownWidth:'',appearance:null,delay:true,autoLoadData:false,independence:false,delayCreateGrid:false,cascade:false,dataXML:null,inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:'func_1348990678',onRowHasChildren:func_1961487125,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:'treeSltPsmDropdown',onCloseup:'startActivity.treeSltPsmCloseup'});	
