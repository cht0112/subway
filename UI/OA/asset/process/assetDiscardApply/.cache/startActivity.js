...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'c55d6df021d1411998c41d0343ffb61c', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrDiscardApply', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'230bcf58033b4506a8c2544a5ba7d738', name:'xforms:label'},{id:'bf80e1ec5c16483faa222397a9380a72', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'e8afdabf90f6410bab17e015ebd71a8d', name:'xforms:value'},{id:'53630982b0964a0fbf5bb4d768098874', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'optCode', name:'xforms:output'},{id:'trgSelectAsset', name:'xforms:trigger', children:[{id:'xuiLabel3', name:'xforms:label'}]},{id:'optKind', name:'xforms:output'},{id:'optName', name:'xforms:output'},{id:'optSpecType', name:'xforms:output'},{id:'optServiceYear', name:'xforms:output'},{id:'optUsedYea', name:'xforms:output'},{id:'optEvaluateValue', name:'xforms:output'},{id:'taReason', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_1939944028', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_1939944028', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'assetDiscardApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetDiscardApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetDiscardApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetDiscardApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'e4c0e716db474a2aabc54b9dea535f17', name:'xforms:trigger', children:[{id:'20eccc2b41504dc19f91e4e64b838294', name:'xforms:label'}]},{id:'1d974a4f676541c5bce1d272bce4843c', name:'xforms:trigger', children:[{id:'f0d1fc0d788d4d748608061ade4dd644', name:'xforms:label'}]}]},{id:'assetDiscardApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'wDlgAssetCard', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_1051890362', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_N1753333613', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_N225985542', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','230bcf58033b4506a8c2544a5ba7d738');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','53630982b0964a0fbf5bb4d768098874');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'optCode');xf._a(null,'trgSelectAsset');xf._a('trgSelectAsset','xuiLabel3');xf._a(null,'optKind');xf._a(null,'optName');xf._a(null,'optSpecType');xf._a(null,'optServiceYear');xf._a(null,'optUsedYea');xf._a(null,'optEvaluateValue');xf._a(null,'taReason');xf._a(null,'taRemark');xf._a(null,'e4c0e716db474a2aabc54b9dea535f17');xf._a('e4c0e716db474a2aabc54b9dea535f17','20eccc2b41504dc19f91e4e64b838294');xf._a(null,'1d974a4f676541c5bce1d272bce4843c');xf._a('1d974a4f676541c5bce1d272bce4843c','f0d1fc0d788d4d748608061ade4dd644');function init() {	
...
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var data = justep.xbl('dDiscardApply'); if (data){ data.attachEvent(justep.XData.EVENT_REFRESHDATA_BEFORE, function(event){ var conceptName = event.source.getConceptAliasName(); var value = justep.Context.getProcessData1(); var condition = null; if (value){ condition = conceptName + "='" + value + "'"; }else{ condition = "1=0"; } event.source.setFilter("_process-filter_", condition); }, data); }else{ throw new Error("[process组件定义出错]: data属性(" + 'dDiscardApply' + ")引用的不是xbl组件!"); }}));xf._p(justep('xf-model-3'),"xforms-model-construct",null,function(evt) { xforms.run(xf_action_xf_action_2,'xf-model-3', evt,false)});	
new xforms.XFDialog('assetDiscardApplyProcess_processControlDialog',"流转信息",'modal',true,false,true,true,false,"",'700','445',null,null,null,null);	
...
var xf_trigger_e4c0e716db474a2aabc54b9dea535f17=new xforms.XFTrigger('e4c0e716db474a2aabc54b9dea535f17',null,null,null,false,false);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetDiscardApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetDiscardApplyProcess_processConfirmDialog').close();}));xf._p(justep('e4c0e716db474a2aabc54b9dea535f17'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'e4c0e716db474a2aabc54b9dea535f17', evt,false)});	
var xf_trigger_1d974a4f676541c5bce1d272bce4843c=new xforms.XFTrigger('1d974a4f676541c5bce1d272bce4843c',null,null,null,false,false);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetDiscardApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetDiscardApplyProcess_processConfirmDialog').close();}));xf._p(justep('1d974a4f676541c5bce1d272bce4843c'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'1d974a4f676541c5bce1d272bce4843c', evt,false)});	
...
var xf_trigger_trgSelectAsset=new xforms.XFTrigger('trgSelectAsset',xf._q("data('dSelectTrg')/selectAssetCard"),"/UI/appCommon/images/search.png","/UI/appCommon/images/un_search.png",false,false);	
