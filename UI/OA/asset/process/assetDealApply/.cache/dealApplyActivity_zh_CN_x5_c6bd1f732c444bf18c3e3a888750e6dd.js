...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'7b1e852c04b94cdd9a40006fa91c35ec', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrDealApply', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'cc09853559b9443bb6b223322a8c6986', name:'xforms:label'},{id:'9923ab9c27674eba8ce5be4e93903d43', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'142860994cc7450dbde0b50f69551507', name:'xforms:value'},{id:'3693bdd48a304b6997abc54c6463f02a', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'optCode', name:'xforms:output'},{id:'trgSelectAsset', name:'xforms:trigger', children:[{id:'xuiLabel4', name:'xforms:label'}]},{id:'optKind', name:'xforms:output'},{id:'optName', name:'xforms:output'},{id:'optSpecType', name:'xforms:output'},{id:'grdSltDealType', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default8', name:'xforms:value'}]},{id:'optServiceYear', name:'xforms:output'},{id:'optUsedYear', name:'xforms:output'},{id:'optEvaluateValue', name:'xforms:output'},{id:'taReason', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_948407494', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_948407494', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'assetDealApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetDealApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetDealApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetDealApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'e31c54c308d846ca8396c68f0c18261b', name:'xforms:trigger', children:[{id:'07c1137f04134acaa0687158e27f3964', name:'xforms:label'}]},{id:'c9f17fc275724c5ab9022ff7bae8a69e', name:'xforms:trigger', children:[{id:'ef7d2face0ee40d98d840c57256e898d', name:'xforms:label'}]}]},{id:'assetDealApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'wDlgAssetCard', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_1964797886', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_N1141218361', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_126376623', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','cc09853559b9443bb6b223322a8c6986');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','3693bdd48a304b6997abc54c6463f02a');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'optCode');xf._a(null,'trgSelectAsset');xf._a('trgSelectAsset','xuiLabel4');xf._a(null,'optKind');xf._a(null,'optName');xf._a(null,'optSpecType');xf._a(null,'grdSltDealType');xf._a('grdSltDealType','xuiLabel3');xf._a('grdSltDealType','default9');xf._a(null,'optServiceYear');xf._a(null,'optUsedYear');xf._a(null,'optEvaluateValue');xf._a(null,'taReason');xf._a(null,'taRemark');xf._a(null,'e31c54c308d846ca8396c68f0c18261b');xf._a('e31c54c308d846ca8396c68f0c18261b','07c1137f04134acaa0687158e27f3964');xf._a(null,'c9f17fc275724c5ab9022ff7bae8a69e');xf._a('c9f17fc275724c5ab9022ff7bae8a69e','ef7d2face0ee40d98d840c57256e898d');function init() {	
...
var xf_trigger_e31c54c308d846ca8396c68f0c18261b=new xforms.XFTrigger('e31c54c308d846ca8396c68f0c18261b',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetDealApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetDealApplyProcess_processConfirmDialog').close();}));xf._p(justep('e31c54c308d846ca8396c68f0c18261b'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'e31c54c308d846ca8396c68f0c18261b', evt,false)});	
var xf_trigger_c9f17fc275724c5ab9022ff7bae8a69e=new xforms.XFTrigger('c9f17fc275724c5ab9022ff7bae8a69e',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetDealApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetDealApplyProcess_processConfirmDialog').close();}));xf._p(justep('c9f17fc275724c5ab9022ff7bae8a69e'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'c9f17fc275724c5ab9022ff7bae8a69e', evt,false)});	
