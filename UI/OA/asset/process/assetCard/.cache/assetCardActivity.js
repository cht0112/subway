...
_xbl_JSClassDefine_menu.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				"_itemsets": null,
				initXBL: function(){
					var menuitemsets = this.getElementByXblID("menuitemsets");					this._id = menuitemsets.attributes["menuid"].value;
					this._itemsets = {};
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'92662b9fe4364440b92b8e04261cb8e0', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'table', name:'/UI/system/components/tableLayout.xbl.xml#tableLayout', children:[{id:'tbrAssetCard', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insert', name:'xforms:trigger', children:[{id:'xuiLabel1', name:'xforms:label'}]},{id:'aabdddc3b15548c68b686680f738abbd', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'trgClear', name:'xforms:trigger', children:[{id:'xuiLabel5', name:'xforms:label'}]}]},{id:'extDateFilter1', name:'/UI/appCommon/components/extDateFilter.xbl.xml#extDateFilter', children:[{id:'extDateFilter1_select_1225010063', name:'xforms:gridselect1', children:[{id:'5819da72b1eb42119060e4d59edf4d21', name:'xforms:value'},{id:'f9b6da0237d546728cc642d52da20cb1', name:'xforms:label'}]},{id:'extDateFilter1_dialog_1225010063', name:'xforms:dialog', children:[{id:'c1adcfd072bf4d0bab94a291b1069fd1', name:'xforms:input'},{id:'4cf632acbc8142658abeb408365ec0a9', name:'xforms:input'}]}]},{id:'gridFilterStatus', name:'/UI/appCommon/components/filter.xbl.xml#gridFilter', children:[{id:'gridFilterStatus_select_572195332', name:'xforms:gridselect', children:[{id:'default19', name:'xforms:value'},{id:'xuiLabel2', name:'xforms:label'}]},{id:'gridFilterStatus_defaultValue_572195332', name:'xforms:output'}]},{id:'grdAssetCard', name:'xforms:grid'}]},{id:'filter-dialog-be1629c0-b5a5-4fa2-9205-19422660f37b', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_789845952', name:'xforms:dialog'}]},{id:'filter-pattern-8ffece9d-a685-4fc2-bb75-002866aaac8d', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'e77fd7e15cf4466b8c359a02eadae620', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N778884851', name:'xforms:menu'}]},{id:'GLOBAL_ID_N435219215', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'insert');xf._a('insert','xuiLabel1');xf._a(null,'trgClear');xf._a('trgClear','xuiLabel5');xf._a(null,'extDateFilter1_select_1225010063');xf._a('extDateFilter1_select_1225010063','f9b6da0237d546728cc642d52da20cb1');xf._a('extDateFilter1_select_1225010063','xf-itemset-0');xf._a(null,'c1adcfd072bf4d0bab94a291b1069fd1');xf._a(null,'4cf632acbc8142658abeb408365ec0a9');xf._a(null,'gridFilterStatus_select_572195332');xf._a('gridFilterStatus_select_572195332','xuiLabel2');xf._a('gridFilterStatus_select_572195332','default20');xf._a(null,'gridFilterStatus_defaultValue_572195332');xf._a(null,'grdAssetCard');function init() {	
...
xf._b("instance('extDateFilter1_data_1225010063')/beginDate",xf._g(xf._f('instance',xf._i("extDateFilter1_data_1225010063")),xf._h(false, xf._k("child",xf._j('','beginDate')))));	
xf._b("instance('extDateFilter1_data_1225010063')/endDate",xf._g(xf._f('instance',xf._i("extDateFilter1_data_1225010063")),xf._h(false, xf._k("child",xf._j('','endDate')))));	
xf._b("instance('extDateFilter1_data_1225010063')/value",xf._g(xf._f('instance',xf._i("extDateFilter1_data_1225010063")),xf._h(false, xf._k("child",xf._j('','value')))));	
xf._b("instance('extDateFilter1_data_1225010063')/label",xf._g(xf._f('instance',xf._i("extDateFilter1_data_1225010063")),xf._h(false, xf._k("child",xf._j('','label')))));	
xf._b("'全部'",xf._i("全部"));	
xf._b("rowid",xf._h(false, xf._k("child",xf._j('','rowid'))));	
xf._b("label",xf._h(false, xf._k("child",xf._j('','label'))));	
xf._b("instance('gridFilterStatus_data_572195332')/value",xf._g(xf._f('instance',xf._i("gridFilterStatus_data_572195332")),xf._h(false, xf._k("child",xf._j('','value')))));	
xf._b("instance('gridFilterStatus_data_572195332')/label",xf._g(xf._f('instance',xf._i("gridFilterStatus_data_572195332")),xf._h(false, xf._k("child",xf._j('','label')))));	
...
var xf_trigger_trgClear=new xforms.XFTrigger('trgClear',null,null,null,false,false);	
...
new xforms.XFDialog('GLOBAL_ID_789845952',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1225596249');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1225596249", "");}));xf._p(justep('GLOBAL_ID_789845952'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_789845952', evt,false)});	
var xf_menu_GLOBAL_ID_N778884851 = new xforms.XFMenu('GLOBAL_ID_N778884851','context');xf_menu_GLOBAL_ID_N778884851.menu.addContextZone('e77fd7e15cf4466b8c359a02eadae620');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N778884851.hide()});xf_menu_GLOBAL_ID_N778884851.menu.setOpenMode('web');	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N435219215");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N778884851'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N778884851', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N435219215',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1206271144');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N1206271144", "");}));xf._p(justep('GLOBAL_ID_N435219215'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_N435219215', evt,false)});	
var xf_action_xf_action_8=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1206271144');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N435219215'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_8,'GLOBAL_ID_N435219215', evt,false)});	
...
var xf_model_extDateFilter1_model_1225010063 = new xforms.XFModel('extDateFilter1_model_1225010063',null);	
xf._c('xf-bind-25','extDateFilter1_model_1225010063',"instance('extDateFilter1_data_1225010063')/beginDate","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-26','extDateFilter1_model_1225010063',"instance('extDateFilter1_data_1225010063')/endDate","xsd:date",null,null,null,null,null,null);	
new xforms.XFInstance2('extDateFilter1_data_1225010063','extDateFilter1_model_1225010063',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('extDateFilter1_data_1225010063','value,label,beginDate,endDate');	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){appCommon.component.ExtDateFilter.setFilterCondition("extDateFilter1", justep.xbl("dAssetCard"), "single", "fCreateTime", "", "", "0", null, null, "", false); }));xf._p(justep('extDateFilter1_model_1225010063'),"xforms-model-construct",null,function(evt) { xforms.run(xf_action_xf_action_3,'extDateFilter1_model_1225010063', evt,false)});	
new xforms.XFExtSelect({id:'extDateFilter1_select_1225010063',type:'gridselect1',defaultLabelRef:xf._q("'全部'"),allSelectedLabelRef:null,ref:xf._q("instance('extDateFilter1_data_1225010063')/value"),labelRef:xf._q("instance('extDateFilter1_data_1225010063')/label"),extRef:null,valueSeparator:null,labelSeparator:null,extSeparator:null,dataId:null,columns:'label',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'',valueColumn:'rowid',labelColumn:'label',extColumn:null,labels:'',aligns:'',types:'ro',widths:{widths:"*",total:0},height:'',dropdownWidth:'',appearance:null,delay:false,autoLoadData:false,independence:false,delayCreateGrid:false,cascade:false,dataXML:'<rows><row id="0"><cell>全部</cell></row><row id="1"><cell>今天</cell></row><row id="2"><cell>昨天</cell></row><row id="3"><cell>本周</cell></row><row id="4"><cell>上周</cell></row><row id="5"><cell>本月</cell></row><row id="6"><cell>上月</cell></row><row id="7"><cell>今年</cell></row><row id="8"><cell>去年</cell></row><row id="9"><cell>自定义...</cell></row></rows>',inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:null});	
new xforms.XFDialog('extDateFilter1_dialog_1225010063',"自定义",'model',true,false,true,true,false,null,'250','135',null,null,null,null);	
xf._d('c1adcfd072bf4d0bab94a291b1069fd1','text',xf._q("instance('extDateFilter1_data_1225010063')/beginDate"),null,null,null,null,false,false);	
xf._d('4cf632acbc8142658abeb408365ec0a9','text',xf._q("instance('extDateFilter1_data_1225010063')/endDate"),null,null,null,null,false,false);	
var xf_model_gridFilterStatus_model_572195332 = new xforms.XFModel('gridFilterStatus_model_572195332',null);	
new xforms.XFInstance2('gridFilterStatus_data_572195332','gridFilterStatus_model_572195332',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('gridFilterStatus_data_572195332','value,label');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){appCommon.component.Filter.setFilterCondition("gridFilterStatus", justep.xbl("dAssetCard"), "fStatus", "", appCommon.component.Filter.getDefaultValueBinding("gridFilterStatus_defaultValue_572195332"), true, ",", "", false); }));xf._p(justep('gridFilterStatus_model_572195332'),"xforms-model-construct",null,function(evt) { xforms.run(xf_action_xf_action_4,'gridFilterStatus_model_572195332', evt,false)});	
new xforms.XFExtSelect({id:'gridFilterStatus_select_572195332',type:'gridselect',defaultLabelRef:xf._q("'闲置,占用'"),allSelectedLabelRef:xf._q("'全部'"),ref:xf._q("instance('gridFilterStatus_data_572195332')/value"),labelRef:xf._q("instance('gridFilterStatus_data_572195332')/label"),extRef:null,valueSeparator:',',labelSeparator:',',extSeparator:null,dataId:'dAssetStatus',columns:'label,value',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'value',valueColumn:'value',labelColumn:'label',extColumn:null,labels:',',aligns:',',types:'checkbox,ro',widths:{widths:"*,*",total:0},height:'',dropdownWidth:'',appearance:null,delay:false,autoLoadData:true,independence:false,delayCreateGrid:false,cascade:false,dataXML:null,inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:null});	
var xf_output_gridFilterStatus_defaultValue_572195332=new xforms.XFOutput('gridFilterStatus_defaultValue_572195332',xf._q("'0,1'"),null,null);	
}	
...
if(xforms.ready)justep('extDateFilter1_model_1225010063').xformsObject.construct_part();	
if(xforms.ready)justep('gridFilterStatus_model_572195332').xformsObject.construct_part();	
}	
