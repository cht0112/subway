...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'b0d5ffe5f4864f79849873e5d6deca37', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'tbrUseApply', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'optNO', name:'xforms:output'},{id:'orgSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltDept', name:'xforms:treeselect1', children:[{id:'06f42e3df8594ed29fe145ff10d20584', name:'xforms:label'},{id:'296bbb75c4444a6c87e59438566d866b', name:'xforms:value'}]}]},{id:'psmSelect', name:'/UI/system/components/orgSelect.xbl.xml#orgSelect', children:[{id:'treeSltPsm', name:'xforms:treeselect1', children:[{id:'30fca9a0ae694b9cb510cffc64f0c10c', name:'xforms:value'},{id:'2195b0f6c48248449b18f86fd2b3a863', name:'xforms:label'}]}]},{id:'iptApplyDate', name:'xforms:input'},{id:'grdSltKind', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default9', name:'xforms:value'}]},{id:'iptName', name:'xforms:input'},{id:'iptDemandDate', name:'xforms:input'},{id:'iptReturnDate', name:'xforms:input'},{id:'taApplyReason', name:'xforms:textarea'},{id:'taRequire', name:'xforms:textarea'},{id:'taRemark', name:'xforms:textarea'},{id:'standardProcessExecuteList', name:'/UI/appCommon/components/standardProcessExecuteList.xbl.xml#standardProcessExecuteList', children:[{id:'standardProcessExecuteList_collapse_panel_953137770', name:'/UI/system/components/collapsePanel.xbl.xml#collapsePanel', children:[{id:'standardProcessExecuteList_windowFrame_953137770', name:'/UI/system/components/windowFrame.xbl.xml#windowFrame'}]}]},{id:'assetUseApplyProcess', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'assetUseApplyProcess_processControlDialog', name:'xforms:dialog'},{id:'assetUseApplyProcess_processChartDialogID', name:'xforms:dialog'},{id:'assetUseApplyProcess_processConfirmDialog', name:'xforms:dialog', children:[{id:'2aa3d6be8c544847997b45eb7b2d6ead', name:'xforms:trigger', children:[{id:'b3635765d51841de837e16dc936fa020', name:'xforms:label'}]},{id:'4a4f0b5e7e6540598f704d60bba74e60', name:'xforms:trigger', children:[{id:'c33c62b10fe942de850378b8ec42f66e', name:'xforms:label'}]}]},{id:'assetUseApplyProcess_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'processChart', name:'/UI/system/components/processChart.xbl.xml#processChart', children:[{id:'GLOBAL_ID_1199768984', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'GLOBAL_ID_N1611172011', name:'/UI/system/components/processChart.xbl.xml#processTrackChart', children:[{id:'bl2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout'}]},{id:'GLOBAL_ID_N1571106054', name:'/UI/system/components/processChart.xbl.xml#processPertChart'}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'optNO');xf._a(null,'treeSltDept');xf._a('treeSltDept','06f42e3df8594ed29fe145ff10d20584');xf._a('treeSltDept','xf-itemset-0');xf._a(null,'treeSltPsm');xf._a('treeSltPsm','2195b0f6c48248449b18f86fd2b3a863');xf._a('treeSltPsm','xf-itemset-1');xf._a(null,'iptApplyDate');xf._a(null,'grdSltKind');xf._a('grdSltKind','xuiLabel3');xf._a('grdSltKind','default10');xf._a(null,'iptName');xf._a(null,'iptDemandDate');xf._a(null,'iptReturnDate');xf._a(null,'taApplyReason');xf._a(null,'taRequire');xf._a(null,'taRemark');xf._a(null,'2aa3d6be8c544847997b45eb7b2d6ead');xf._a('2aa3d6be8c544847997b45eb7b2d6ead','b3635765d51841de837e16dc936fa020');xf._a(null,'4a4f0b5e7e6540598f704d60bba74e60');xf._a('4a4f0b5e7e6540598f704d60bba74e60','c33c62b10fe942de850378b8ec42f66e');function init() {	
...
var xf_trigger_2aa3d6be8c544847997b45eb7b2d6ead=new xforms.XFTrigger('2aa3d6be8c544847997b45eb7b2d6ead',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetUseApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('assetUseApplyProcess_processConfirmDialog').close();}));xf._p(justep('2aa3d6be8c544847997b45eb7b2d6ead'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'2aa3d6be8c544847997b45eb7b2d6ead', evt,false)});	
var xf_trigger_4a4f0b5e7e6540598f704d60bba74e60=new xforms.XFTrigger('4a4f0b5e7e6540598f704d60bba74e60',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('assetUseApplyProcess_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('assetUseApplyProcess_processConfirmDialog').close();}));xf._p(justep('4a4f0b5e7e6540598f704d60bba74e60'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'4a4f0b5e7e6540598f704d60bba74e60', evt,false)});	
