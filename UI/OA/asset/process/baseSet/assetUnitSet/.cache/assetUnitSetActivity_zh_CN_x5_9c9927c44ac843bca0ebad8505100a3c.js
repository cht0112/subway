...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'4673041b71fc49b49b8d61b366791236', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tbrListToolbar', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'8f445d625d184df29648efc1724ace81', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'trgStartUse', name:'xforms:trigger', children:[{id:'abc583c47b3f46d7a3ea0480f42b024f', name:'xforms:label'}]},{id:'trgAllUse', name:'xforms:trigger', children:[{id:'a75cee2101ed4032840877e43f234703', name:'xforms:label'}]},{id:'trgStopUse', name:'xforms:trigger', children:[{id:'caadab50679f4d6e8dba67dba7b8bfeb', name:'xforms:label'}]}]},{id:'listGrid', name:'xforms:grid'},{id:'filter-dialog-90184504-43bf-464b-9731-17d8929bffca', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N899867839', name:'xforms:dialog'}]},{id:'filter-pattern-f7c1f681-6ef5-4646-af45-7d1a7eeae6e5', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'f8b547caabda43e28cff57af505e931b', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_944020690', name:'xforms:menu'}]},{id:'GLOBAL_ID_166782877', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'trgStartUse');xf._a('trgStartUse','abc583c47b3f46d7a3ea0480f42b024f');xf._a(null,'trgAllUse');xf._a('trgAllUse','a75cee2101ed4032840877e43f234703');xf._a(null,'trgStopUse');xf._a('trgStopUse','caadab50679f4d6e8dba67dba7b8bfeb');xf._a(null,'listGrid');function init() {	
...
xf._c('xf-bind-1','model1',"instance('dPubBaseCode')/version","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-2','model1',"instance('dPubBaseCode')/fLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-3','model1',"instance('dPubBaseCode')/fCreateTime","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-4','model1',"instance('dPubBaseCode')/fUpdateTime","xsd:dateTime",null,null,null,null,null,null);	
...
xf._c('xf-bind-5','model1',"instance('dBtnStatus')/startUse",null,"instance('dPubBaseCode')/fUseStatus = '1'",null,null,null,null,null);	
xf._c('xf-bind-6','model1',"instance('dBtnStatus')/stopUse",null,"not(instance('dPubBaseCode')/fUseStatus = '1')",null,null,null,null,null);	
xforms.load_parts('rootView');	
new xforms.XFDialog('GLOBAL_ID_N899867839',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_301417546');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_301417546", "");}));xf._p(justep('GLOBAL_ID_N899867839'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_3,'GLOBAL_ID_N899867839', evt,false)});	
var xf_menu_GLOBAL_ID_944020690 = new xforms.XFMenu('GLOBAL_ID_944020690','context');xf_menu_GLOBAL_ID_944020690.menu.addContextZone('f8b547caabda43e28cff57af505e931b');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_944020690.hide()});xf_menu_GLOBAL_ID_944020690.menu.setOpenMode('web');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_166782877");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_944020690'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_944020690', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_166782877',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1349407694');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_1349407694", "");}));xf._p(justep('GLOBAL_ID_166782877'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_166782877', evt,false)});	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1349407694');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_166782877'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_166782877', evt,false)});	
