...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'6ba0cb35d90a4ff58c74801583d3e8c0', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tbrListToolbar', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'03cf14b012fa4c72a5caec450455f13c', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'trgStartUse', name:'xforms:trigger', children:[{id:'a9b4045b63dc40a6bf9c9fb2571767b2', name:'xforms:label'}]},{id:'trgAllUse', name:'xforms:trigger', children:[{id:'cea6377c6e2a4c52a67b61fac3eccf5c', name:'xforms:label'}]},{id:'trgStopUse', name:'xforms:trigger', children:[{id:'e2fb856737f04d6693e98822448ffa5a', name:'xforms:label'}]}]},{id:'listGrid', name:'xforms:grid'},{id:'filter-dialog-688f6e74-8a5e-4f91-97d6-d2368635a88a', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N197631723', name:'xforms:dialog'}]},{id:'filter-pattern-405088e0-f31e-4fdb-834e-d2ca92a635ab', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'52405fee1d5344279720be8b9f876636', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N1144313884', name:'xforms:menu'}]},{id:'GLOBAL_ID_N817757916', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'trgStartUse');xf._a('trgStartUse','a9b4045b63dc40a6bf9c9fb2571767b2');xf._a(null,'trgAllUse');xf._a('trgAllUse','cea6377c6e2a4c52a67b61fac3eccf5c');xf._a(null,'trgStopUse');xf._a('trgStopUse','e2fb856737f04d6693e98822448ffa5a');xf._a(null,'listGrid');function init() {	
...
new xforms.XFDialog('GLOBAL_ID_N197631723',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1864016152');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1864016152", "");}));xf._p(justep('GLOBAL_ID_N197631723'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_3,'GLOBAL_ID_N197631723', evt,false)});	
var xf_menu_GLOBAL_ID_N1144313884 = new xforms.XFMenu('GLOBAL_ID_N1144313884','context');xf_menu_GLOBAL_ID_N1144313884.menu.addContextZone('52405fee1d5344279720be8b9f876636');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N1144313884.hide()});xf_menu_GLOBAL_ID_N1144313884.menu.setOpenMode('web');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N817757916");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N1144313884'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_N1144313884', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N817757916',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_999663838');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_999663838", "");}));xf._p(justep('GLOBAL_ID_N817757916'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N817757916', evt,false)});	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_999663838');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N817757916'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N817757916', evt,false)});	
