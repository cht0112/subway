$(document).ready(function(){
	...
	$('#appleApp').bind('click',function(){
		window.open('http://itunes.apple.com/us/app/x5/id541487259','_downIOS');
	});
	$('#androidApp').bind('click',function(){
		window.open(justep.Request.convertURL('/UI/portal2/process/portal/x5_Pad.apk'),'_downAndroid');
	});
	//判断license是否有效
