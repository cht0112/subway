...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xui:view id="rootView"> 
    ...
    <xforms:input id="inputTitle" ref="data('dPerson')/sTitle"/>  
    ...
    <xforms:input id="inputFamilyPhone" ref="data('dPerson')/sFamilyPhone"/>  
  ...
  <xforms:input id="input2" ref="data('dPerson')/sPasswordModifyTime" format="yyyy-MM-dd hh:mm"></xforms:input>  
    ...
    <xui:layout style="height:100%;width:100%;position:relative;" id="rootLayout"
      ...
      <xui:place control="inputTitle" id="controlPlace13" style="position:absolute;width:141px;top:190px;left:298px;"/>  
      <xui:place control="inputDegree" id="controlPlace14" style="position:absolute;width:140px;top:220px;left:88px;"/>  
      ...
      <xui:place control="gridSelectMarriage" id="controlPlace17" style="position:absolute;width:140px;top:100px;left:298px;"/>  
      ...
      <xui:place control="inputJoinDate" id="controlPlace20" style="position:absolute;width:141px;top:190px;left:88px;"/>  
      <xui:place control="inputGraduateSchool" id="controlPlace21" style="position:absolute;width:140px;top:220px;left:298px;"/>  
      <xui:place control="inputSpeciality" id="controlPlace22" style="position:absolute;width:140px;top:250px;left:88px;"/>  
      <xui:place control="inputSchoolLength" id="controlPlace23" style="position:absolute;width:140px;top:250px;left:298px;"/>  
      <xui:place control="inputMail" id="controlPlace24" style="position:absolute;width:140px;top:280px;left:88px;"/>  
      ...
      <xui:place control="inputOfficePhone" id="controlPlace28" style="position:absolute;width:140px;top:310px;left:88px;"/>  
      <xui:place control="inputMobilePhone" id="controlPlace29" style="position:absolute;width:140px;top:310px;left:298px;"/>  
      <xui:place control="inputFamilyPhone" id="controlPlace30" style="position:absolute;width:146px;top:310px;left:508px;"/>  
      <xui:place control="inputZip" id="controlPlace31" style="position:absolute;width:140px;top:340px;left:88px;"/>  
      ...
      <xui:place control-label="gridSelectMarriage" id="controlLabel7" style="position:absolute;top:106px;left:238px;"/>  
      ...
      <xui:place control-label="inputJoinDate" id="controlLabel13" style="position:absolute;top:196px;left:8px;"/>  
      <xui:place control-label="inputTitle" id="controlLabel14" style="position:absolute;top:196px;left:238px;"/>  
      <xui:place control-label="inputDegree" id="controlLabel15" style="position:absolute;top:226px;left:8px;"/>  
      <xui:place control-label="inputGraduateSchool" id="controlLabel16" style="position:absolute;top:226px;left:238px;"/>  
      <xui:place control-label="inputSpeciality" id="controlLabel17" style="position:absolute;top:256px;left:8px;"/>  
      <xui:place control-label="inputSchoolLength" id="controlLabel18" style="position:absolute;top:256px;left:238px;"/>  
      <xui:place control-label="inputMail" id="controlLabel19" style="position:absolute;top:286px;left:8px;"/>  
      <xui:place control-label="inputQQ" id="controlLabel20" style="position:absolute;top:286px;left:238px;"/>  
      <xui:place control-label="inputMsn" id="controlLabel21" style="position:absolute;top:286px;left:448px;"/>  
      <xui:place control-label="inputOfficePhone" id="controlLabel22" style="position:absolute;top:316px;left:8px;"/>  
      <xui:place control-label="inputMobilePhone" id="controlLabel23" style="position:absolute;top:316px;left:238px;"/>  
      <xui:place control-label="inputFamilyPhone" id="controlLabel24" style="position:absolute;top:316px;left:448px;"/>  
      <xui:place control-label="inputZip" id="controlLabel25" style="position:absolute;left:8px;top:345px;"/>  
  ...
  <xhtml:label id="label3" style="position:absolute;width:110px;top:448px;height:18px;left:183px;" class="xui-label">密码最后修改时间</xhtml:label></xui:layout> 
  </xui:view>  
