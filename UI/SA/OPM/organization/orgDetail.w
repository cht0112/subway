...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <creator id="default7"></creator></data></xforms:model>  
  <xui:view id="rootView"> 
    ...
    <xui:layout style="position:relative;height:100%;width:100%;" id="rootLayout"
      ...
      <xui:place control="inputZip" id="controlPlace14" style="position:absolute;width:147px;top:159px;left:249px;"/>  
      ...
      <xui:place control-label="inputZip" id="controlLabel8" style="position:absolute;top:164px;left:208px;"/>  
      ...
      <xui:place control-label="inputOrgKind" id="controlLabel11" style="position:absolute;top:104px;left:7px;"
        label="类型"/>  
      <xui:place control="textareaDescription" id="controlPlace17" style="position:absolute;width:348px;top:189px;height:70px;left:49px;"/>  
      <xui:place control-label="textareaDescription" id="controlLabel13" style="position:absolute;top:194px;left:8px;"/> 
      <xui:place control="btnOK" id="controlPlace6" style="position:absolute;width:75px;top:268px;left:241px;"/>  
      <xui:place control="btnCancel" id="controlPlace7" style="position:absolute;width:75px;top:268px;left:323px;"/>  
    <xui:place control-label="simpleSelect1" id="controlLabel1" style="position:absolute;top:106px;left:208px;"></xui:place><xui:place control="simpleSelect1" id="controlPlace2" style="position:absolute;width:145px;top:99px;left:250px;"></xui:place></xui:layout> 
  <xhtml:div component="/UI/system/components/select.xbl.xml#simpleSelect" id="simpleSelect1" ref="data('dOrg')/sLevel" option-data="dOrgLevel" option-label="sName" option-value="sCode"></xhtml:div></xui:view>  
