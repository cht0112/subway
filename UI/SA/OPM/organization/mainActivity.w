...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/window.xbl.xml#window">  
  ...
  <xui:view id="rootView" auto-load="true"> 
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" width="406px" height="299px" modal="true" id="wdOrgDetail" url="/SA/OPM/organization/orgDetail.w" resizable="false" minmaxable="false" reload-on-open="false" title="组织" onReceive="mainActivity.wdOrgDetailReceive" dialogUpdate="true"/>  
    ...
    <xhtml:div component="/UI/system/components/menuButton.xbl.xml#menuButton" id="menuButton1" label="更多操作" mode="down left"> 
      ...
      <menuitem id="itemChangeMainOrg" label="设置主岗" name="itemChangeMainOrg" icon-class="icon-system-users" onClick="mainActivity.btnChangeMainOrgClick"/> 
    </xhtml:div>  
  ...
  <xforms:column ref="label" id="default22"></xforms:column></xforms:itemset></xhtml:div></xui:view>  
