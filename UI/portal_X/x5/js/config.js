...
portalConfig.shortcuts=[
	  //{title:"检测流程",url:"/metrodetection/detection_Process_Related/process/detectionManager/mainActivityNew.w?log=1",process:"/metrodetection/detection_Process_Related/process/detectionManager/detectionManagerProcess",activity:"mainActivityNew",width:"",height:"",openType:"",params:"",id:"",icon:"",thumbnail:"",refresh:false,hideTree:false}
];           
