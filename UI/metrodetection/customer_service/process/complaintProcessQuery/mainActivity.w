...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model1" style="top:96px;height:auto;left:213px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereVersion"
      ...
      order-by="sCreateTime desc" filter-relations="sName,sCreateTime,sLastModifyTime,sCreatorPersonName"> 
  ...
  <xui:view id="rootView"> 
    ...
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column"
      ...
      <xui:column id="gridColumn3" ref="sStatusName1" label="状态" type="ro" width="60px"
        ...
        <xui:column id="gridColumn1" ref="sESField05" label="投诉文档单据号" type="html" width="120px"
        onRender="mainActivity.grid_sNameRender"/> 
        <xui:column id="gridColumn2" ref="sName" label="名称" type="ro" width="560px"></xui:column>
...
<!--        onRender="mainActivity.grid_sNameRender"/>  -->
      <xui:column id="gridColumn7" ref="sCreatorPersonName" label="提交人" type="ro"
        width="100px"/>  
      <xui:column id="gridColumn5" ref="sCreateTime" label="提交时间" type="ro" width="130px"/>  
      <xui:column id="gridColumn6" ref="sLastModifyTime" label="最后修改时间" type="ro" width="130px"/> 
    </xhtml:div>  
