...
<window xmlns="http://www.justep.com/xui" xmlns:ev="http://www.w3.org/2001/xml-events"
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="flow" style="position:relative;" id="layout1"> 
        <xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout"
          id="excelLayout1" src="complaint2_xls.xls" style="width:100%;height:998px;"/> 
      </layout>  
     ...
     <cell id="default44">其他</cell></row> </rows> </itemset-data></xforms:itemset> 
      ...
      <xui:view auto-load="false" id="view2" class="xui-container" style="border-color:#000000 #000000 #000000 #000000;border-style:double double double double;border-width:1px 1px 1px 1px;width:100%;height:198px;"> 
        <layout type="absolute" style="position:relative;" id="layout2"> 
          <xui:place control="toolbars1" id="controlPlace3" style="position:absolute;left:10px;top:5px;width:696px;height:35px;"/>  
          <xui:place control="view3" id="controlPlace4" style="position:absolute;top:34px;left:4px;border-color:#FFFFFF #FFFFFF #FFFFFF #FFFFFF;width:100%;height:159px;"/> 
        </layout>  
        ...
        <xui:view auto-load="true" id="view3" class="xui-container"> 
          <layout type="absolute" style="position:relative;" id="layout3"> 
            <xui:place control="report1" id="controlPlace5" style="position:absolute;top:5px;width:767px;left:29px;height:144px;"/> 
          </layout>  
  ...
  <xforms:input id="input1" ref="data('complaintData')/MAILING_ADDRESS" style="width:604px;" disabled="true"></xforms:input>
  <xforms:input id="input5" ref="data('complaintData')/POSTCODE" style="width:193px;" disabled="true"></xforms:input>
