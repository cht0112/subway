...
_xbl_JSClassDefine_menu.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				initXBL: function(){
					...
					for (var i = 0; len > i; i++) {
						...
						this._itemsets[info["id"]] = info;	if(info["init-loaded"] == "true"){
					...
					if (typeof(filterData.advanceFilter) != "undefined") {
						...
						if(dialog) {
							...
							if (frameEl) {
								...
								frameEl.callBack = callBack;		dialog.open();
								return true;
							}
						}
					}
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'2118f4ddd83442ebb15d856c585ba51f', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'dlgChart', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'process', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'process_processControlDialog', name:'xforms:dialog'},{id:'process_processChartDialogID', name:'xforms:dialog'},{id:'process_processConfirmDialog', name:'xforms:dialog', children:[{id:'1cd2bae9138e4d99963767462aa7eb0c', name:'xforms:trigger', children:[{id:'ef19409d57fe4a63ac1f815db194811c', name:'xforms:label'}]},{id:'d482815a939043068c163e7fecd2987d', name:'xforms:trigger', children:[{id:'2d36b7db92d54b079f9bd75ee0f7a137', name:'xforms:label'}]}]},{id:'process_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'240ab4efc856447aa653edc6254b3bc9', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'dateFilter1', name:'/UI/system/components/dateFilter.xbl.xml#dateFilter', children:[{id:'dateFilter1_part', name:'xforms:group', children:[{id:'dateFilter1_dialog', name:'xforms:dialog', children:[{id:'1c3b09f8a4ce48b4961c92bc4e7f1539', name:'/UI/system/components/tableLayout.xbl.xml#tableLayout', children:[{id:'09375f96772846be9080a0d4ac1a78f3', name:'xforms:input'},{id:'e90461b46fb343a38ce4efee724fa386', name:'xforms:input'},{id:'a0fec015763f4af7a199f85287169109', name:'xforms:trigger', children:[{id:'cb1ee32df2794b8b97cda7fbfcacb0a0', name:'xforms:label'}]},{id:'961fed0c2eb44b6c8577c98b34160d55', name:'xforms:trigger', children:[{id:'d7a3ceda20d44847b18221f671fe9d3e', name:'xforms:label'}]}]}]}]}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'gridSelect1', name:'xforms:gridselect', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'smartFilter1', name:'/UI/system/components/smartFilter.xbl.xml#smartFilter', children:[{id:'smartFilter1_input_2004278730', name:'xforms:input'}]},{id:'trgSearch', name:'xforms:trigger', children:[{id:'xuiLabel10', name:'xforms:label'}]},{id:'grid', name:'xforms:grid'}]},{id:'filter-pattern-0276f26a-b3ff-4af2-888c-b3a0ce94d603', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'0ca7e9c724f043fcbd46b644dfe08f34', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N1865280944', name:'xforms:menu'}]},{id:'GLOBAL_ID_1145874352', name:'xforms:dialog'}]},{id:'filter-dialog-a57c3e1d-66f0-4acc-b424-52faea04c30c', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N1536728492', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'1cd2bae9138e4d99963767462aa7eb0c');xf._a('1cd2bae9138e4d99963767462aa7eb0c','ef19409d57fe4a63ac1f815db194811c');xf._a(null,'d482815a939043068c163e7fecd2987d');xf._a('d482815a939043068c163e7fecd2987d','2d36b7db92d54b079f9bd75ee0f7a137');xf._a(null,'dateFilter1_part');xf._a('dateFilter1_part','09375f96772846be9080a0d4ac1a78f3');xf._a('dateFilter1_part','e90461b46fb343a38ce4efee724fa386');xf._a('dateFilter1_part','a0fec015763f4af7a199f85287169109');xf._a('a0fec015763f4af7a199f85287169109','cb1ee32df2794b8b97cda7fbfcacb0a0');xf._a('dateFilter1_part','961fed0c2eb44b6c8577c98b34160d55');xf._a('961fed0c2eb44b6c8577c98b34160d55','d7a3ceda20d44847b18221f671fe9d3e');xf._a(null,'gridSelect2');xf._a('gridSelect2','xuiLabel6');xf._a('gridSelect2','default3');xf._a(null,'gridSelect1');xf._a('gridSelect1','xf-label-5');xf._a('gridSelect1','xf-itemset-1');xf._a(null,'smartFilter1_input_2004278730');xf._a(null,'trgSearch');xf._a('trgSearch','xuiLabel10');xf._a(null,'grid');function init() {	
...
xf._b("instance('smartFilter1_data_2004278730')/value",xf._g(xf._f('instance',xf._i("smartFilter1_data_2004278730")),xf._h(false, xf._k("child",xf._j('','value')))),'','http://www.justep.com/xui');	
...
var xf_trigger_1cd2bae9138e4d99963767462aa7eb0c=new xforms.XFTrigger('1cd2bae9138e4d99963767462aa7eb0c',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('process_processConfirmDialog').close();}));xf._p(justep('1cd2bae9138e4d99963767462aa7eb0c'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'1cd2bae9138e4d99963767462aa7eb0c', evt,false)});	
var xf_trigger_d482815a939043068c163e7fecd2987d=new xforms.XFTrigger('d482815a939043068c163e7fecd2987d',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('process_processConfirmDialog').close();}));xf._p(justep('d482815a939043068c163e7fecd2987d'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'d482815a939043068c163e7fecd2987d', evt,false)});	
...
var xf_model_smartFilter1_model_2004278730 = new xforms.XFModel('smartFilter1_model_2004278730',null);	
new xforms.XFInstance2('smartFilter1_data_2004278730','smartFilter1_model_2004278730',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('smartFilter1_data_2004278730','value');	
xf._d('smartFilter1_input_2004278730','text',xf._q("instance('smartFilter1_data_2004278730')/value"),null,null,null,null,false,false);	
...
xf._d('09375f96772846be9080a0d4ac1a78f3','text',xf._q("instance('dateFilter1_data')/beginDate"),null,null,null,null,false,false);	
xf._d('e90461b46fb343a38ce4efee724fa386','text',xf._q("instance('dateFilter1_data')/endDate"),null,null,null,null,false,false);	
var xf_trigger_a0fec015763f4af7a199f85287169109=new xforms.XFTrigger('a0fec015763f4af7a199f85287169109',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){xforms.blur(true); if(justep.xbl('dateFilter1')._doDialogCheck()) xforms('dateFilter1_dialog').close();}));xf._p(justep('a0fec015763f4af7a199f85287169109'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_5,'a0fec015763f4af7a199f85287169109', evt,false)});	
var xf_trigger_961fed0c2eb44b6c8577c98b34160d55=new xforms.XFTrigger('961fed0c2eb44b6c8577c98b34160d55',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){xforms('dateFilter1_dialog').close();}));xf._p(justep('961fed0c2eb44b6c8577c98b34160d55'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_6,'961fed0c2eb44b6c8577c98b34160d55', evt,false)});	
}	
...
function load_dateFilter1_part_html(){var a = [];a.push('<div class="xforms-group-content" style="" >');a.push('<div id="dateFilter1_dialog" style="display:none" >');a.push('</div>');a.push('<div style="width:234px;height:87px;position:absolute;left:-9000px;top:-9000px" >');a.push('<div class="xforms-dialog" height="112" id="dateFilter1_dialog-content" minmax="false" resizable="false" style="width:100%;height:100%" title="自定义" width="238" >');a.push('<table border="0" cellpadding="0" cellspacing="8" class="component_42908985 tableLayout" component="/UI/system/components/tableLayout.xbl.xml#tableLayout" id="1c3b09f8a4ce48b4961c92bc4e7f1539" style="width:100%;height:100%;tabel-layout:fixed" >');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('开始日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="09375f96772846be9080a0d4ac1a78f3" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('结束日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="e90461b46fb343a38ce4efee724fa386" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr valign="middle" >');a.push('<td align="right" colspan="2" >');a.push('<table cellpadding="0" cellspacing="0" class="button-green xforms-control xforms-trigger xforms-appearance-minimal xui-button" id="a0fec015763f4af7a199f85287169109" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" style="width:75px;margin-right:8px;;table-layout:fixed" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="xxf-value" >');a.push('<button class="xui-button-label" onmouseout="xforms.Core.setClass(this,\'xforms-trigger-over\')" onmouseover="xforms.Core.setClass(this,\'xforms-trigger-over\',true)" tabindex="" type="button" >');a.push('<span class="xforms-label " id="cb1ee32df2794b8b97cda7fbfcacb0a0" >');a.push('确定');a.push('</span>');a.push('</button>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-trigger xforms-appearance-minimal xui-button" id="961fed0c2eb44b6c8577c98b34160d55" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" style="width:75px;;table-layout:fixed" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="xxf-value" >');a.push('<a class="xui-button-label" tabindex="" >');a.push('<i class="icon " >');a.push('</i>');a.push('<span class="xforms-label " id="d7a3ceda20d44847b18221f671fe9d3e" >');a.push('取消');a.push('</span>');a.push('</a>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('</table>');a.push('</div>');a.push('</div>');a.push('</div>');justep('dateFilter1_part').innerHTML = a.join('');}