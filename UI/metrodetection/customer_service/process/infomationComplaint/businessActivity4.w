...
<data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="xml" auto-load="false" id="bizData2" concept="CUSTOMER_COMPLAINT_FEEDBACK" auto-new="true" store-type="simple" confirm-refresh="false" onValueChanged="businessActivity4.bizData2ValueChanged"><creator id="default14" action="/metrodetection/customer_service/logic/action/createCUSTOMER_COMPLAINT_FEEDBACKAction"></creator>
  ...
  <rule id="dataBizRule1" relation="TREATMENT_VERIFICATION" required="true()" alert="'处理效果情况验证不能为空!'"></rule></data>
  <xforms:action id="action2" ev:event="onload"><xforms:script id="xformsScript2"><![CDATA[businessActivity4.mdDefaultLoad(event)]]></xforms:script></xforms:action></xforms:model>
        ...
        <item> 
          <xforms:trigger appearance="image-text" id="saveTrigger" image-text-mode="LR"
            ...
            <xforms:action ev:event="DOMActivate">  
              <xforms:script><![CDATA[businessActivity4.saveMore(event)]]></xforms:script> 
            </xforms:action> 
          </xforms:trigger> 
        </item> 
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/process.xbl.xml#process" data="dataMain" id="flw" auto-save="true" onAdvanceCommit="businessActivity4.flwAdvanceCommit" auto-filter="false"/>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/excelLayout.xbl.xml#excelLayout" id="excelLayout1" style="position:absolute;width:105%;top:5px;left:6px;height:869px;" src="complaintSetting_xls4.xls" />
</layout>
...
<xforms:select1 ref="data('dataMain')/COMPLAINT_SOURCE" id="radio2" disabled="true">
  ...
  <xforms:textarea ref="data('dataMain')/SOLVING_DESCRIPTION" id="textarea2" style="height:60px;" disabled="true"></xforms:textarea>
  ...
  <xforms:input id="input13" ref="data('dataMain')/oPERATORNAME2" disabled="true"></xforms:input>
  <xforms:input id="input18" ref="data('dataMain')/APPROVAL_DATE" format="yyyy-MM-dd" disabled="true"></xforms:input></xui:view>
  <xforms:textarea ref="data('bizData2')/TREATMENT_VERIFICATION" id="textarea6" style="height:60px;"></xforms:textarea>
  ...
  <xforms:select1 ref="data('bizData2')/RELEASE" id="radio5" disabled="false">
  ...
  <xforms:textarea ref="data('bizData2')/MEMO" id="textarea3" style="height:60px;"></xforms:textarea></xui:view>
</xui:view>
    <resource id="rsMain" xui:update-mode="insert" xui:parent="" >
<xhtml:script xmlns:xhtml="http://www.w3.org/1999/xhtml" id="htmlScript1" src="businessActivity4.js" />
</resource>
