...
_xbl_JSClassDefine_splitter.prototype = justep.Object.extend(new justep.XBLObject(), eval({
			...
			onWindowResize: function(){
				...
				setTimeout(function(){
			   	...
			   	if(this.hasHandler && this.resizable && !this.mousedowned){	this.mousedowned = true;
	...
	var ids=[{id:'bf8382b811744177b0a577dca17bccf6', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'HSplitter1', name:'/UI/system/components/splitter.xbl.xml#splitter', children:[{id:'grid1', name:'xforms:grid'},{id:'grid2', name:'xforms:grid'}]}]}]; 
...
xf._b("instance('laboratoryData')/rOOMTYPE",xf._g(xf._f('instance',xf._i("laboratoryData")),xf._h(false, xf._k("child",xf._j('','rOOMTYPE')))));	
xf._b("instance('laboratoryData')/MANUFACTURE_ID",xf._g(xf._f('instance',xf._i("laboratoryData")),xf._h(false, xf._k("child",xf._j('','MANUFACTURE_ID')))));	
xf._b("instance('laboratoryData')/IS_DELEGATE",xf._g(xf._f('instance',xf._i("laboratoryData")),xf._h(false, xf._k("child",xf._j('','IS_DELEGATE')))));	
...
xf._c('xf-bind-1','model1',"instance('laboratoryData')/rOOMTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-2','model1',"instance('laboratoryData')/MANUFACTURE_ID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-3','model1',"instance('laboratoryData')/IS_DELEGATE","xsd:integer",null,null,null,null,null,null);	
...
xf._c('xf-bind-4','model1',"instance('proData')",null,"true()",null,null,null,null,null);	
xf._c('xf-bind-5','model1',"instance('proData')/TSTART","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-6','model1',"instance('proData')/TEND","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-7','model1',"instance('proData')/ROOMID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-8','model1',"instance('proData')/TOOLNO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-9','model1',"instance('proData')/LINEID","xsd:integer",null,null,null,null,null,null);	
