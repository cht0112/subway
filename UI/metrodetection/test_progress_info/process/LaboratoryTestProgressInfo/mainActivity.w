...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="width:162px;top:439px;height:auto;left:556px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="laboratoryData" concept="DETECTION_ROOM_INFO" confirm-refresh="false" limit="-1"><creator id="default1" action="/metrodetection/system_code/logic/action/createDETECTION_ROOM_INFOAction"></creator>
  <reader id="default2" action="/metrodetection/system_code/logic/action/queryDETECTION_ROOM_INFOAction"></reader>
  <writer id="default3" action="/metrodetection/system_code/logic/action/saveDETECTION_ROOM_INFOAction"></writer>
  <rule id="dataBizRule2" concept="DETECTION_ROOM_INFO" readonly="true()"></rule></data>
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="xml" auto-load="false" id="proData" concept="JINDU_VIEW" is-tree="true" store-type="grid" limit="-1" confirm-refresh="false"><creator id="default4" action="/metrodetection/system_code/logic/action/createJINDU_VIEWAction"></creator>
  ...
  <rule id="dataBizRule1" concept="JINDU_VIEW" readonly="true()"></rule></data></xforms:model>  
  ...
  <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column" smart-render="0" id="grid1" data="laboratoryData" onRowClick="mainActivity.grid1RowClick"><xui:column id="gridColumn1" ref="rOOMCNAME" label="房间名称" type="ed" width="175px"></xui:column></xhtml:div>
  <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column" smart-render="20" id="grid2" data="proData" delay="false"><xui:column id="gridColumn2" ref="TNAME" label="名称" type="tree" width="260px"></xui:column>
