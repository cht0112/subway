...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'80f23cb925ef4dfa921810c7a1849161', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTrigger', name:'xforms:trigger', children:[{id:'adef9e976f334ec9960c05c2a544a8d1', name:'xforms:label'}]},{id:'removeTrigger', name:'xforms:trigger', children:[{id:'80a2bc52277643e1bf107cefc9a7e9eb', name:'xforms:label'}]},{id:'72426ffe925f4bfdbacc87d0b7ba7d63', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'excelExport1', name:'/UI/system/components/excel.xbl.xml#export', children:[{id:'trigger-excelExport1', name:'xforms:trigger', children:[{id:'19413646c9094fb59edd499301d618ac', name:'xforms:label'}]}]},{id:'smartFilter1', name:'/UI/system/components/smartFilter.xbl.xml#smartFilter', children:[{id:'smartFilter1_input_263457197', name:'xforms:input'}]},{id:'trigger1', name:'xforms:trigger', children:[{id:'default11', name:'xforms:label'}]}]},{id:'grdMain', name:'xforms:grid'}]},{id:'borderLayout2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain2', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'iptVISITOR', name:'xforms:input'},{id:'iptVISIT_DATE', name:'xforms:input'},{id:'iptVISITOR_PERSON', name:'xforms:input'},{id:'iptRECEPT_UNIT', name:'xforms:input'},{id:'iptRECEPT_LEADER', name:'xforms:input'},{id:'textarea1', name:'xforms:textarea'},{id:'textarea2', name:'xforms:textarea'}]}]},{id:'filter-pattern-3a2260ce-e102-45b2-8883-bdab7b9ba898', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'6d150aaebad042ffbbd8edde95c99c9e', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_1140253069', name:'xforms:menu'}]},{id:'GLOBAL_ID_N828053717', name:'xforms:dialog'}]},{id:'filter-dialog-8becc5de-4765-43d7-92f7-92c36493fd75', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N1015691369', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'insertTrigger');xf._a('insertTrigger','adef9e976f334ec9960c05c2a544a8d1');xf._a(null,'removeTrigger');xf._a('removeTrigger','80a2bc52277643e1bf107cefc9a7e9eb');xf._a(null,'trigger-excelExport1');xf._a('trigger-excelExport1','19413646c9094fb59edd499301d618ac');xf._a(null,'smartFilter1_input_263457197');xf._a(null,'trigger1');xf._a('trigger1','default11');xf._a(null,'grdMain');xf._a(null,'iptVISITOR');xf._a(null,'iptVISIT_DATE');xf._a(null,'iptVISITOR_PERSON');xf._a(null,'iptRECEPT_UNIT');xf._a(null,'iptRECEPT_LEADER');xf._a(null,'textarea1');xf._a(null,'textarea2');function init() {	
var begin = new Date().getTime();	
xf._b("instance('dataMain')/VISITOR",xf._g(xf._f('instance',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISITOR')))));	
xf._b("true()",xf._f('true'));	
xf._b("'来访单位不能为空'",xf._i("来访单位不能为空"));	
xf._b("instance('dataMain')/VISIT_DATE",xf._g(xf._f('instance',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISIT_DATE')))));	
xf._b("'参观时间不能为空'",xf._i("参观时间不能为空"));	
xf._b("instance('dataMain')/VISITOR_PERSON",xf._g(xf._f('instance',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISITOR_PERSON')))));	
xf._b("instance('smartFilter1_data_263457197')/value",xf._g(xf._f('instance',xf._i("smartFilter1_data_263457197")),xf._h(false, xf._k("child",xf._j('','value')))));	
xf._b("recCB",xf._h(false, xf._k("child",xf._j('','recCB'))));	
xf._b("VISITOR",xf._h(false, xf._k("child",xf._j('','VISITOR'))));	
xf._b("VISITOR_PERSON",xf._h(false, xf._k("child",xf._j('','VISITOR_PERSON'))));	
xf._b("VISIT_DATE",xf._h(false, xf._k("child",xf._j('','VISIT_DATE'))));	
xf._b("RECEPT_UNIT",xf._h(false, xf._k("child",xf._j('','RECEPT_UNIT'))));	
xf._b("RECEPT_LEADER",xf._h(false, xf._k("child",xf._j('','RECEPT_LEADER'))));	
xf._b("CONTENT_DESC",xf._h(false, xf._k("child",xf._j('','CONTENT_DESC'))));	
xf._b("space-column",xf._h(false, xf._k("child",xf._j('','space-column'))));	
xf._b("data('dataMain')/VISITOR",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISITOR')))));	
xf._b("data('dataMain')/VISIT_DATE",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISIT_DATE')))));	
xf._b("data('dataMain')/VISITOR_PERSON",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','VISITOR_PERSON')))));	
xf._b("data('dataMain')/RECEPT_UNIT",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','RECEPT_UNIT')))));	
xf._b("data('dataMain')/RECEPT_LEADER",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','RECEPT_LEADER')))));	
xf._b("data('dataMain')/CONTENT_DESC",xf._g(xf._f('data',xf._i("dataMain")),xf._h(false, xf._k("child",xf._j('','CONTENT_DESC')))));	
...
xforms.Schema.registerPrefix('xsd', 'http://www.w3.org/2001/XMLSchema');xforms.Schema.registerPrefix('checkbox', 'null');xforms.Schema.registerPrefix('ro', 'null');xforms.Schema.registerPrefix('dateTime', 'null');var xf_model_mdDefault = new xforms.XFModel('mdDefault',null);	
new xforms.XFInstance2('dataMain','mdDefault',null,null,null,null,null,null,null,null,null,null,'whereAll');	
xf._c('xf-bind-0','mdDefault',"instance('dataMain')/VISITOR",null,null,"true()",null,null,null,"'来访单位不能为空'");	
xf._c('xf-bind-1','mdDefault',"instance('dataMain')/VISIT_DATE",null,null,"true()",null,null,null,"'参观时间不能为空'");	
xf._c('xf-bind-2','mdDefault',"instance('dataMain')/VISIT_DATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-3','mdDefault',"instance('dataMain')/VISITOR_PERSON","xsd:integer",null,null,null,null,null,null);	
xforms.load_parts('rootView');	
var xf_menu_GLOBAL_ID_1140253069 = new xforms.XFMenu('GLOBAL_ID_1140253069','context');xf_menu_GLOBAL_ID_1140253069.menu.addContextZone('6d150aaebad042ffbbd8edde95c99c9e');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_1140253069.hide()});xf_menu_GLOBAL_ID_1140253069.menu.setOpenMode('web');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N828053717");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_1140253069'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_1140253069', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N828053717',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1432598016');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N1432598016", "");}));xf._p(justep('GLOBAL_ID_N828053717'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N828053717', evt,false)});	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1432598016');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N828053717'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N828053717', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N1015691369',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1908019580');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1908019580", "");}));xf._p(justep('GLOBAL_ID_N1015691369'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_N1015691369', evt,false)});	
...
var xf_model_smartFilter1_model_263457197 = new xforms.XFModel('smartFilter1_model_263457197',null);	
new xforms.XFInstance2('smartFilter1_data_263457197','smartFilter1_model_263457197',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('smartFilter1_data_263457197','value');	
xf._d('smartFilter1_input_263457197','text',xf._q("instance('smartFilter1_data_263457197')/value"),null,null,null,null,false,false);	
...
new xforms.XFGrid({id:'grdMain',instance:'dataMain',systemColumnsPro:'MEMO',onInit:null,type:'grid',smartRender:null,delay:false,ids:'recCB,VISITOR,VISITOR_PERSON,VISIT_DATE,RECEPT_UNIT,RECEPT_LEADER,CONTENT_DESC,space-column',headNames:'#master_checkbox,来访单位名称,访客人数,参观时间,接待单位,接待单位负责人,行程描述,&nbsp;',widths:'30,144,52,118,143,88,172,*',types:'checkbox,ro,ro,dateTime,ro,ro,ro,ro',hiddenColumns:'',aligns:'center,,,,,,,',serverSort:true,sorts:'na,na,na,na,na,na,na,na',fixColumnSize:null,nodeImgCallback:'',multiSelection:'',checkedRef:'',filters:'\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0',sysColumns:'',treeColumnReadonly:true,showTreeIndex:null,editMode:null,filterColumn:true,drag:null,beforeDragCallback:null,afterDragCallback:null,afterFillRowCallback:null,beforeIndexChangedCallback:null,afterIndexChangedCallback:null,contextMenuId:null,rightClickSelected:'true',rightClickCallback:null,allowCheckCallback:null,rowHeight:null,hdrRowH:null,hdrFilterH:null,moveColumn:null,rowValueChangedCallback:null,groupColumn:true,adjustColumn:true,saveColumn:true,showHeaderMenu:'hide-column,save-layout,group-column,adjust-column',hintCallback:null,cascade:null,hasChildrenCallback1:null,onRowCheck:null,onRowChecked:null,onRowCheckedAll:null,onRowExpand:null,onRowClick:null,onRowDblClick:'mainActivity.grdMainRowDblClick',onLastEditorPressEnter:null,initFun:function(){}});	
xforms.load_parts('vDetail');	
}	
function load_rootView_xblinit(){if (justep("rootView").getAttribute('xblloaded') && justep("rootView").getAttribute('xblloaded') == 'true') return;justep("rootView").setAttribute('xblloaded', 'true');	
if(xforms.ready)justep('smartFilter1_model_263457197').xformsObject.construct_part();	
}	
...
xf._d('iptVISITOR','text',xf._q("data('dataMain')/VISITOR"),null,null,null,null,false,false);	
xf._d('iptVISIT_DATE','text',xf._q("data('dataMain')/VISIT_DATE"),null,null,null,null,false,false);	
xf._d('iptVISITOR_PERSON','text',xf._q("data('dataMain')/VISITOR_PERSON"),null,null,null,null,false,false);	
xf._d('iptRECEPT_UNIT','text',xf._q("data('dataMain')/RECEPT_UNIT"),null,null,null,null,false,false);	
xf._d('iptRECEPT_LEADER','text',xf._q("data('dataMain')/RECEPT_LEADER"),null,null,null,null,false,false);	
xf._d('textarea1','textarea',xf._q("data('dataMain')/CONTENT_DESC"),null,null,null,null,false,false);	
