...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/window.xbl.xml#window" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="width:143px;height:auto;top:38px;left:612px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="xml" auto-load="true" id="beipinbeijian" concept="DETECTION_TOOL_MOVING_RECORD" store-type="simple">
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="xml" auto-load="false" id="toolData" concept="DETECTION_TOOL_INFO" store-type="simple">
   <reader id="default4" action="/metrodetection/system_code/logic/action/queryDETECTION_TOOL_INFOAction"></reader></data>
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="false" id="bizData5" concept="USE_STATE_CODE">
   <reader id="default85" action="/metrodetection/system_code/logic/action/queryUSE_STATE_CODEAction"></reader></data>
  <xforms:action id="action1" ev:event="xbl-loaded"><xforms:script id="xformsScript1"><![CDATA[waiburukuNew.model1XBLLoaded(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view auto-load="true" id="rootView"> 
    <xhtml:div component="/UI/system/components/windowReceiver.xbl.xml#windowReceiver" id="windowReceiver" onReceive="waiburukuNew.windowReceiverReceive"/>  
    <xui:layout style="height:100%;width:100%"> 
      <xui:place control="windowReceiver" id="controlPlace1" style="top:230px;left:564px;"/>  
      <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout" id="borderLayout1" style="width:100%;height:100%;"> 
        <center id="borderLayout-center1"><xui:place control="view1" id="controlPlace2" style="width:685px;height:379px;"></xui:place></center>  
        <bottom id="borderLayout-bottom1" size="40px"> 
          ...
          <xhtml:input class="xui-button" id="input(button)1" onclick="waiburukuNew.inputbutton1Click(event)" style="width:75px;float:right" type="button" value="确定"/> 
        </bottom> 
      </xhtml:div> 
    </xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="oPERATEDATETIME" style="width: 153px;position:absolute;left:95px;top:18px;" id="controlPlace3"></xui:place>
  <xui:place control="tOOLID" style="width: 153px;position:absolute;left:95px;top:78px;" id="controlPlace9"></xui:place>
  <xui:place control="tOOLNUMBER" style="width: 153px;position:absolute;left:95px;top:108px;" id="controlPlace11"></xui:place><xhtml:label id="label1" class="xui-label" style="position:absolute;position:absolute;left:21px;top:23px;">操作日期时间</xhtml:label><xhtml:label id="label2" class="xui-label" style="position:absolute;position:absolute;left:57px;top:53px;">操作员</xhtml:label><xhtml:label id="label4" class="xui-label" style="position:absolute;position:absolute;left:56px;top:83px;">工具ID</xhtml:label><xhtml:label id="label5" class="xui-label" style="position:absolute;position:absolute;left:45px;top:113px;">工具数量</xhtml:label><xhtml:label id="label6" class="xui-label" style="position:absolute;left:67px;position:absolute;top:139px;">备注</xhtml:label><xhtml:label id="label7" class="xui-label" style="position:absolute;position:absolute;top:23px;left:306px;">操作类型</xhtml:label><xhtml:label id="label9" class="xui-label" style="position:absolute;position:absolute;top:54px;left:306px;">工具类型</xhtml:label><xhtml:label id="label10" class="xui-label" style="position:absolute;position:absolute;top:83px;left:307px;">工具状态</xhtml:label><xhtml:label id="label11" class="xui-label" style="position:absolute;position:absolute;top:116px;left:296px;">出入库原因</xhtml:label>
  <xui:place control="textarea1" id="controlPlace6" style="height:99px;left:95px;position:absolute;width:421px;top:139px;"></xui:place>
  <xui:place control="gridSelect1" id="controlPlace7" style="left:358px;position:absolute;top:18px;width:157px;"></xui:place>
  <xui:place control="gridSelect2" id="controlPlace4" style="width:157px;left:358px;position:absolute;top:48px;"></xui:place>
  <xui:place control="gridSelect3" id="controlPlace8" style="width:157px;left:358px;position:absolute;top:78px;"></xui:place>
  <xui:place control="gridSelect4" id="controlPlace10" style="width:157px;left:358px;position:absolute;top:108px;"></xui:place>
  <xui:place control="gridSelect5" id="controlPlace5" style="width:152px;position:absolute;left:95px;top:48px;"></xui:place></layout>
  ...
  <xui:resource id="resource1"><xhtml:script id="htmlScript1" src="waiburukuNew.js"></xhtml:script></xui:resource> 
</xui:window>
