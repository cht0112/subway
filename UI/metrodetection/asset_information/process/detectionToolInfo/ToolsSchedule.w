...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdMain" style="width:150px;top:239px;height:105px;left:132px;"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" auto-load="true" id="dSchedule" concept="TOOL_OCCUPY_INFO" store-type="simple">
      <creator id="default4" action="/metrodetection/system_code/logic/action/createTOOL_OCCUPY_INFOAction" />  
      <reader id="default5" action="/metrodetection/system_code/logic/action/myQueryTools" />  
      <writer id="default6" action="/metrodetection/system_code/logic/action/saveTOOL_OCCUPY_INFOAction" />
    </data><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" auto-load="true" id="hrBaseData" concept="DETECTION_TOOL_INFO" is-tree="false" store-type="simple">
      <creator id="default1" action="/metrodetection/system_code/logic/action/createDETECTION_TOOL_INFOAction" />  
      <reader id="default2" action="/metrodetection/system_code/logic/action/queryDETECTION_TOOL_INFOAction" />  
      <writer id="default3" action="/metrodetection/system_code/logic/action/saveDETECTION_TOOL_INFOAction" />
    </data></xforms:model>  
...
<!--        </xui:tab> -->
  ...
  <resource id="resource1">
    <xhtml:script id="htmlScript1" src="/UI/metrodetection/asset_information/process/detectionToolInfo/ToolsSchedule.js"/>  
