...
xf._b("data('hrData')/oPERATORNAME",xf._g(xf._f('data',xf._i("hrData")),xf._h(false, xf._k("child",xf._j('','oPERATORNAME')))));	
...
xf._c('xf-bind-1','model1',"instance('lvliData')/oPERATETYPE",null,null,"true()",null,null,null,"'操作类型不能为空!'");	
xf._c('xf-bind-2','model1',"instance('lvliData')/oPERATORID",null,null,"true()",null,null,null,"'操作员不能为空!'");	
xf._c('xf-bind-3','model1',"instance('lvliData')/dEVICEID",null,null,"true()",null,null,null,"'设备ID不能为空!'");	
xf._c('xf-bind-4','model1',"instance('lvliData')/oPERATERESULTSTATE",null,null,"true()",null,null,null,"'操作结果不能为空!'");	
xf._c('xf-bind-5','model1',"instance('lvliData')/oPERATEDATETIME","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-6','model1',"instance('lvliData')/oPERATETYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-7','model1',"instance('lvliData')/pROJECTID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-8','model1',"instance('lvliData')/oPERATERESULTSTATE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-9','model1',"instance('lvliData')/sAMPLEDEVICENO","xsd:integer",null,null,null,null,null,null);	
...
xf._c('xf-bind-13','model1',"instance('cData')/aPPLICATIONNO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-14','model1',"instance('cData')/aPPLICATIONTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-15','model1',"instance('cData')/cHECKRESULT","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-16','model1',"instance('cData')/cHECKTIME","xsd:date",null,null,null,null,null,null);	
new xforms.XFInstance2('hrData','model1',null,null,null,null,null,null,null,null,null,null,'whereAll');	
xf._c('xf-bind-17','model1',"instance('hrData')/oPERATORSEX","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-18','model1',"instance('hrData')/oPERATORBIRTHDAY","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-19','model1',"instance('hrData')/oFFICEID","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-20','model1',"instance('hrData')/pOSITIONID","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-21','model1',"instance('hrData')/dEGREEID","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-22','model1',"instance('hrData')/eDUCATIONID","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-23','model1',"instance('hrData')/pOLITICALID","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-24','model1',"instance('hrData')/pOSITIONALTITLE","xsd:float",null,null,null,null,null,null);	
xf._c('xf-bind-25','model1',"instance('hrData')/oPERATORSTATE","xsd:float",null,null,null,null,null,null);	
...
xf._c('xf-bind-26','model1',"instance('dataMaster')/dEVICETYPE",null,null,"true()",null,null,null,"'检测对象不能为空!'");	
xf._c('xf-bind-27','model1',"instance('dataMaster')/dECTIONTYPE",null,null,"true()",null,null,null,"'检测类型不能为空!'");	
xf._c('xf-bind-28','model1',"instance('dataMaster')/sOFTWAREVERSION",null,null,"true()",null,null,null,"'软件版本不能为空!'");	
xf._c('xf-bind-29','model1',"instance('dataMaster')/hARDWAREVERSION",null,null,"true()",null,null,null,"'硬件版本不能为空!'");	
xf._c('xf-bind-30','model1',"instance('dataMaster')/dEADLINERECEIVEDATE",null,null,"true()",null,null,null,"'最晚进场日期不能为空!'");	
xf._c('xf-bind-31','model1',"instance('dataMaster')/iNDEEDRECEIVEDATE",null,null,"true()",null,null,null,"'实际进场日期不能为空!'");	
xf._c('xf-bind-32','model1',"instance('dataMaster')/rETURNDATE",null,null,"true()",null,null,null,"'预计归还日期不能为空!'");	
xf._c('xf-bind-33','model1',"instance('dataMaster')/iNDEEDRETURNDATE",null,null,"true()",null,null,null,"'实际归还日期不能为空!'");	
xf._c('xf-bind-34','model1',"instance('dataMaster')/sHAREDFLAG",null,null,"true()",null,null,null,"'是否允许资源共用不能为空!'");	
xf._c('xf-bind-35','model1',"instance('dataMaster')/mANUFACTUREID",null,null,"true()",null,null,null,"'供应商名称不能为空!'");	
xf._c('xf-bind-36','model1',"instance('dataMaster')/dEVICEID",null,null,"true()",null,null,null,"'设备ID不能为空!'");	
xf._c('xf-bind-37','model1',"instance('dataMaster')/aPPLICATIONNO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-38','model1',"instance('dataMaster')/mANUFACTUREID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-39','model1',"instance('dataMaster')/dEVICETYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-40','model1',"instance('dataMaster')/dECTIONTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-41','model1',"instance('dataMaster')/sOFTWAREVERSION","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-42','model1',"instance('dataMaster')/hARDWAREVERSION","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-43','model1',"instance('dataMaster')/dEADLINERECEIVEDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-44','model1',"instance('dataMaster')/iNDEEDRECEIVEDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-45','model1',"instance('dataMaster')/rETURNDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-46','model1',"instance('dataMaster')/iNDEEDRETURNDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-47','model1',"instance('dataMaster')/sHAREDFLAG","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-48','model1',"instance('dataMaster')/sAMPLEDEVICENO1","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-49','model1',"instance('dataMaster')/oCCUPYSTARTDATETIME","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-50','model1',"instance('dataMaster')/oCCUPYENDDATETIME","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-51','model1',"instance('dataMaster')/pROJECTID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-52','model1',"instance('dataMaster')/TEST_CONTRACT_INFO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-53','model1',"instance('dataMaster')/TEST_PROJECT_INFO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-54','model1',"instance('dataMaster')/AFC_MANUFACTURER_INFO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-55','model1',"instance('dataMaster')/DETECTION_OBJECT_TYPE","xsd:integer",null,null,null,null,null,null);	
var xf_action_action1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){neibuguihuan.model1XBLLoaded(event)}));xf._p(justep('model1'),"xbl-loaded",null,function(evt) { xforms.run(xf_action_action1,'model1', evt,false)});	
new xforms.XFInstance2('bizData1','model1',null,null,null,null,null,null,null,null,null,null,'whereAll');	
xf._c('xf-bind-56','model1',"instance('bizData1')/aPPLICATIONNO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-57','model1',"instance('bizData1')/tESTSCHEMEID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-58','model1',"instance('bizData1')/pROJECTTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-59','model1',"instance('bizData1')/aSSIGNEDMANUFACTUREID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-60','model1',"instance('bizData1')/nOTIFYTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-61','model1',"instance('bizData1')/lINEID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-62','model1',"instance('bizData1')/bUSINESSID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-63','model1',"instance('bizData1')/mANUFACTUREID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-64','model1',"instance('bizData1')/pROJECTDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-65','model1',"instance('bizData1')/eNDINGDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-66','model1',"instance('bizData1')/mAKEDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-67','model1',"instance('bizData1')/eXECUTESTATE","xsd:integer",null,null,null,null,null,null);	
...
xf._c('xf-bind-68','model1',"instance('bizData2')/oPERATEDATETIME","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-69','model1',"instance('bizData2')/oPERATETYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-70','model1',"instance('bizData2')/pROJECTID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-71','model1',"instance('bizData2')/oPERATERESULTSTATE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-72','model1',"instance('bizData2')/sAMPLEDEVICENO","xsd:integer",null,null,null,null,null,null);	
new xforms.XFInstance2('bizData3','model1',null,null,null,null,null,null,null,null,null,null,'whereAll');new SimpleStore('bizData3',null);	
xf._c('xf-bind-73','model1',"instance('bizData3')/aPPLICATIONNO","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-74','model1',"instance('bizData3')/tESTSCHEMEID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-75','model1',"instance('bizData3')/pROJECTTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-76','model1',"instance('bizData3')/aSSIGNEDMANUFACTUREID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-77','model1',"instance('bizData3')/nOTIFYTYPE","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-78','model1',"instance('bizData3')/lINEID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-79','model1',"instance('bizData3')/bUSINESSID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-80','model1',"instance('bizData3')/mANUFACTUREID","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-81','model1',"instance('bizData3')/pROJECTDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-82','model1',"instance('bizData3')/eNDINGDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-83','model1',"instance('bizData3')/mAKEDATE","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-84','model1',"instance('bizData3')/eXECUTESTATE","xsd:integer",null,null,null,null,null,null);	
...
xf._c('xf-bind-10','model1',"instance('sysOperData')/sValidState","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-11','model1',"instance('sysOperData')/sLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-12','model1',"instance('sysOperData')/version","xsd:integer",null,null,null,null,null,null);	
