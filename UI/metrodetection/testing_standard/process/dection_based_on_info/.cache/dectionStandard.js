...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'259025496bed4ca1b1d58b63e6d62206', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabPanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'grid2', name:'xforms:grid'},{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTr', name:'xforms:trigger', children:[{id:'1c39ba75ad6d4e6cb82b2e7256fd6213', name:'xforms:label'}]},{id:'removeStandard', name:'xforms:trigger', children:[{id:'1886e303b0814820aa396cdb07bffa99', name:'xforms:label'}]},{id:'6ae80c4b0240469e89d07ad112a198dc', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'toolbars2', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'input2', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'default4', name:'xforms:label'},{id:'default5', name:'xforms:value'}]},{id:'input3', name:'xforms:input'},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'default7', name:'xforms:label'},{id:'default8', name:'xforms:value'}]},{id:'treeSelect1', name:'xforms:treeselect1', children:[{id:'default10', name:'xforms:label'},{id:'default11', name:'xforms:value'}]},{id:'input4', name:'xforms:input'},{id:'textarea1', name:'xforms:textarea'}]},{id:'filter-pattern-d1e97169-f769-4536-9dd4-40ff8997fa5e', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'d53f73da44f14318840394f0a644dc37', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_944950328', name:'xforms:menu'}]},{id:'GLOBAL_ID_N454470416', name:'xforms:dialog'}]},{id:'filter-dialog-3ef72b71-dbd8-4905-aefc-0b0510d49546', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N2128404119', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'grid2');xf._a(null,'insertTr');xf._a('insertTr','1c39ba75ad6d4e6cb82b2e7256fd6213');xf._a(null,'removeStandard');xf._a('removeStandard','1886e303b0814820aa396cdb07bffa99');xf._a(null,'input2');xf._a(null,'gridSelect1');xf._a('gridSelect1','default4');xf._a('gridSelect1','default6');xf._a(null,'input3');xf._a(null,'gridSelect2');xf._a('gridSelect2','default7');xf._a('gridSelect2','default9');xf._a(null,'treeSelect1');xf._a('treeSelect1','default10');xf._a('treeSelect1','default12');xf._a(null,'input4');xf._a(null,'textarea1');function init() {	
...
var xf_menu_GLOBAL_ID_944950328 = new xforms.XFMenu('GLOBAL_ID_944950328','context');xf_menu_GLOBAL_ID_944950328.menu.addContextZone('d53f73da44f14318840394f0a644dc37');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_944950328.hide()});xf_menu_GLOBAL_ID_944950328.menu.setOpenMode('web');	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N454470416");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {				var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_944950328'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'GLOBAL_ID_944950328', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N454470416',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1679919070');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N1679919070", "");}));xf._p(justep('GLOBAL_ID_N454470416'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_N454470416', evt,false)});	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1679919070');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N454470416'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N454470416', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N2128404119',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1939298048');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1939298048", "");}));xf._p(justep('GLOBAL_ID_N2128404119'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N2128404119', evt,false)});	
...
var xf_trigger_removeStandard=new xforms.XFTrigger('removeStandard',null,"/UI/system/images/standardToolbar/standard/remove.gif",null,false,false);	
