...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model1" style="height:auto;top:77px;left:257px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      ...
      store-type="simple" auto-new="false"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      ...
      onAfterRefresh="examineVerify.testCaseBaseInfoDAfterRefresh" limit="-1"> 
    ...
    <calculate-relation relation="calmark" id="calculate-relation3" type="xsd:string"></calculate-relation></data>  
  ...
  <xforms:action id="action1" ev:event="onload"><xforms:script id="xformsScript1"><![CDATA[examineVerify.model1Load(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view id="rootView"> 
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="absolute" style="position:relative;" id="layout1"> 
        ...
        <xui:place control="toolbars3" id="controlPlace8" style="position:absolute;left:5px;height:37px;top:210px;width:365px;"/>  
        <xui:place control="testCaseGrid" id="controlPlace12" style="position:absolute;left:5px;top:253px;width:905px;height:248px;"/>  
      ...
      <xui:place control="relationWD" id="controlPlace11" style="position:absolute;top:349px;left:838px;"></xui:place></layout>  
      ...
      <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars3"> 
        <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" mode="IMG_TXT_LR"
          ...
          <item id="barItem12"></item>  
          <item name="refresh-item" id="barItem14"/> 
        </xui:bar>  
        <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" mode="IMG_TXT_LR"
          id="navigatorBar3" data="testCaseBaseInfoD"> 
  ...
  <xui:column id="gridColumn2" ref="tESTCASEID" label="测试用例ID" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn3" ref="tESTCASENAME" label="测试用例名称" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn4" ref="dETECTIONOBJECTCNAME" label="对象类别" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn5" ref="dEVICETYPECNAME" label="检测对象" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn6" ref="dECTIONBASEDONNAME" label="检测依据文件名称" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn9" ref="calmark" label="用例指标" type="html" width="100px" onRender="examineVerify.testCaseGrid_calmarkRender"></xui:column></xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
    ...
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="子用例和指标映射信息" width="730px" height="400px" modal="true" id="relationWD" url="/UI/metrodetection/testing_standard/process/testscheme_baseinfo/relationIndex.w" left="238px"></xhtml:div></xui:view> 
  </xui:view>  
  <xui:resource id="resource1"> 
    <xhtml:script id="htmlScript1" src="compilation.js"/>  
    <xhtml:script id="htmlScript2" src="examineVerify.js"/> 
  </xui:resource> 
</xui:window>
