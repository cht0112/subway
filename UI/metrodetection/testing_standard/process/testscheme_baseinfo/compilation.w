...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model1" style="height:auto;top:32px;left:521px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      ...
      store-type="simple" auto-new="false" onAfterNew="compilation.testSchemeBaseInfoDAfterNew"
      onValueChanging="compilation.testSchemeBaseInfoDValueChanging"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      ...
      onAfterRefresh="compilation.testCaseBaseInfoDAfterRefresh" limit="-1"> 
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="indexAndRelationD" concept="RELATIONSHIP_INDEX_AND_CASE" store-type="simple"><reader id="default43" action="/metrodetection/system_code/logic/action/queryRELATIONSHIP_INDEX_AND_CASEAction"></reader></data>
  <xforms:action id="action3" ev:event="onload"><xforms:script id="xformsScript3"><![CDATA[compilation.model1Load(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view id="rootView"> 
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="absolute" style="position:relative;" id="layout1"> 
        ...
        <xui:place control="input1" id="controlPlace4" style="position:absolute;left:104px;top:79px;"/>  
        ...
        <xui:place control="testCaseGrid" id="controlPlace12" style="position:absolute;left:5px;top:253px;height:244px;width:843px;"/>  
      ...
      <xui:place control="relationWD" id="controlPlace14" style="position:absolute;top:318px;left:643px;"></xui:place></layout>  
      ...
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        ...
        label-ref="data('testSchemeBaseInfoD')/dECTIONBASEDONNAME" onCloseup="compilation.gridSelect1Closeup"> 
      ...
      <xforms:input id="input2" ref="data('testSchemeBaseInfoD')/mAKEDATETIME"/>  
          ...
          <item> 
            <xforms:trigger appearance="image-text" id="saveMore" image-text-mode="LR"
              ...
              <xforms:action id="action1" ev:event="DOMActivate"> 
                <xforms:script id="xformsScript1"><![CDATA[compilation.saveMoreClick(event)]]></xforms:script> 
              </xforms:action> 
            </xforms:trigger> 
          </item>  
          ...
          <item id="barItem12"> 
            <xforms:trigger appearance="image-text" id="saveMoreD" image-text-mode="LR"
              ...
              <xforms:action id="action2" ev:event="DOMActivate"> 
                <xforms:script id="xformsScript2"><![CDATA[compilation.saveMoreDClick(event)]]></xforms:script> 
              </xforms:action> 
            </xforms:trigger> 
          </item>  
      ...
      <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column"
        ...
        <xui:column id="gridColumn1" ref="tESTCASEVER" label="测试用例版本" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn2" ref="tESTCASEID" label="测试用例ID" type="ro" width="120px"></xui:column>
  <xui:column id="gridColumn3" ref="tESTCASENAME" label="测试用例名称" type="ro" width="100px"></xui:column>
  <xui:column id="gridColumn4" ref="dETECTIONOBJECTCNAME" label="检测对象类别" type="ro" width="117px"></xui:column>
  <xui:column id="gridColumn5" ref="dEVICETYPECNAME" label="检测对象" type="ro" width="132px"></xui:column>
  <xui:column id="gridColumn6" ref="dECTIONBASEDONNAME" label="检测依据文件名称" type="ro" width="109px"></xui:column>
  <xui:column id="gridColumn9" ref="calmark" label="用例指标" type="html" width="100px" onRender="compilation.testCaseGrid_calmarkRender"></xui:column></xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="gridSelect4" ref="data('businessCD')/businessStage"
        label-ref="data('businessCD')/businessStageName"> 
    ...
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="子用例和指标映射信息" width="730px" height="400px" modal="true" id="relationWD" url="/UI/metrodetection/testing_standard/process/testscheme_baseinfo/relationIndex.w" left="236px"></xhtml:div></xui:view> 
  </xui:view>  
