...
var __actions__ = {	
		...
		function load_view2_html(){var a = [];a.push('<div class="xui-container" id="view3" lazy="false" style="position:relative;;position:absolute;border-color:#FFFFFF #FFFFFF #FFFFFF #FFFFFF;left:1px;top:1px;height:100%;width:100%;" >');a.push('<div auto-load="false" class="xui-report component_2BF03861 report" column-width="1" component="/UI/system/components/report.xbl.xml#report" data-list="reportData" id="report1" report-name="流程记录" src="" style="position:absolute;height:170px;width:688px;left:1px;top:1px;" >');a.push('<span cacheFile="%2FUI%2Fmetrodetection%2Ftesting_standard%2Fprocess%2Ftestscheme_baseinfo%2F.cache%2FschemeProcessQueryDetail.report" dataList="reportData" marginBottom="2.4mm" marginFootter="" marginHeader="" marginLeft="3.7mm" marginRight="3.7mm" marginTop="2.4mm" orientation="" pageHeight="297mm" pageWidth="210mm" paperType="A4" style="display:none" xblid="attribute" >');a.push('</span>');a.push('<div id="report_report1_content" report-name="流程记录" style="width:100%;height:100%;" >');a.push('</div>');a.push('<iframe name="report_report1_frame" onReadyStateChange="var xbl=justep.xbl(\'report1\'); if (xbl != null) xbl._hideWaittingDialog()" style="position:absolute;top:-1000px;left:-1000px;width:1px;height:1px;" >');a.push('</iframe>');a.push('</div>');a.push('</div>');justep('view2').innerHTML = a.join('');}function load_vProcessChart_html(){var a = [];a.push('<div class="component_4D3D41 processChart" component="/UI/system/components/processChart.xbl.xml#processChart" id="processChart" style="height:100%;width:100%;" >');a.push('<div pertID="GLOBAL_ID_1983704505" style="display:none" trackID="GLOBAL_ID_N1456089715" xblid="interface" >');a.push('</div>');a.push('<div class="component_478DC2A1 tabs" component="/UI/system/components/tabs.xbl.xml#tabs" id="GLOBAL_ID_N1936516097" style="width:100%;height:100%;overflow:auto;" >');a.push('<div class="jstabbar" id="GLOBAL_ID_N1936516097_root" >');a.push('<ul class="tabItems" >');a.push('<li class="selected" id="GLOBAL_ID_1181199466_tab" >');a.push('<button class="selected" onclick="this.parentNode.parentNode.parentNode.parentNode.tabbar.setTabActive(\'GLOBAL_ID_1181199466\');this.blur();" type="button" >');a.push('轨迹图');a.push('</button>');a.push('</li>');a.push('<li id="GLOBAL_ID_813473271_tab" >');a.push('<button onclick="this.parentNode.parentNode.parentNode.parentNode.tabbar.setTabActive(\'GLOBAL_ID_813473271\');this.blur();" type="button" >');a.push('波特图');a.push('</button>');a.push('</li>');a.push('</ul>');a.push('<div class="contents" id="GLOBAL_ID_N1936516097_contents" >');a.push('<div class="content selected" id="GLOBAL_ID_1181199466" >');a.push('<div class="component_8CF08DD0 processTrackChart" component="/UI/system/components/processChart.xbl.xml#processTrackChart" id="GLOBAL_ID_N1456089715" style="height:100%;" >');a.push('<div style="display:none" >');a.push('<div chartControlID="track_GLOBAL_ID_N1445993370" xblid="interface" >');a.push('</div>');a.push('</div>');a.push('<div class="component_8F7B2FA1 borderLayout" component="/UI/system/components/borderLayout.xbl.xml#borderLayout" id="bl2" style="height:100%;" >');a.push('<div borderSize="0" class="xui-borderlayout-root" >');a.push('<div class="xui-borderlayout-area xui-borderlayout-top" size="40px" style="" >');a.push('<table>');a.push('<tr>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:green; width:100%;height:2px" >');a.push('</div>');a.push('</td>');a.push('<td align="" >');a.push('<span>');a.push('已经过');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:black; width:100%;height:2px" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('未经过');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:red; width:100%;height:2px" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('回退');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:#0080FF; border:1px #0080FF solid; width:100%;height:20px;border-style:solid;" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('当前环节');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:green; border:1px green solid; width:100%;height:20px; border-style:solid;" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('已处理');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:#ff6666; border:1px #ff6666 solid; width:100%;height:20px;border-style:solid;" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('已终止');a.push('</span>');a.push('</td>');a.push('<td width="20" >');a.push('</td>');a.push('<td width="30" >');a.push('<div style="overflow:hidden;display:block;background:yellow; border:1px yellow solid; width:100%;height:20px;border-style:solid;" >');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<span>');a.push('已暂停');a.push('</span>');a.push('</td>');a.push('</tr>');a.push('</table>');a.push('</div>');a.push('<div class="xui-borderlayout-border xui-borderlayout-border-top" style="height:0" >');a.push('</div>');a.push('<div class="xui-borderlayout-area xui-borderlayout-center" style="overflow:auto;" >');a.push('<div id="track_GLOBAL_ID_N1445993370" style="width:100%;height:100%;overflow:auto;" >');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('<div class="content" id="GLOBAL_ID_813473271" >');a.push('<div class="component_4502B30A processPertChart" component="/UI/system/components/processChart.xbl.xml#processPertChart" id="GLOBAL_ID_1983704505" style="height:100%;" >');a.push('<div style="display:none" >');a.push('<div chartControlID="bot_GLOBAL_ID_N248975070" xblid="interface" >');a.push('</div>');a.push('</div>');a.push('<div id="bot_GLOBAL_ID_N248975070" style="width:100%;height:100%;overflow:auto;" >');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');a.push('</div>');justep('vProcessChart').innerHTML = a.join('');}