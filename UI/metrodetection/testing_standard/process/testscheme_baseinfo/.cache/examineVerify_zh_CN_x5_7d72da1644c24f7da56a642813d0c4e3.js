				...
				for(var model in this.xformInfo){
					...
					for(var i in infos){
						...
						if (info.readonly){
							...
							var a = jQuery("#" + info.id);		if(0!=img.size()){
								if (!info.enImg){
...
_xbl_JSClassDefine_bizDataFilterDialog.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'aa4581834eb043af928438ce1160a161', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'testSchemeP', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'testSchemeP_processControlDialog', name:'xforms:dialog'},{id:'testSchemeP_processChartDialogID', name:'xforms:dialog'},{id:'testSchemeP_processConfirmDialog', name:'xforms:dialog', children:[{id:'7846aafb300f4843862567d720053bda', name:'xforms:trigger', children:[{id:'5dd3e912b9594e90aa2c735ca3b79e71', name:'xforms:label'}]},{id:'69bd2d5e7405435dbba6d4b8172e4663', name:'xforms:trigger', children:[{id:'80ec9e95241f4a7b94f961993863be96', name:'xforms:label'}]}]},{id:'testSchemeP_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'input1', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'default4', name:'xforms:label'},{id:'default5', name:'xforms:value'}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'default24', name:'xforms:label'},{id:'default25', name:'xforms:value'}]},{id:'gridSelect3', name:'xforms:gridselect1', children:[{id:'default27', name:'xforms:label'},{id:'default28', name:'xforms:value'}]},{id:'textarea2', name:'xforms:textarea'},{id:'input2', name:'xforms:input'},{id:'toolbars3', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'testCaseGrid', name:'xforms:grid'},{id:'gridSelect4', name:'xforms:gridselect1', children:[{id:'default40', name:'xforms:label'},{id:'default41', name:'xforms:value'}]},{id:'relationWD', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'filter-pattern-99a94c7d-4307-4090-a761-9d59113f2165', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'ebd8b9f126d64d3eadd3f0bb919dd85f', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_1465508325', name:'xforms:menu'}]},{id:'GLOBAL_ID_1177664524', name:'xforms:dialog'}]},{id:'filter-dialog-a3000f6c-d6e3-400f-ab45-bcd79cabe7f6', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_1462107401', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'7846aafb300f4843862567d720053bda');xf._a('7846aafb300f4843862567d720053bda','5dd3e912b9594e90aa2c735ca3b79e71');xf._a(null,'69bd2d5e7405435dbba6d4b8172e4663');xf._a('69bd2d5e7405435dbba6d4b8172e4663','80ec9e95241f4a7b94f961993863be96');xf._a(null,'input1');xf._a(null,'gridSelect1');xf._a('gridSelect1','default4');xf._a('gridSelect1','default6');xf._a(null,'gridSelect2');xf._a('gridSelect2','default24');xf._a('gridSelect2','default26');xf._a(null,'gridSelect3');xf._a('gridSelect3','default27');xf._a('gridSelect3','default29');xf._a(null,'textarea2');xf._a(null,'input2');xf._a(null,'testCaseGrid');xf._a(null,'gridSelect4');xf._a('gridSelect4','default40');xf._a('gridSelect4','default42');function init() {	
...
var xf_action_action1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){examineVerify.model1Load(event)}));xf._p(justep('model1'),"onload",null,function(evt) { xforms.run(xf_action_action1,'model1', evt,false)});	
xforms.load_parts('view1');	
var xf_menu_GLOBAL_ID_1465508325 = new xforms.XFMenu('GLOBAL_ID_1465508325','context');xf_menu_GLOBAL_ID_1465508325.menu.addContextZone('ebd8b9f126d64d3eadd3f0bb919dd85f');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_1465508325.hide()});xf_menu_GLOBAL_ID_1465508325.menu.setOpenMode('web');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_1177664524");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){			var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_1465508325'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_1465508325', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1177664524',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1572710471');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_1572710471", "");}));xf._p(justep('GLOBAL_ID_1177664524'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_1177664524', evt,false)});	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1572710471');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_1177664524'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_1177664524', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1462107401',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_N1227953798');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_N1227953798", "");}));xf._p(justep('GLOBAL_ID_1462107401'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_1462107401', evt,false)});	
...
var xf_trigger_7846aafb300f4843862567d720053bda=new xforms.XFTrigger('7846aafb300f4843862567d720053bda',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('testSchemeP_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('testSchemeP_processConfirmDialog').close();}));xf._p(justep('7846aafb300f4843862567d720053bda'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'7846aafb300f4843862567d720053bda', evt,false)});	
var xf_trigger_69bd2d5e7405435dbba6d4b8172e4663=new xforms.XFTrigger('69bd2d5e7405435dbba6d4b8172e4663',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('testSchemeP_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('testSchemeP_processConfirmDialog').close();}));xf._p(justep('69bd2d5e7405435dbba6d4b8172e4663'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'69bd2d5e7405435dbba6d4b8172e4663', evt,false)});	
