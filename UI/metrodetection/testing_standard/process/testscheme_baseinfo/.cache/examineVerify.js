...
_xbl_JSClassDefine_dialog.prototype = justep.Object.extend(new justep.XBLObject(), eval({"initXBL" : function() {
...
_xbl_JSClassDefine_bizDataFilterDialog.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'16d8dca608354462b5a3fb18037ba8f5', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'testSchemeP', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'testSchemeP_processControlDialog', name:'xforms:dialog'},{id:'testSchemeP_processChartDialogID', name:'xforms:dialog'},{id:'testSchemeP_processConfirmDialog', name:'xforms:dialog', children:[{id:'92550ca98a6b424d92b639353b2448f4', name:'xforms:trigger', children:[{id:'c6e0f578b3c744389efc0c97bc1a9799', name:'xforms:label'}]},{id:'edf7c8b8250f4bdaace12d96783af491', name:'xforms:trigger', children:[{id:'118083b479d545699dbbfa7aa506992e', name:'xforms:label'}]}]},{id:'testSchemeP_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'input1', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'default4', name:'xforms:label'},{id:'default5', name:'xforms:value'}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'default24', name:'xforms:label'},{id:'default25', name:'xforms:value'}]},{id:'gridSelect3', name:'xforms:gridselect1', children:[{id:'default27', name:'xforms:label'},{id:'default28', name:'xforms:value'}]},{id:'textarea2', name:'xforms:textarea'},{id:'input2', name:'xforms:input'},{id:'toolbars3', name:'/UI/system/components/toolbars.xbl.xml#toolbars'},{id:'testCaseGrid', name:'xforms:grid'},{id:'gridSelect4', name:'xforms:gridselect1', children:[{id:'default40', name:'xforms:label'},{id:'default41', name:'xforms:value'}]},{id:'relationWD', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'filter-pattern-19ab01f4-23d8-4f62-a206-34f76d314ead', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'82336d6aac2f4e2aa70657cc4ce994da', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N1841103574', name:'xforms:menu'}]},{id:'GLOBAL_ID_N1217244683', name:'xforms:dialog'}]},{id:'filter-dialog-43eeeeee-eef4-4c99-ad5c-5d015660262c', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_1572763435', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'92550ca98a6b424d92b639353b2448f4');xf._a('92550ca98a6b424d92b639353b2448f4','c6e0f578b3c744389efc0c97bc1a9799');xf._a(null,'edf7c8b8250f4bdaace12d96783af491');xf._a('edf7c8b8250f4bdaace12d96783af491','118083b479d545699dbbfa7aa506992e');xf._a(null,'input1');xf._a(null,'gridSelect1');xf._a('gridSelect1','default4');xf._a('gridSelect1','default6');xf._a(null,'gridSelect2');xf._a('gridSelect2','default24');xf._a('gridSelect2','default26');xf._a(null,'gridSelect3');xf._a('gridSelect3','default27');xf._a('gridSelect3','default29');xf._a(null,'textarea2');xf._a(null,'input2');xf._a(null,'testCaseGrid');xf._a(null,'gridSelect4');xf._a('gridSelect4','default40');xf._a('gridSelect4','default42');function init() {	
...
var xf_menu_GLOBAL_ID_N1841103574 = new xforms.XFMenu('GLOBAL_ID_N1841103574','context');xf_menu_GLOBAL_ID_N1841103574.menu.addContextZone('82336d6aac2f4e2aa70657cc4ce994da');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N1841103574.hide()});xf_menu_GLOBAL_ID_N1841103574.menu.setOpenMode('web');	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N1217244683");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N1841103574'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_N1841103574', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N1217244683',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_938466149');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_938466149", "");}));xf._p(justep('GLOBAL_ID_N1217244683'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N1217244683', evt,false)});	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_938466149');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N1217244683'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N1217244683', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1572763435',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1077159009');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1077159009", "");}));xf._p(justep('GLOBAL_ID_1572763435'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_1572763435', evt,false)});	
...
var xf_trigger_92550ca98a6b424d92b639353b2448f4=new xforms.XFTrigger('92550ca98a6b424d92b639353b2448f4',null,null,null,false,false);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('testSchemeP_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('testSchemeP_processConfirmDialog').close();}));xf._p(justep('92550ca98a6b424d92b639353b2448f4'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'92550ca98a6b424d92b639353b2448f4', evt,false)});	
var xf_trigger_edf7c8b8250f4bdaace12d96783af491=new xforms.XFTrigger('edf7c8b8250f4bdaace12d96783af491',null,null,null,false,false);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('testSchemeP_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('testSchemeP_processConfirmDialog').close();}));xf._p(justep('edf7c8b8250f4bdaace12d96783af491'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'edf7c8b8250f4bdaace12d96783af491', evt,false)});	
