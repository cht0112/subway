...
_xbl_JSClassDefine_menu.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				refreshMenuItemset: function(itemsetID){
					...
					var data = this._itemsets[itemsetID]["data"];var replace = this._itemsets[itemsetID]["replace"];
...
_xbl_JSClassDefine_dateFilter.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				initXBL : function() {
					...
					this.dropdownHeight = el.attr("dropdown-height") || "185";
			    	...
			    	this.combo.addOption([["0", "全部"], ["1", "今天"], ["2", "昨天"], ["3", "本周"], ["4", "上周"], ["5", "本月"], ["6", "上月"], ["7", "今年"], ["8", "去年"], ["9", "自定义..."]]);
...
_xbl_JSClassDefine_orgFilter.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				"setDefaultValue" : function(value,label){
					if(this.__result_instance_obj){
						if(value=='本人') {value = justep.Context.getCurrentPersonID();label = '本人';}
				...
				"__addCurrentPerson" : function(data, grid){
					...
					try{
						...
						data.setValue('sName','本人',currentPersonId);
				...
				"getSelecteds" : function(){
					...
					if(!this.getSelect().isLoadData){
						if(this.hasCurrentPerson && '本人'==this.domNode.getAttribute('default-value')){
							var o = {};
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'c81ff191c621421d82767ba404e8dafd', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'dlgChart', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'process', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'process_processControlDialog', name:'xforms:dialog'},{id:'process_processChartDialogID', name:'xforms:dialog'},{id:'process_processConfirmDialog', name:'xforms:dialog', children:[{id:'fb28265d23ae432886aff44cb8ae21c0', name:'xforms:trigger', children:[{id:'73f63c2e004b4cc78bbd1e82c17fe32c', name:'xforms:label'}]},{id:'de1f2b905c1d466889882a38c751bc5b', name:'xforms:trigger', children:[{id:'cdb2e01b88484d318a09d6dee700a58f', name:'xforms:label'}]}]},{id:'process_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'4e784c145d4d443f89fc99630e124bcb', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'dateFilter1', name:'/UI/system/components/dateFilter.xbl.xml#dateFilter', children:[{id:'dateFilter1_part', name:'xforms:group', children:[{id:'dateFilter1_dialog', name:'xforms:dialog', children:[{id:'ca1617eee153432d9806475bd3431c9e', name:'/UI/system/components/tableLayout.xbl.xml#tableLayout', children:[{id:'f947a48c4e3c45f6929f1bfc5c1cf5bb', name:'xforms:input'},{id:'8aa22e20f5ed4ce99df089751692a304', name:'xforms:input'}]}]}]}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'gridSelect1', name:'xforms:gridselect', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'smartFilter1', name:'/UI/system/components/smartFilter.xbl.xml#smartFilter', children:[{id:'smartFilter1_input_2066227094', name:'xforms:input'}]},{id:'trgSearch', name:'xforms:trigger', children:[{id:'xuiLabel10', name:'xforms:label'}]},{id:'grid', name:'xforms:grid'}]},{id:'filter-pattern-d8d04e8e-71c2-427a-879f-d9d70c18821c', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'3b55271491bb46c5868af098800f53c0', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_2094288445', name:'xforms:menu'}]},{id:'GLOBAL_ID_1276110461', name:'xforms:dialog'}]},{id:'filter-dialog-63d66863-ede5-414a-b376-a9c43c94f423', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_1079081436', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'fb28265d23ae432886aff44cb8ae21c0');xf._a('fb28265d23ae432886aff44cb8ae21c0','73f63c2e004b4cc78bbd1e82c17fe32c');xf._a(null,'de1f2b905c1d466889882a38c751bc5b');xf._a('de1f2b905c1d466889882a38c751bc5b','cdb2e01b88484d318a09d6dee700a58f');xf._a(null,'dateFilter1_part');xf._a('dateFilter1_part','f947a48c4e3c45f6929f1bfc5c1cf5bb');xf._a('dateFilter1_part','8aa22e20f5ed4ce99df089751692a304');xf._a(null,'gridSelect2');xf._a('gridSelect2','xuiLabel6');xf._a('gridSelect2','default3');xf._a(null,'gridSelect1');xf._a('gridSelect1','xf-label-3');xf._a('gridSelect1','xf-itemset-1');xf._a(null,'smartFilter1_input_2066227094');xf._a(null,'trgSearch');xf._a('trgSearch','xuiLabel10');xf._a(null,'grid');function init() {	
...
xf._b("instance('smartFilter1_data_2066227094')/value",xf._g(xf._f('instance',xf._i("smartFilter1_data_2066227094")),xf._h(false, xf._k("child",xf._j('','value')))),'','http://www.justep.com/xui');	
...
new xforms.XFDialog('process_processControlDialog',"流转信息",'modal',true,false,true,true,false,"",'700','445',null,null,null,null);	
...
var xf_trigger_fb28265d23ae432886aff44cb8ae21c0=new xforms.XFTrigger('fb28265d23ae432886aff44cb8ae21c0',null,null,null,false,false);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('process_processConfirmDialog').close();}));xf._p(justep('fb28265d23ae432886aff44cb8ae21c0'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'fb28265d23ae432886aff44cb8ae21c0', evt,false)});	
var xf_trigger_de1f2b905c1d466889882a38c751bc5b=new xforms.XFTrigger('de1f2b905c1d466889882a38c751bc5b',null,null,null,false,false);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('process_processConfirmDialog').close();}));xf._p(justep('de1f2b905c1d466889882a38c751bc5b'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'de1f2b905c1d466889882a38c751bc5b', evt,false)});	
...
new xforms.XFExtSelect({id:'gridSelect1',type:'gridselect',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('custom_filter')/status"),labelRef:xf._q("data('custom_filter')/statusLabel"),extRef:null,valueSeparator:',',labelSeparator:',',extSeparator:',',dataId:null,columns:'col_0,col_1',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'col_1',valueColumn:'col_0',labelColumn:'col_0',extColumn:null,labels:',',aligns:',',types:'checkbox,ro',widths:{widths:"*,*",total:0},height:'',dropdownWidth:'',appearance:null,delay:false,autoLoadData:false,independence:false,delayCreateGrid:false,cascade:false,dataXML:'<rows id="default9"><row id="default10"><cell id="default11">处理中</cell></row><row id="default12"><cell id="default13">编辑中</cell></row><row id="default14"><cell id="default15">已完成</cell></row><row id="default16"><cell id="default17">已终止</cell></row></rows>',inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:'mainActivity.gridSelect1Closeup'});	
var xf_model_smartFilter1_model_2066227094 = new xforms.XFModel('smartFilter1_model_2066227094',null);	
new xforms.XFInstance2('smartFilter1_data_2066227094','smartFilter1_model_2066227094',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('smartFilter1_data_2066227094','value');	
xf._d('smartFilter1_input_2066227094','text',xf._q("instance('smartFilter1_data_2066227094')/value"),null,null,null,null,false,false);	
var xf_trigger_trgSearch=new xforms.XFTrigger('trgSearch',null,"/UI/SA/task/taskCenter/images/search.png",null,false,false);	
...
new xforms.XFGroup('dateFilter1_part',null);var xf_model_dateFilter1_model = new xforms.XFModel('dateFilter1_model',null);	
xf._c('xf-bind-25','dateFilter1_model',"instance('dateFilter1_data')/beginDate","xsd:date",null,null,null,null,null,null);	
xf._c('xf-bind-26','dateFilter1_model',"instance('dateFilter1_data')/endDate","xsd:date",null,null,null,null,null,null);	
new xforms.XFInstance2('dateFilter1_data','dateFilter1_model',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('dateFilter1_data','value,label,beginDate,endDate');	
new xforms.XFDialog('dateFilter1_dialog',"自定义",'model',true,false,true,false,false,null,'242','135',null,null,null,null);	
xf._d('f947a48c4e3c45f6929f1bfc5c1cf5bb','text',xf._q("instance('dateFilter1_data')/beginDate"),null,null,null,null,false,false);	
xf._d('8aa22e20f5ed4ce99df089751692a304','text',xf._q("instance('dateFilter1_data')/endDate"),null,null,null,null,false,false);	
}	
...
if(xforms.ready)justep('dateFilter1_model').xformsObject.construct_part();	
xforms.refresh(justep("dateFilter1_part"));	
justep.XBLObject.loadXBL(justep("dateFilter1_part"));}	
var __actions__ = {	
};	
		function load_dateFilter1_part_html(){var a = [];a.push('<div class="xforms-group-content" style="" >');a.push('<div id="dateFilter1_dialog" style="display:none" >');a.push('</div>');a.push('<div style="width:238px;height:110px;position:absolute;left:-9000px;top:-9000px" >');a.push('<div class="xforms-dialog" height="135" id="dateFilter1_dialog-content" minmax="false" resizable="false" style="width:100%;height:100%" title="自定义" width="242" >');a.push('<table border="0" cellpadding="0" cellspacing="8" class="component_42908985 tableLayout" component="/UI/system/components/tableLayout.xbl.xml#tableLayout" id="ca1617eee153432d9806475bd3431c9e" style="width:100%;height:100%;tabel-layout:fixed" >');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('开始日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="f947a48c4e3c45f6929f1bfc5c1cf5bb" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('结束日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="8aa22e20f5ed4ce99df089751692a304" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr valign="middle" >');a.push('<td align="right" colspan="2" >');a.push('<button class="xui-button" onclick="xforms.blur(true); if (justep.xbl(\'dateFilter1\')._doDialogCheck())xforms(\'dateFilter1_dialog\').close();" style="width: 75px;margin-right:8px;" >');a.push('确定');a.push('</button>');a.push('<button class="xui-button" onclick="xforms(\'dateFilter1_dialog\').close();" style="width: 75px" >');a.push('取消');a.push('</button>');a.push('</td>');a.push('</tr>');a.push('</table>');a.push('</div>');a.push('</div>');a.push('</div>');justep('dateFilter1_part').innerHTML = a.join('');}