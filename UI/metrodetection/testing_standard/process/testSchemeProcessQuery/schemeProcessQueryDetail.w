...
<window xmlns="http://www.justep.com/xui" xmlns:ev="http://www.w3.org/2001/xml-events"
  ...
  <xforms:model id="model1" style="height:auto;top:47px;left:172px;"> 
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData"
      concept="SA_Task" id="dataMain" limit="20" offset="1" store-type="simple" confirm-delete="true" confirm-refresh="false"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      ...
      store-type="simple" auto-new="true" onAfterNew="compilation.testSchemeBaseInfoDAfterNew"
      onValueChanging="compilation.testSchemeBaseInfoDValueChanging" confirm-refresh="false"> 
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="flow" style="position:relative;" id="layout1"> 
        <xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout"
          ...
          <xui:place control="gridSelect4" id="controlPlace8"/>  
          <xui:place control="grid2" id="controlPlace9" style="width:200px;height:100px;"/>  
          <xui:place control="grid2" id="controlPlace2" style="width:200px;height:100px;"/>  
          <xui:place control="grid3" id="controlPlace6" style="width:200px;height:100px;"/> 
        </xhtml:div> 
      </layout>  
      <xui:view auto-load="false" id="view2" class="xui-container" style="border-color:#000000 #000000 #000000 #000000;border-style:double double double double;border-width:1px 1px 1px 1px;width:919px;height:207px;"> 
        ...
        <xui:view auto-load="true" id="view3" class="xui-container"> 
          <layout type="absolute" style="position:relative;" id="layout3"> 
            <xui:place control="report1" id="controlPlace5" style="position:absolute;top:5px;height:149px;left:-3px;width:684px;"/> 
          </layout>  
  ...
  <table cellspacing="0" cellpadding="0" rowHeight="19" columnWidth="1" style="font-size:11pt;border-collapse:collapse;table-layout:fixed;width:1px;">
     ...
     <tr><td  style="HEIGHT: 26px"></td><td  style="HEIGHT: 26px"></td><td  style="BORDER-BOTTOM: #000000 2px solid; TEXT-ALIGN: left; BORDER-LEFT: #000000 2px solid; FONT-FAMILY: 宋体; HEIGHT: 26px; FONT-SIZE: 12px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid; VERTIAL-ALIGN: middle">reportData.select(reportData.SACTIVITYNAME)</td><td  style="BORDER-BOTTOM: #000000 2px solid; TEXT-ALIGN: left; BORDER-LEFT: #000000 1px solid; FONT-FAMILY: 宋体; HEIGHT: 26px; FONT-SIZE: 12px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid; VERTIAL-ALIGN: middle">reportData.SCONTENT</td><td  style="BORDER-BOTTOM: #000000 2px solid; TEXT-ALIGN: left; BORDER-LEFT: #000000 1px solid; FONT-FAMILY: 宋体; HEIGHT: 26px; FONT-SIZE: 12px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid; VERTIAL-ALIGN: middle">reportData.SEXECUTORDEPTNAME</td><td  style="BORDER-BOTTOM: #000000 2px solid; TEXT-ALIGN: center; BORDER-LEFT: #000000 1px solid; FONT-FAMILY: 宋体; HEIGHT: 26px; FONT-SIZE: 12px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid; VERTIAL-ALIGN: middle">reportData.SEXECUTORPERSONNAME</td><td  style="BORDER-BOTTOM: #000000 2px solid; TEXT-ALIGN: center; BORDER-LEFT: #000000 1px solid; FONT-FAMILY: 宋体; HEIGHT: 26px; FONT-SIZE: 12px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 2px solid; VERTIAL-ALIGN: middle" format="yyyy/m/d h:mm;@">reportData.SACTUALFINISHTIME</td></tr>
      ...
      <xforms:trigger appearance="image" id="trigger1" image-text-mode="LR" style="width:31px;"
        src="/UI/metrodetection/testing_standard/process/testSchemeProcessQuery/images/move_down.gif"> 
        <xforms:action id="action49" ev:event="DOMActivate"> 
          <xforms:script id="xformsScript49"><![CDATA[schemeProcessQueryDetail.trigger1Click(event)]]></xforms:script> 
        </xforms:action> 
      </xforms:trigger>  
      <xforms:input id="input1" ref="data('testSchemeBaseInfoD')/tESTSCHEMENAME" readonly="true" style="width:174px;"/>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        ...
        label-ref="data('testSchemeBaseInfoD')/dECTIONBASEDONNAME" readonly="true" style="width:160px;"> 
      ...
      <xforms:input id="input2" ref="data('testSchemeBaseInfoD')/mAKEDATETIME" readonly="true" style="width:175px;"/>  
      ...
      <xhtml:div style="height:176px;width:689px;" component="/UI/system/components/grid.xbl.xml#grid"
        ...
        <xui:column id="gridColumn14" ref="tESTCASEVER" label="测试用例版本" type="ro" width="105px"></xui:column>
  <xui:column id="gridColumn15" ref="tESTCASEID" label="测试用例ID" type="ro" width="145px"></xui:column>
  <xui:column id="gridColumn17" ref="bUSINESSSTAGECNAME" label="业务阶段" type="ro" width="127px"></xui:column>
  <xui:column id="gridColumn18" ref="dETECTIONOBJECTCNAME" label="检测对象类型" type="ro" width="131px"></xui:column>
  <xui:column id="gridColumn19" ref="dEVICETYPECNAME" label="检测对象" type="ro" width="173px"></xui:column></xhtml:div>  
      <xui:view auto-load="true" id="view5" class="xui-container" style="width:610px;height:38px;"> 
        <layout type="absolute" style="position:relative;" id="layout5"> 
          <xui:place control="toolbars2" id="controlPlace12" style="position:absolute;width:400px;left:5px;top:1px;height:35px;"/> 
        </layout>  
        <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars2"> 
          <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" mode="IMG_TXT_LR"
            ...
            <item name="save-item" id="barItem8"/> 
          </xui:bar> 
        </xhtml:div> 
      </xui:view> 
  ...
  <xforms:action id="action2" ev:event="DOMActivate"><xforms:script id="xformsScript2"><![CDATA[schemeProcessQueryDetail.trigger1Click(event)]]></xforms:script></xforms:action></xforms:trigger>
