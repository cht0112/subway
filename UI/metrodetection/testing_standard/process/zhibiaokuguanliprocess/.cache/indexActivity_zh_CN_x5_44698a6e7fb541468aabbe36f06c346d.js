...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'0447ef1d116c4db2b08782207722454e', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTrigger', name:'xforms:trigger', children:[{id:'f8700bcb09024770925cb2ad6de78cc6', name:'xforms:label'}]},{id:'removeTrigger', name:'xforms:trigger', children:[{id:'0298ec634ecf4a06b77264b2f3a866b8', name:'xforms:label'}]},{id:'7065c01eb31447d389f314c3dd181708', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'grdMaster', name:'xforms:grid'}]},{id:'borderLayout2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster2', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertMore1', name:'xforms:trigger', children:[{id:'3c674cfcc618478aaae557274bb1088b', name:'xforms:label'}]},{id:'saveMore', name:'xforms:trigger', children:[{id:'8f55632cfa1d4a9ebf73be7cc789dfc2', name:'xforms:label'}]}]},{id:'iptINDEXIDCNAME', name:'xforms:input'},{id:'iptINDEXIDDEFINITION', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default34', name:'xforms:value'}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'xuiLabel4', name:'xforms:label'},{id:'default48', name:'xforms:value'}]},{id:'textarea1', name:'xforms:textarea'},{id:'tbsDetail', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertMore', name:'xforms:trigger', children:[{id:'d4e45e749c0242abb6ac965e08dbf423', name:'xforms:label'}]},{id:'saveMore1', name:'xforms:trigger', children:[{id:'41c63884f4184476bf43bdb81a8a9a7a', name:'xforms:label'}]},{id:'remove2', name:'xforms:trigger', children:[{id:'739f552507ee4f10840e5260ba808e4a', name:'xforms:label'}]}]},{id:'grdDetail', name:'xforms:grid'}]}]},{id:'filter-dialog-e70753f5-9b1b-4e94-9b09-a2735dbde6e5', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N1995479186', name:'xforms:dialog'}]},{id:'filter-pattern-c5fe43fa-5c54-4313-a3a4-78b8e2d71fa9', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'6ab7b7c142244efb99c2c37e482f2479', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N136286852', name:'xforms:menu'}]},{id:'GLOBAL_ID_N64691283', name:'xforms:dialog'}]},{id:'gridSelect3', name:'xforms:gridselect1', children:[{id:'xuiLabel5', name:'xforms:label'},{id:'default66', name:'xforms:value'}]},{id:'gridSelect4', name:'xforms:gridselect1', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default68', name:'xforms:value'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'insertTrigger');xf._a('insertTrigger','f8700bcb09024770925cb2ad6de78cc6');xf._a(null,'removeTrigger');xf._a('removeTrigger','0298ec634ecf4a06b77264b2f3a866b8');xf._a(null,'grdMaster');xf._a(null,'insertMore1');xf._a('insertMore1','3c674cfcc618478aaae557274bb1088b');xf._a(null,'saveMore');xf._a('saveMore','8f55632cfa1d4a9ebf73be7cc789dfc2');xf._a(null,'iptINDEXIDCNAME');xf._a(null,'iptINDEXIDDEFINITION');xf._a(null,'gridSelect1');xf._a('gridSelect1','xuiLabel3');xf._a('gridSelect1','default35');xf._a(null,'gridSelect2');xf._a('gridSelect2','xuiLabel4');xf._a('gridSelect2','default49');xf._a(null,'textarea1');xf._a(null,'insertMore');xf._a('insertMore','d4e45e749c0242abb6ac965e08dbf423');xf._a(null,'saveMore1');xf._a('saveMore1','41c63884f4184476bf43bdb81a8a9a7a');xf._a(null,'remove2');xf._a('remove2','739f552507ee4f10840e5260ba808e4a');xf._a(null,'grdDetail');xf._a(null,'gridSelect3');xf._a('gridSelect3','xuiLabel5');xf._a('gridSelect3','default67');xf._a(null,'gridSelect4');xf._a('gridSelect4','xuiLabel6');xf._a('gridSelect4','default69');function init() {	
...
var xf_trigger_insertMore=new xforms.XFTrigger('insertMore',null,"/UI/system/images/standardToolbar/standard/insert.gif","/UI/system/images/standardToolbar/standard/un_insert.gif",false,false,false,null,null,null);	
...
var xf_trigger_saveMore1=new xforms.XFTrigger('saveMore1',null,"/UI/system/images/standardToolbar/standard/save.gif","/UI/system/images/standardToolbar/standard/un_save.gif",false,false,false,null,null,null);	
