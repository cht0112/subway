...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'bbcd701817084a1b9d49b2ec368533de', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTrigger', name:'xforms:trigger', children:[{id:'2887ac5744694fc0924da3e21c58e5f5', name:'xforms:label'}]},{id:'removeTrigger', name:'xforms:trigger', children:[{id:'b0ddd6c37352476f9e3288580c91bfa2', name:'xforms:label'}]},{id:'bae0a39291ee4bd79fb197c6e107dfa9', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'grdMain', name:'xforms:grid'}]},{id:'borderLayout2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain2', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertId', name:'xforms:trigger', children:[{id:'fe1452abd5f24e23b2e1ca7dcaa2426e', name:'xforms:label'}]},{id:'saveTrigger', name:'xforms:trigger', children:[{id:'3d97d21da5c8481084531bf2623d3e9b', name:'xforms:label'}]}]},{id:'iptINDEXSYSTEMNAME', name:'xforms:input'},{id:'iptMAKEDATETIME', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default22', name:'xforms:value'}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'xuiLabel4', name:'xforms:label'},{id:'default50', name:'xforms:value'}]}]}]},{id:'filter-dialog-ffbf64b7-f5e1-4e98-a1e0-8584f1f496ed', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_1451562932', name:'xforms:dialog'}]},{id:'filter-pattern-bcb30034-3132-4f9e-8d0a-630edec43dad', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'5db79bf3345743f88b3ce5c1ed568674', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N1049810350', name:'xforms:menu'}]},{id:'GLOBAL_ID_N1526017881', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'insertTrigger');xf._a('insertTrigger','2887ac5744694fc0924da3e21c58e5f5');xf._a(null,'removeTrigger');xf._a('removeTrigger','b0ddd6c37352476f9e3288580c91bfa2');xf._a(null,'grdMain');xf._a(null,'insertId');xf._a('insertId','fe1452abd5f24e23b2e1ca7dcaa2426e');xf._a(null,'saveTrigger');xf._a('saveTrigger','3d97d21da5c8481084531bf2623d3e9b');xf._a(null,'iptINDEXSYSTEMNAME');xf._a(null,'iptMAKEDATETIME');xf._a(null,'gridSelect1');xf._a('gridSelect1','xuiLabel3');xf._a('gridSelect1','default23');xf._a(null,'gridSelect2');xf._a('gridSelect2','xuiLabel4');xf._a('gridSelect2','default51');function init() {	
...
new xforms.XFDialog('GLOBAL_ID_1451562932',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_N1500402434');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_N1500402434", "");}));xf._p(justep('GLOBAL_ID_1451562932'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_1451562932', evt,false)});	
var xf_menu_GLOBAL_ID_N1049810350 = new xforms.XFMenu('GLOBAL_ID_N1049810350','context');xf_menu_GLOBAL_ID_N1049810350.menu.addContextZone('5db79bf3345743f88b3ce5c1ed568674');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N1049810350.hide()});xf_menu_GLOBAL_ID_N1049810350.menu.setOpenMode('web');	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N1526017881");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N1049810350'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N1049810350', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N1526017881',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_6=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1959380668');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_1959380668", "");}));xf._p(justep('GLOBAL_ID_N1526017881'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_6,'GLOBAL_ID_N1526017881', evt,false)});	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1959380668');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N1526017881'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_N1526017881', evt,false)});	
...
var xf_trigger_saveTrigger=new xforms.XFTrigger('saveTrigger',null,"/UI/system/images/standardToolbar/standard/save.gif","/UI/system/images/standardToolbar/standard/un_save.gif",false,false);	
