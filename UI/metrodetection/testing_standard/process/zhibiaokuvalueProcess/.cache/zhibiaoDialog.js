...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
			...
			"mousedownAction" : function(event) {
				...
				group.style.top = posY - 0 + 4;group.style.left = posX - 0 + 4;
...
xf._a(null,'grid1');xf._a(null,'saveMas');xf._a('saveMas','1c58f7a5acb04cf2b2a224d3e2e61aef');xf._a(null,'gridSelect2');xf._a('gridSelect2','default17');xf._a('gridSelect2','default19');xf._a(null,'trigger-excelExport1');xf._a('trigger-excelExport1','6e8cc0a893704354b5fb3527993f4a11');xf._a(null,'trigger2');xf._a('trigger2','default4');function init() {	
...
new xforms.XFGrid({id:'grid1',instance:'indexData',systemColumnsPro:'INDEXSYSTEMNO,BUSINESSID,APPLYFOROBJECT,APPLYFORDEVICETYPE,DETECTIONRANGETYPE,DETECTIONRANGEID,INDEXSYSTEMNAME,recCB',onInit:null,type:'grid',smartRender:20,delay:false,ids:'calIndex,INDEXNO,INDEXID,INDEXIDCNAME,DETECTIONRANGECNAME,RANGEIDCNAME,DETECTIONOBJECTCNAME,DEVICETYPECNAME,BUSINESSIDCNAME,INDEXVALUE,INDEXVALUEDESC',headNames:'序号,指标序号,指标ID,指标名称,指标检测方面类别,检测方面,应用检测对象类型,应用检测对象,指标应用业务类型,指标值公式,指标值文字描述',widths:'30,56,48,108,119,100,114,100,120,116,184',types:'cntr,ro,ro,ro,ro,ro,ro,ro,ro,ed,ed',hiddenColumns:'',aligns:'center,center,center,,,,,,,,',serverSort:true,sorts:'na,na,na,na,na,na,na,na,na,na,na',fixColumnSize:null,nodeImgCallback:'',multiSelection:'',checkedRef:'',filters:'\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0,\u00A0',sysColumns:'',treeColumnReadonly:true,showTreeIndex:null,editMode:null,filterColumn:true,drag:null,beforeDragCallback:null,afterDragCallback:null,afterFillRowCallback:null,beforeIndexChangedCallback:null,afterIndexChangedCallback:null,contextMenuId:null,rightClickSelected:'true',rightClickCallback:null,allowCheckCallback:null,rowHeight:null,hdrRowH:null,hdrFilterH:null,moveColumn:null,rowValueChangedCallback:null,groupColumn:true,adjustColumn:true,saveColumn:true,showHeaderMenu:'hide-column,save-layout,group-column,adjust-column',hintCallback:null,cascade:null,hasChildrenCallback1:null,onRowCheck:null,onRowChecked:null,onRowCheckedAll:null,onRowExpand:null,onRowClick:null,onRowDblClick:null,onLastEditorPressEnter:null,initFun:function(){}});	
...
var xf_trigger_trigger2=new xforms.XFTrigger('trigger2',null,"/UI/system/components/excel/images/import.gif","/UI/system/components/excel/images/unimport.gif",false,false);	
