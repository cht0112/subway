...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdDefault" style="height:auto;top:94px;left:656px;"> 
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData"
      ...
      offset="0" update-mode="whereAll" onIndexChanged="reviewDefectBug.dataMainIndexChanged" onValueChanging="reviewDefectBug.dataMainValueChanging" filter-relations="FUNC_NAME,MODULE_NAME,PRODUCT_NAME,PROJECT_NAME,DEFECT_STATUS_CNAME"> 
    ...
    <tree-option id="default14" parent-relation="sParent"></tree-option></data>  
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
  ...
  <tree-option id="default13" parent-relation="sParent"></tree-option></data>
  ...
  <xforms:action id="action2" ev:event="xbl-loaded"><xforms:script id="xformsScript2"><![CDATA[reviewDefectBug.mdDefaultXBLLoaded(event)]]></xforms:script></xforms:action>
      ...
      <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dataMain"
        ...
        <item id="customBarItem5">
          <xforms:trigger id="trigger3"> 
            ...
            <xforms:action id="action3" ev:event="DOMActivate"><xforms:script id="xformsScript3"><![CDATA[reviewDefectBug.trigger3Click(event)]]></xforms:script></xforms:action></xforms:trigger>
        </item>
         
      </xui:bar> 
    </xhtml:div>  
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dataMain"
      id="grdMain" onRowDblClick="reviewDefectBug.grdMainRowDblClick" show-header-menu="hide-column,save-layout,group-column,adjust-column"> 
      ...
      <xui:column id="gridColumn6" ref="FUNC_NAME" label="功能名称" type="ro" width="185px"
        align="left"/>
      <xui:column id="gridColumn12" ref="myVersionId" type="ro" width="101px" label="缺陷版本号" align="left"/>
      <xui:column id="gridColumn3" ref="PRIORITY_NAME" type="ro" width="84px" label="缺陷类型"
        align="left"/>  
      <xui:column id="gridColumn4" ref="SEVERITY_NAME" type="ro" width="100px" label="缺陷等级"
        align="left"/>  
      <xui:column id="gridColumn5" ref="DEFECT_STATUS_CNAME" type="ro" width="82px"
        label="缺陷状态" align="left"/>  
      <xui:column id="gridColumn7" ref="ASSIGN_PERSON_NAME" label="分配给谁" type="ro"
        width="94px" align="left"/>  
      <xui:column id="gridColumn9" ref="CREATOR_NAME" label="缺陷提出人" type="ro" width="94px"
        align="left"/> 
    <xui:column id="gridColumn11" ref="REVIEWER_NAME" label="缺陷审核人" type="ed" width="100px"></xui:column></xhtml:div> 
...
<!--        <item id="barItem13" name="save-item"/>  -->
      <item> 
          <xforms:trigger appearance="image-text" id="saveMas" image-text-mode="LR"
            ...
            <xforms:action ev:event="DOMActivate"> 
              <xforms:script> <![CDATA[reviewDefectBug.newItemClick(event)]]> </xforms:script> 
            </xforms:action> 
          </xforms:trigger> 
        </item>  
    ...
    <xui:view auto-load="true" id="vDetail"> 
      <layout id="layout2" style="height:100%;;position:relative;" type="absolute"> 
        <place control-label="iptVERSION_ID" id="default23" style="font-size:10pt;position: absolute;height:14px;width:31px;top:47px;left:70px;"
          label="版本"/>  
        <place control-label="iptFUNC_ID" id="default25" style="font-size:10pt;position: absolute;top:78px;left:69px;"
          label="功能"/>  
        <place control-label="iptPLATFORM_INFO" id="default27" style="font-size:10pt;position: absolute;width:99px;left:6px;top:108px;"
          label="平台及操作系统"/>  
        <xhtml:span id="span1" style="font-size:10pt;position:absolute;color:#FF0000;width:9px;top:169px;left:345px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptPRIORITY" id="default30" style="font-size:10pt;position:absolute;color:#000000;width:57px;height:15px;top:171px;left:356px;"
          label="缺陷类型"/>  
        <xhtml:span id="span2" style="font-size:10pt;position:absolute;color:#FF0000;width:9px;top:165px;left:25px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptSEVERITY" id="default33" style="font-size:10pt;position:absolute;color:#000000;width:54px;height:14px;top:167px;left:41px;"
          label="缺陷等级"/>  
        <xhtml:span id="span3" style="font-size:10pt;position:absolute;color:#FF0000;top:198px;left:36px;"> <![CDATA[*]]> </xhtml:span>  
        <place id="default36" style="font-size:10pt;position:absolute;color:#000000;top:200px;left:45px;"
        ...
        <place control-label="iptCC_PERSON" id="default38" style="font-size:10pt;position: absolute;top:199px;left:361px;"
          label="抄送给谁"/>  
        <xhtml:span id="span4" style="font-size:10pt;position:absolute;color:#FF0000;top:240px;left:36px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptDEFECT_DESC" id="default41" style="font-size:10pt;position:absolute;color:#000000;top:240px;left:49px;"
          label="缺陷描述"/>  
        <place control-label="iptDEFECT_DETAIL" id="default43" style="font-size:10pt;position: absolute;top:330px;left:45px;"
          label="缺陷详细"/>  
        <place control-label="iptDEFECT_REASON" id="default45" style="font-size:10pt;position: absolute;top:434px;left:43px;"
          label="缺陷原因"/>  
        <xhtml:span id="span5" style="font-size:10pt;position:absolute;color:#FF0000;top:77px;left:345px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptDEFECT_STATUS" id="default50" style="font-size:10pt;position:absolute;color:#000000;top:79px;left:356px;"
          label="缺陷状态"/>  
        <xhtml:span id="span6" style="font-size:10pt;position:absolute;color:#FF0000;top:867px;left:14px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptCREATOR" id="default53" style="font-size:10pt;position:absolute;color:#000000;top:870px;left:29px;"
          label="缺陷提出人"/>  
        <place control="iptCREATOR" id="default54" style="font-size:10pt;position: absolute;width:165px;left:110px;top:862px;"/>  
        <xhtml:span id="span7" style="font-size:10pt;position:absolute;color:#FF0000;left:321px;top:868px;"> <![CDATA[*]]> </xhtml:span>  
        <place control-label="iptCREATE_DATE" id="default56" style="font-size:10pt;position:absolute;color:#000000;left:332px;top:871px;"
          label="缺陷提出日期"/>  
        <place control="iptCREATE_DATE" id="default57" style="font-size:10pt;position: absolute;width:165px;left:426px;top:862px;"/>  
        <place control-label="iptMEMO" id="default64" style="font-size:10pt;position: absolute;top:744px;left:71px;"
          label="备注"/>  
        <xui:place control="iptVERSION_ID" id="controlPlace3" style="position:absolute;width:165px;top:43px;left:112px;"/>  
        <xui:place control="iptPRIORITY" id="controlPlace6" style="position:absolute;width:164px;top:165px;left:427px;"/>  
        <xui:place control="iptSEVERITY" id="controlPlace7" style="position:absolute;width:165px;top:165px;left:111px;"/>  
        <xui:place control="iptCC_PERSON" id="controlPlace8" style="position:absolute;width:165px;top:196px;left:426px;"/>  
        <xui:place control="projectSelect" id="controlPlace9" style="position:absolute;width:165px;left:112px;top:13px;"/>  
        <xhtml:label id="label1" style="position:absolute;width:20px;top:18px;left:73px;"
          class="xui-label"><![CDATA[项目]]></xhtml:label>  
        <xui:place control="gridSelect2" id="controlPlace10" style="position:absolute;width:165px;top:13px;left:425px;"/>  
        <xhtml:label id="label2" class="xui-label" style="position:absolute;position:absolute;top:19px;left:385px;"><![CDATA[产品]]></xhtml:label>  
        <xui:place control="iptMEMO" id="controlPlace11" style="position:absolute;width:482px;height:87px;top:734px;left:111px;"/>  
        <xui:place control="iptDEFECT_REASON" id="controlPlace14" style="position:absolute;height:92px;top:419px;left:111px;"/>  
        <xui:place control="iptDEFECT_DETAIL" id="controlPlace15" style="position:absolute;height:89px;top:319px;left:111px;"/>  
        <xui:place control="iptDEFECT_DESC" id="controlPlace16" style="position:absolute;height:82px;left:112px;top:226px;"/>  
        <xui:place control="gridSelect3" id="controlPlace17" style="position:absolute;width:165px;top:43px;left:425px;"/>  
        <xhtml:label id="label3" class="xui-label" style="position:absolute;position:absolute;position:absolute;top:49px;left:384px;"><![CDATA[模块]]></xhtml:label>  
        <xui:place control="iptPLATFORM_INFO" id="controlPlace18" style="position:absolute;width:479px;top:103px;left:111px;"/>  
        <xui:place control="iptFUNC_ID" id="controlPlace19" style="position:absolute;width:164px;top:73px;left:112px;"/>  
        <xui:place control="iptDEFECT_STATUS" id="controlPlace20" style="position:absolute;width:164px;top:73px;left:426px;"/>  
        <xui:place control="iptASSIGN_PERSON" id="controlPlace21" style="position:absolute;width:165px;top:196px;left:112px;"/> 
      <xui:place control="textarea1" id="controlPlace12" style="position:absolute;height:95px;left:112px;top:522px;"></xui:place>
  <xhtml:label id="label4" style="position:absolute;top:533px;left:25px;" class="xui-label"><![CDATA[缺陷解决过程]]></xhtml:label>
  <xui:place control="textarea2" id="controlPlace13" style="position:absolute;height:96px;left:112px;top:628px;"></xui:place>
  <xhtml:label id="label5" style="position:absolute;top:641px;left:24px;" class="xui-label"><![CDATA[缺陷评审意见]]></xhtml:label>
  <xhtml:label id="label6" style="position:absolute;top:135px;left:38px;" class="xui-label"><![CDATA[缺陷评审人]]></xhtml:label>
  <xhtml:label id="label7" style="position:absolute;top:141px;left:343px;" class="xui-label"><![CDATA[缺陷评审日期]]></xhtml:label>
  <xui:place control="input1" id="controlPlace22" style="position:absolute;width:165px;top:134px;left:112px;"></xui:place>
  <xui:place control="input2" id="controlPlace23" style="position:absolute;width:164px;top:135px;left:427px;"></xui:place>
  </layout>  
      <xforms:input id="iptCREATOR" ref="data('dataMain')/CREATOR_NAME" disabled="true" tabindex="20"/>  
      <xforms:input id="iptCREATE_DATE" ref="data('dataMain')/CREATE_DATE" disabled="true" tabindex="21"/>  
      ...
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="iptPRIORITY" ref="data('dataMain')/PRIORITY" disabled="true" tabindex="11"> 
        ...
        <itemset-data xmlns="" id="default103">
   <rows xmlns="" id="default104">
    <row id="default105">
     <cell id="default115">1</cell>
     <cell id="default116">功能错误</cell></row> 
    <row id="default117">
     <cell id="default118">2</cell>
     <cell id="default123">功能缺失</cell></row> 
    <row id="default124">
     <cell id="default129">3</cell>
     <cell id="default130">界面缺陷</cell></row> 
    <row id="default131">
     <cell id="default132">4</cell>
     <cell id="default136">其他</cell></row> </rows> </itemset-data></xforms:itemset> 
      </xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="iptSEVERITY" ref="data('dataMain')/SEVERITY" disabled="true" tabindex="10"> 
        ...
        <itemset-data xmlns="" id="default61">
   <rows xmlns="" id="default62">
    <row id="default63">
     <cell id="default89">1</cell>
     <cell id="default90">致命缺陷</cell></row> 
    <row id="default91">
     <cell id="default92">2</cell>
     <cell id="default93">严重缺陷</cell></row> 
    <row id="default94">
     <cell id="default95">3</cell>
     <cell id="default96">一般性缺陷</cell></row> 
    <row id="default97">
     <cell id="default98">4</cell>
     <cell id="default99">建议性缺陷</cell></row> 
    <row id="default100">
     <cell id="default101">5</cell>
     <cell id="default102">其它缺陷</cell></row> </rows> </itemset-data></xforms:itemset> 
      </xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="iptCC_PERSON" ref="data('dataMain')/CC_PERSON"
        label-ref="data('dataMain')/CC_PERSON_NAME" disabled="true" tabindex="13"> 
        ...
        <xforms:column ref="personLoginName" visible="false" id="default15"></xforms:column>
  <xforms:column ref="sName" id="default16"></xforms:column></xforms:itemset> 
      </xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
      ...
      <xforms:textarea ref="data('dataMain')/MEMO" id="iptMEMO" disabled="true" tabindex="19"/>  
      <xforms:textarea ref="data('dataMain')/DEFECT_REASON" id="iptDEFECT_REASON" disabled="true" tabindex="16"/>  
      <xforms:textarea ref="data('dataMain')/DEFECT_DETAIL" id="iptDEFECT_DETAIL" disabled="true" tabindex="15"/>  
      <xforms:textarea ref="data('dataMain')/DEFECT_DESC" id="iptDEFECT_DESC" disabled="true" tabindex="14"/>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
  ...
  <xforms:column ref="col_1" id="default51"></xforms:column></xforms:itemset> 
      ...
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="iptDEFECT_STATUS" ref="data('dataMain')/DEFECT_STATUS" onDropdown="reviewDefectBug.iptDEFECT_STATUSDropdown" onCloseup="reviewDefectBug.iptDEFECT_STATUSCloseup" tabindex="6"> 
        ...
        <itemset-data xmlns="" id="default2">
   <rows xmlns="" id="default7"></rows></itemset-data>
  <xforms:column ref="DEFECT_STATUS_CODE" visible="false" id="default8"></xforms:column>
  <xforms:column ref="DEFECT_STATUS_CNAME" id="default9"></xforms:column></xforms:itemset> 
      </xhtml:div>  
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="iptASSIGN_PERSON" ref="data('dataMain')/ASSIGN_PERSON"
        label-ref="data('dataMain')/ASSIGN_PERSON_NAME" disabled="true" tabindex="12"> 
  ...
  <xforms:column ref="sName" id="default12"></xforms:column></xforms:itemset> 
    ...
    <xforms:textarea ref="data('dataMain')/DEFECT_SOLUTION" id="textarea1" disabled="true" tabindex="17"></xforms:textarea>
  <xforms:textarea ref="data('dataMain')/REVIEW_COMMENT" id="textarea2" tabindex="18"></xforms:textarea>
  <xforms:input id="input1" ref="data('dataMain')/REVIEWER_NAME" disabled="true" tabindex="8"></xforms:input>
  <xforms:input id="input2" ref="data('dataMain')/REVIEW_DATE" format="yyyy-MM-dd" disabled="true" tabindex="9"></xforms:input>
  </xui:view>  
    <xui:layout id="rootLayout" style="height:100%;width:100%"> 
      <xhtml:div component="/UI/system/components/tabs.xbl.xml#tabs" id="tabpanel1"
        ...
        <xui:tab id="tabList" xforms-select="reviewDefectBug.tabListSelect"> 
        ...
        <xui:tab id="tabDetail" xforms-select="reviewDefectBug.tabDetailSelect"> 
          <xui:label id="xuiLabel2">详细</xui:label>  
          <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout"
            id="borderLayout2" style="width:100%;height:184%;"> 
  ...
  <xui:resource id="rsMain"> 
    <xhtml:script id="htmlScript1" src="reviewDefectBug.js"/> 
  </xui:resource> 
</xui:window>
