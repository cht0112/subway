...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdDefault" style="height:auto;top:455px;left:361px;"> 
      
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      data-type="json" auto-load="true" id="bizData1" concept="QA_SUPERVISION_PLAN" confirm-refresh="false">
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      data-type="json" auto-load="true" id="cData" concept="CHECK_RECORD" store-type="simple" confirm-refresh="false">
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereVersion"
      data-type="json" auto-load="false" id="sysOperData" concept="SA_OPOrg" store-type="simple" confirm-refresh="false">
      <reader id="default25" action="/system/logic/action/queryOrgAction"/>
    </data>  
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      data-type="json" auto-load="true" id="hrPerData" concept="HR_BASE_INFO" store-type="simple" confirm-refresh="false">
  ...
  <xforms:action id="action2" ev:event="xbl-loaded"><xforms:script id="xformsScript2"><![CDATA[mainActivity.mdDefaultXBLLoaded(event)]]></xforms:script></xforms:action><data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData" concept="DAILY_SUPERVISION_RECORD" direct-delete="true" id="dataMain" limit="20" offset="0" update-mode="whereAll" confirm-refresh="false" filter-relations="RECORD_CODE,RECORD_NO,RECORD_DATE,SUPERVISION_PERSON"> 
    ...
    <rule id="dataBizRule1" relation="SUPERVISION_PLAN_IDID" required="true()" alert="'质量监督计划ID不能为空!'"></rule></data></xforms:model>  
  <xui:view auto-load="true" id="rootView"> 
    <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="tbsMain1"> 
      <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dataMain"
        id="ngtbMain1" mode="IMG_TXT_LR" style="height:27px;"> 
        <item> 
        ...
        <xui:tab id="tabList" xforms-select="mainActivity.tabListSelect"> 
          ...
          <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout"
            ...
            <top id="borderLayout-top1" size="40px"> 
              <place control="tbsMain1" id="controlPlace1" style="height:73px;"/> 
            </top>  
    ...
    <xui:view auto-load="true" id="view2" class="xui-container"> 
      ...
      <xforms:input ref="data('dataMain')/RECORD_CODE" id="RECORD_CODE1" tabindex="1"/>  
      <xforms:input ref="data('dataMain')/RECORD_NO" id="RECORD_NO1" tabindex="2"/>  
      <xforms:input ref="data('dataMain')/RECORD_DATE" id="RECORD_DATE1" tabindex="3" readonly="true"/>  
      ...
      <xforms:input ref="data('dataMain')/SIGNING_DATE" id="SIGNING_DATE1" format="yyyy-MM-dd"
        disabled="true"/>  
      <xforms:input ref="data('dataMain')/RESPONSOR_PERSON" id="RESPONSOR_PERSON1"/>  
      <xforms:textarea ref="data('dataMain')/CONFIRMATION_OPINIONS" id="textarea1" style="height:79px;"/>  
      <xforms:textarea ref="data('dataMain')/SUPPLEMENTARY_DESC" id="textarea2" style="height:93px;" tabindex="8"/>  
      <xforms:textarea ref="data('dataMain')/FACTUAL_RECORD" id="textarea3" style="height:99px;" tabindex="7"/>  
      ...
      <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator=","
        value-separator="," ext-separator="," id="gridSelect1" ref="data('dataMain')/SUPERVISION_PLAN_IDID" tabindex="5"> 
  ...
  <xforms:select id="checkbox2" ref="data('dataMain')/RECORD_CONTENT" tabindex="6">
