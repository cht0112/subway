...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.justep.com/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/window.xbl.xml#window">  
  ...
  <xui:view auto-load="true" id="rootView"> 
   ...
   <xui:tab id="tabDetail">
    ...
    <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout" id="borderLayout2" style="width:100%;height:74%;">
  ...
  <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dataMain" id="grdMain" onRowDblClick="mainActivity.grdMainRowDblClick" show-header-menu="hide-column,save-layout,group-column,adjust-column">
   ...
   <column id="default8" label="项目开始日期" ref="PROJECT_DATE" type="dateTime" width="100px" format="yyyy-MM-dd"></column>
   <column id="default9" label="项目结束日期" ref="ENDING_DATE" type="dateTime" width="100px" format="yyyy-MM-dd"></column>
   <column id="default18" label="计划制定日期" ref="PLAN_DATE" type="dateTime" width="100px" format="yyyy-MM-dd"></column></xhtml:div>
  <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="tbsMain2">
   <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dataMain" id="ngtbMain2" mode="IMG_TXT_LR">
    <item id="barItem13" name="save-item"></item>
  ...
  <xui:view auto-load="true" id="vDetail" class="xui-container">
   ...
   <xforms:input id="iptSUPERVISION_PLAN_CODEPLANCODE" ref="data('dataMain')/SUPERVISION_PLAN_CODEPLANCODE" style="width:156px;text-align:left;" disabled="true" tabindex="1"></xforms:input>
   <xforms:input id="iptSUPERVISION_NO" ref="data('dataMain')/SUPERVISION_NO" disabled="true" tabindex="2"></xforms:input>
   ...
   <xforms:input id="iptPROJECT_DATE" ref="data('dataMain')/PROJECT_DATE" format="yyyy-MM-dd" disabled="true" tabindex="4"></xforms:input>
   <xforms:input id="iptENDING_DATE" ref="data('dataMain')/ENDING_DATE" format="yyyy-MM-dd" disabled="true" tabindex="5"></xforms:input>
   <xforms:input id="iptEMPLOYEE_NUMBER" ref="data('dataMain')/EMPLOYEE_NUMBER" input-regex="^[0-9]*[1-9][0-9]*$" disabled="true" tabindex="6"><xforms:action id="action3" ev:event="xforms-value-changed"><xforms:script id="xformsScript3"><![CDATA[mainActivity.iptEMPLOYEE_NUMBERChange(event)]]></xforms:script></xforms:action></xforms:input>
   <xforms:input id="iptPROBATION_NUMBER" ref="data('dataMain')/PROBATION_NUMBER" input-regex="^[0-9]*[1-9][0-9]*$" disabled="true" tabindex="7"><xforms:action id="action4" ev:event="xforms-value-changed"><xforms:script id="xformsScript4"><![CDATA[mainActivity.iptPROBATION_NUMBERChange(event)]]></xforms:script></xforms:action></xforms:input>
   <xforms:input id="iptSTUDENT_NUMBER" ref="data('dataMain')/STUDENT_NUMBER" input-regex="^[0-9]*[1-9][0-9]*$" disabled="true" tabindex="8"><xforms:action id="action5" ev:event="xforms-value-changed"><xforms:script id="xformsScript5"><![CDATA[mainActivity.iptSTUDENT_NUMBERChange(event)]]></xforms:script></xforms:action></xforms:input>
   <xforms:input id="iptOTHER_NUMBER" ref="data('dataMain')/OTHER_NUMBER" input-regex="^[0-9]*[1-9][0-9]*$" disabled="true" tabindex="9"><xforms:action id="action7" ev:event="xforms-value-changed"><xforms:script id="xformsScript7"><![CDATA[mainActivity.iptOTHER_NUMBERChange(event)]]></xforms:script></xforms:action></xforms:input>
   ...
   <xforms:input id="iptPLAN_DATE" ref="data('dataMain')/PLAN_DATE" format="yyyy-MM-dd" disabled="true" tabindex="11"></xforms:input>
   ...
   <xforms:select1 ref="data('dataMain')/PROJECT_PRIOR" id="radio1" disabled="true" tabindex="12">
   ...
   <xforms:textarea ref="data('dataMain')/RESPONSOR_VIEW" id="textarea2" style="height:34px;" tabindex="14"></xforms:textarea>
   ...
   <xforms:textarea ref="data('dataMain')/MEMO" id="textarea4" style="height:45px;" disabled="true" tabindex="15"></xforms:textarea>
   <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect2" ref="data('dataMain')/PROJECT_ID" label-ref="data('dataMain')/PROJECT_NAME" onCloseup="mainActivity.gridSelect2Closeup" disabled="true" tabindex="3">
   ...
   <xforms:textarea ref="data('dataMain')/SUPPLEMENT" id="textarea5" style="height:100%;" disabled="true" tabindex="13"></xforms:textarea>
  ...
  <xui:view auto-load="true" id="view3" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout4"><xui:place control="grid5" style="left:5px;top:5px;width:99%;height:114%;" id="controlPlace14"></xui:place>
  </layout>
  <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" id="grid5" data="qa_supervision_plan_round">
   <xui:column id="gridColumn1" ref="ROUND_NO" label="轮次" type="ed" width="100px" readonly="true"></xui:column>
  <xui:column id="gridColumn2" ref="SUPERVISION_DATE" label="监督时间" type="ed" width="100px" format="yyyy-MM-dd" readonly="true"></xui:column>
  <xui:column id="gridColumn3" ref="SUPERVISION_PERSON" label="监督员" type="select" width="100px" editor="gridSelect3" readonly="true"><xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect3" ref="data('qa_supervision_plan_round')/SUPERVISION_PERSON" label-ref="data('hrPerData')/oPERATORNAME" disabled="true">
  ...
  <xforms:column ref="HR_BASE_INFO" visible="false" id="default49"></xforms:column>
  <xforms:column ref="oPERATORNAME" id="default50"></xforms:column></xforms:itemset></xhtml:div></xui:column>
