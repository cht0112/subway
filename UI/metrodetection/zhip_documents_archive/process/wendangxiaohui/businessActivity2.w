...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="height:auto;top:90px;left:534px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="dataMain" concept="DOCUMENTS_DESTROY_RECORD" store-type="simple"><creator id="default1" action="/metrodetection/system_code/logic/action/createDOCUMENTS_DESTROY_RECORDAction"></creator>
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="bizData1" concept="P_DOCUMENTS_ARCHIVE">
   <creator id="default14"></creator>
   <reader id="default14" action="/metrodetection/system_code/logic/action/queryP_DOCUMENTS_ARCHIVEAction"></reader>
  ...
  <xforms:action id="action2" ev:event="onload"><xforms:script id="xformsScript2"><![CDATA[businessActivity2.model1Load(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view id="rootView"> 
    <xui:layout style="height:100%;width:100%" id="rootLayout"><xui:place control="view1" id="controlPlace1" style="width:755px;height:619px;"></xui:place></xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="toolbars1" id="controlPlace2" style="position:absolute;width:79px;height:25px;left:2px;top:5px;"></xui:place>
  <xui:place control="toolbars2" id="controlPlace3" style="position:absolute;width:400px;height:25px;top:5px;left:76px;"></xui:place>
  <xui:place control="view2" id="controlPlace4" style="left:7px;top:45px;width:757px;height:579px;position:relative;"></xui:place></layout>
  ...
  <xui:view auto-load="true" id="view2" class="xui-container">
   <layout type="flow" style="position:relative;" id="layout2"><xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout" style="width:100%; height: 100%;" id="excelLayout1" src="excelLayout3.xls"></xhtml:div>
  <xui:place control="process1" id="controlPlace5" style="position:absolute;top:348px;left:102px;"></xui:place></layout>
  <xforms:input ref="data('dataMain')/aPPLICATIONTIME" id="aPPLICATIONTIME8"></xforms:input>
  <xforms:input ref="data('dataMain')/dESTROYTYPE" id="dESTROYTYPE8"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEID" id="fILEID8"></xforms:input>
  <xforms:input ref="data('dataMain')/fILENAME" id="fILENAME8"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEVER" id="fILEVER8"></xforms:input>
  <xforms:input ref="data('dataMain')/sECRETLEVEL" id="sECRETLEVEL8"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEDESC" id="fILEDESC8"></xforms:input>
  <xforms:input ref="data('dataMain')/mEMO" id="mEMO8"></xforms:input>
  ...
  <xforms:input id="input3" ref="data('dataMain')/dESTROYTYPE"></xforms:input>
  <xforms:input id="input4" ref="data('dataMain')/aPPLICATIONTIME" format="yyyy-MM-dd" disabled="true"></xforms:input>
  ...
  <xforms:textarea ref="data('dataMain')/fILEDESC" id="textarea1" style="height:80px;" disabled="true"></xforms:textarea>
  <xforms:textarea ref="data('dataMain')/mEMO" id="textarea2" style="height:65px;" disabled="true"></xforms:textarea>
  ...
  <xforms:textarea ref="data('cData')/cHECKDESC" id="textarea3" style="height:70px;"></xforms:textarea>
  <xforms:textarea ref="data('cData')/mEMO" id="textarea4" style="height:67px;"></xforms:textarea>
  ...
  <itemset-data xmlns="" id="default43">
   <rows xmlns="" id="default44">
    <row id="default45">
     ...
     <cell id="default47">普通</cell></row> 
    <row id="default48">
     <cell id="default49">2</cell>
     <cell id="default50">秘密</cell></row> 
    <row id="default51">
     <cell id="default52">3</cell>
     <cell id="default53">机密</cell></row> 
    <row id="default54">
     <cell id="default55">4</cell>
     <cell id="default56">绝密</cell></row> </rows> </itemset-data></xforms:itemset></xhtml:div>
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect3" ref="data('dataMain')/fILEID" label-ref="data('dataMain')/fILENAME" disabled="true">
   <xforms:label ref="pFILENAME" id="default15"></xforms:label>
   <xforms:value ref="P_DOCUMENTS_ARCHIVE" id="default16"></xforms:value>
   <xforms:itemset id="default17" data="bizData1" auto-load-data="true">
  <xforms:column ref="P_DOCUMENTS_ARCHIVE" visible="false" id="default20"></xforms:column>
  <xforms:column ref="pFILENAME" id="default21"></xforms:column></xforms:itemset></xhtml:div>
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect4" ref="data('bizData1')/dOCUMENTCATEGORY" disabled="true">
   <xforms:label ref="dOCUMENTCATEGORYCNAME" id="default18"></xforms:label>
   <xforms:value ref="DOCUMENT_CATEGORY_CODE" id="default19"></xforms:value>
   <xforms:itemset id="default22" data="kemu" auto-load-data="true">
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect5" ref="data('bizData1')/dOCUMENTTYPE" disabled="true">
   <xforms:label ref="dOCUMENTTYPECNAME" id="default23"></xforms:label>
   <xforms:value ref="DOCUMENT_TYPE_CODE" id="default24"></xforms:value>
   <xforms:itemset id="default41" data="leixing" auto-load-data="true">
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#treeSelect" label-separator="," value-separator="," ext-separator="," id="treeSelect1" ref="data('dataMain')/sParentID" label-ref="data('dataMain')/sDocName1" disabled="true">
   <xforms:label id="default42" ref="sDocName"></xforms:label>
