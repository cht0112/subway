...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="height:auto;top:106px;left:298px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="dataMain" concept="DOCUMENTS_DESTROY_RECORD" store-type="simple"><creator id="default1" action="/metrodetection/system_code/logic/action/createDOCUMENTS_DESTROY_RECORDAction"></creator>
  ...
  <xforms:action id="action2" ev:event="onload"><xforms:script id="xformsScript2"><![CDATA[businessActivity3.model1Load(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view id="rootView"> 
    <xui:layout style="height:100%;width:100%" id="rootLayout"><xui:place control="view1" id="controlPlace1" style="width:868px;height:616px;"></xui:place></xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="toolbars1" id="controlPlace2" style="position:absolute;width:76px;height:34px;top:5px;left:4px;"></xui:place>
  <xui:place control="toolbars2" id="controlPlace3" style="position:absolute;width:400px;height:25px;top:5px;left:78px;"></xui:place>
  <xui:place control="view2" id="controlPlace4" style="top:48px;left:10px;width:861px;height:577px;position:relative;"></xui:place></layout>
  ...
  <xui:place control="process1" id="controlPlace5" style="position:absolute;top:322px;left:52px;"></xui:place></layout>
  <xforms:input ref="data('dataMain')/aPPLICATIONTIME" id="aPPLICATIONTIME9"></xforms:input>
  <xforms:input ref="data('dataMain')/dESTROYTYPE" id="dESTROYTYPE9"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEID" id="fILEID9"></xforms:input>
  <xforms:input ref="data('dataMain')/fILENAME" id="fILENAME9"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEVER" id="fILEVER9"></xforms:input>
  <xforms:input ref="data('dataMain')/sECRETLEVEL" id="sECRETLEVEL9"></xforms:input>
  <xforms:input ref="data('dataMain')/fILEDESC" id="fILEDESC9"></xforms:input>
  <xforms:input ref="data('dataMain')/mEMO" id="mEMO9"></xforms:input>
  ...
  <xforms:textarea ref="data('dataMain')/fILEDESC" id="textarea1" style="height:104px;" disabled="true"></xforms:textarea>
  <xforms:textarea ref="data('dataMain')/mEMO" id="textarea2" style="height:80px;" disabled="true"></xforms:textarea>
  ...
  <xforms:textarea ref="data('cData')/mEMO" id="textarea4" style="height:78px;"></xforms:textarea>
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect4" ref="data('bizData1')/dOCUMENTCATEGORY" disabled="true">
   ...
   <xforms:itemset id="default52" data="kemu">
