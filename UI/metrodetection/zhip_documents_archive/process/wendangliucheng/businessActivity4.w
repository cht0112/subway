...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="top:163px;height:auto;left:264px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="dataMain" concept="P_DOCUMENTS_BORROW_RECORD" store-type="simple"><creator id="default1" action="/metrodetection/system_code/logic/action/createP_DOCUMENTS_BORROW_RECORDAction"></creator>
  ...
  <writer id="default13" action="/metrodetection/system_code/logic/action/saveDOCUMENT_CATEGORY_CODEAction"></writer></data><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="leixing" concept="DOCUMENT_TYPE_CODE"><creator id="default14" action="/metrodetection/system_code/logic/action/createDOCUMENT_TYPE_CODEAction"></creator>
  ...
  <xui:view id="rootView"> 
    <xui:layout style="height:100%;width:100%" id="rootLayout"><xui:place control="view1" id="controlPlace1" style="width:868px;height:627px;"></xui:place></xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="toolbars1" id="controlPlace2" style="position:absolute;height:39px;width:79px;top:3px;left:2px;"></xui:place>
  <xui:place control="toolbars2" id="controlPlace3" style="position:absolute;width:400px;height:25px;top:3px;left:77px;"></xui:place>
  <xui:place control="view2" id="controlPlace4" style="top:44px;left:7px;width:863px;height:579px;position:relative;"></xui:place></layout>
  ...
  <xui:view auto-load="true" id="view2" class="xui-container">
   <layout type="flow" style="position:relative;" id="layout2"><xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout" style="width:100%; height: 100%;" id="excelLayout1" src="excelLayout5.xls"></xhtml:div>
  <xui:place control="process1" id="controlPlace5" style="position:absolute;top:473px;left:80px;"></xui:place></layout>
  ...
  <xforms:input id="input5" ref="data('dataMain')/pFILENAME" disabled="true"></xforms:input>
  <xforms:input id="input6" ref="data('dataMain')/rETURNDATE" format="yyyy-MM-dd" disabled="true"></xforms:input>
  <xforms:input id="input7" ref="data('dataMain')/aPPLICATIONTIME" format="yyyy-MM-dd" disabled="true"></xforms:input>
  <xforms:textarea ref="data('cData')/cHECKDESC" id="textarea1" style="height:89px;"></xforms:textarea>
  <xforms:textarea ref="data('cData')/mEMO" id="textarea2" style="height:91px;"></xforms:textarea>
  ...
  <xhtml:div component="/UI/system/components/process.xbl.xml#process" use-simple-dialog="true" data-type="json" dialog-window="/UI/system/service/process/dialogs/processDialog.w" dialog-height="480" dialog-width="600" id="process1" data="dataMain" auto-filter="false" onAdvanceCommit="businessActivity4.process1AdvanceCommit"></xhtml:div>
  <xforms:textarea ref="data('dataMain')/mEMO" id="textarea3" disabled="true"></xforms:textarea>
