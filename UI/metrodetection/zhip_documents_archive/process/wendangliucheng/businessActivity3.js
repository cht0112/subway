...
businessActivity3.model1XBLLoaded = function(event){
	...
	checkRecordData.setFilter("filter0", "CHECK_RECORD.cHECKNAME = '复审' and CHECK_RECORD.aPPLICATIONNO ="+justep.Context.getProcessData1());
...
*/
businessActivity3.process1AdvanceCommit = function(event){
