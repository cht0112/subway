...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui" xmlns:xforms="http://www.justep.com/xforms" component="/UI/system/components/window.xbl.xml#window" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events">  
  <xforms:model id="model1" style="height:auto;top:109px;left:370px;"><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="dataMain" concept="P_DOCUMENTS_BORROW_RECORD" store-type="simple"><creator id="default1" action="/metrodetection/system_code/logic/action/createP_DOCUMENTS_BORROW_RECORDAction"></creator>
  <reader id="default2" action="/metrodetection/system_code/logic/action/queryP_DOCUMENTS_BORROW_RECORDAction"></reader>
  <writer id="default3" action="/metrodetection/system_code/logic/action/saveP_DOCUMENTS_BORROW_RECORDAction"></writer></data>
  ...
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="kemu" concept="DOCUMENT_CATEGORY_CODE"><creator id="default17" action="/metrodetection/system_code/logic/action/createDOCUMENT_CATEGORY_CODEAction"></creator>
  <reader id="default18" action="/metrodetection/system_code/logic/action/queryDOCUMENT_CATEGORY_CODEAction"></reader>
  <writer id="default19" action="/metrodetection/system_code/logic/action/saveDOCUMENT_CATEGORY_CODEAction"></writer></data>
  <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="leixing" concept="DOCUMENT_TYPE_CODE"><creator id="default20" action="/metrodetection/system_code/logic/action/createDOCUMENT_TYPE_CODEAction"></creator>
  <reader id="default21" action="/metrodetection/system_code/logic/action/queryDOCUMENT_TYPE_CODEAction"></reader>
  <writer id="default22" action="/metrodetection/system_code/logic/action/saveDOCUMENT_TYPE_CODEAction"></writer></data><data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll" data-type="json" auto-load="true" id="hrData" concept="HR_BASE_INFO"><creator id="default23" action="/metrodetection/system_code/logic/action/createHR_BASE_INFOAction"></creator>
  ...
  <xforms:action id="action1" ev:event="xbl-loaded"><xforms:script id="xformsScript1"><![CDATA[businessActivity3.model1XBLLoaded(event)]]></xforms:script></xforms:action>
  ...
  <xui:view id="rootView"> 
    <xui:layout style="height:100%;width:100%" id="rootLayout"><xui:place control="view1" id="controlPlace1" style="width:752px;height:625px;"></xui:place></xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="toolbars1" id="controlPlace2" style="position:absolute;top:5px;left:0px;height:37px;width:79px;"></xui:place>
  <xui:place control="toolbars2" id="controlPlace3" style="position:absolute;width:400px;height:25px;top:5px;left:75px;"></xui:place>
  <xui:place control="view2" id="controlPlace4" style="top:45px;left:5px;width:752px;height:576px;position:relative;"></xui:place></layout>
  ...
  <xui:view auto-load="true" id="view2" class="xui-container">
   <layout type="flow" style="position:relative;" id="layout2"><xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout" style="width:100%; height: 100%;" id="excelLayout1" src="excelLayout4.xls"></xhtml:div>
  <xui:place control="process1" id="controlPlace5" style="position:absolute;top:340px;left:316px;"></xui:place></layout>
  <xforms:input ref="data('dataMain')/aPPLICATIONTIME" id="aPPLICATIONTIME2"></xforms:input>
  <xforms:input ref="data('dataMain')/pFILEID" id="pFILEID2"></xforms:input>
  <xforms:input ref="data('dataMain')/dOCUMENTCATEGORY" id="dOCUMENTCATEGORY2"></xforms:input>
  <xforms:input ref="data('dataMain')/dOCUMENTTYPE" id="dOCUMENTTYPE2"></xforms:input>
  <xforms:input ref="data('dataMain')/pFILENAME" id="pFILENAME2"></xforms:input>
  <xforms:input ref="data('dataMain')/bORROWER" id="bORROWER2"></xforms:input>
  <xforms:input ref="data('dataMain')/rETURNDATE" id="rETURNDATE2"></xforms:input>
  <xforms:input ref="data('dataMain')/iNDEEDRETURNDATE" id="iNDEEDRETURNDATE2"></xforms:input>
  <xforms:input ref="data('dataMain')/mEMO" id="mEMO2"></xforms:input>
  ...
  <xforms:textarea ref="data('dataMain')/mEMO" id="textarea1" style="height:103px;" disabled="true"></xforms:textarea>
  <xforms:textarea ref="data('cData')/cHECKDESC" id="textarea2" style="height:95px;"></xforms:textarea>
  <xforms:textarea ref="data('cData')/mEMO" id="textarea3" style="height:102px;"></xforms:textarea>
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect1" ref="data('dataMain')/dOCUMENTCATEGORY" disabled="true">
   <xforms:label ref="dOCUMENTCATEGORYCNAME" id="default11"></xforms:label>
   <xforms:value ref="DOCUMENT_CATEGORY_CODE" id="default12"></xforms:value>
   <xforms:itemset id="default13" data="kemu" auto-load-data="true">
  ...
  <xhtml:div component="/UI/system/components/select.xbl.xml#gridSelect" label-separator="," value-separator="," ext-separator="," id="gridSelect2" ref="data('dataMain')/dOCUMENTTYPE" disabled="true">
   <xforms:label ref="dOCUMENTTYPECNAME" id="default14"></xforms:label>
   <xforms:value ref="DOCUMENT_TYPE_CODE" id="default15"></xforms:value>
   <xforms:itemset id="default16" data="leixing" auto-load-data="true">
  ...
  <xforms:column ref="pFILENAME" id="default44"></xforms:column></xforms:itemset></xhtml:div></xui:view></xui:view></xui:view>  
  <xui:resource id="resource1"><xhtml:script id="htmlScript1" src="businessActivity3.js"></xhtml:script></xui:resource> 
</xui:window>
