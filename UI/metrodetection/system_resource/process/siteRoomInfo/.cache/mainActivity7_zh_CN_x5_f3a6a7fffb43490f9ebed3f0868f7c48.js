...
*/				
	...
	var ids=[{id:'6d811d3e38f9472183e50501f15a21b0', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'windowReceiver', name:'/UI/system/components/windowReceiver.xbl.xml#windowReceiver'},{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'blobImage1', name:'/UI/system/components/blob.xbl.xml#image', children:[{id:'blob-blobImage1', name:'/UI/system/components/blob.xbl.xml#blob', children:[{id:'dlg-blob-blobImage1', name:'/UI/system/components/dialog.xbl.xml#dialog', children:[{id:'51e546c50a1d4aa59beb17749aaa4d37', name:'xforms:trigger', children:[{id:'366f2c5a097e489eb2fc68f077def3e4', name:'xforms:label'}]},{id:'4cd72d3b0000464fbe15f43b8063cffb', name:'xforms:trigger', children:[{id:'e2d203632de84e4d856f930ff83a4c59', name:'xforms:label'}]}]}]}]}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'51e546c50a1d4aa59beb17749aaa4d37');xf._a('51e546c50a1d4aa59beb17749aaa4d37','366f2c5a097e489eb2fc68f077def3e4');xf._a(null,'4cd72d3b0000464fbe15f43b8063cffb');xf._a('4cd72d3b0000464fbe15f43b8063cffb','e2d203632de84e4d856f930ff83a4c59');function init() {	
...
var xf_trigger_51e546c50a1d4aa59beb17749aaa4d37=new xforms.XFTrigger('51e546c50a1d4aa59beb17749aaa4d37',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_0=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){justep.xbl('blob-blobImage1').dialogCancel();}));xf._p(justep('51e546c50a1d4aa59beb17749aaa4d37'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_0,'51e546c50a1d4aa59beb17749aaa4d37', evt,false)});	
var xf_trigger_4cd72d3b0000464fbe15f43b8063cffb=new xforms.XFTrigger('4cd72d3b0000464fbe15f43b8063cffb',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){justep.xbl('blob-blobImage1').dialogOk();}));xf._p(justep('4cd72d3b0000464fbe15f43b8063cffb'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_1,'4cd72d3b0000464fbe15f43b8063cffb', evt,false)});	
}	
