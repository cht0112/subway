...
_xbl_JSClassDefine_bizDataFilterDialog.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'d31bc01753f84bdb8824b5b002fcffcb', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'windowReceiver', name:'/UI/system/components/windowReceiver.xbl.xml#windowReceiver'},{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'rOOMAREA', name:'xforms:input'},{id:'blobImage1', name:'/UI/system/components/blob.xbl.xml#image', children:[{id:'blob-blobImage1', name:'/UI/system/components/blob.xbl.xml#blob', children:[{id:'dlg-blob-blobImage1', name:'/UI/system/components/dialog.xbl.xml#dialog', children:[{id:'771dff78815a4701a938d929a2bc5a09', name:'xforms:trigger', children:[{id:'cd502c008765463780ce891ccc330715', name:'xforms:label'}]},{id:'db113df8de024d4fafa0197be3b4dc49', name:'xforms:trigger', children:[{id:'aded88fbb25f49459480738252ba5b9c', name:'xforms:label'}]}]}]}]},{id:'gridSelect4', name:'xforms:gridselect1', children:[{id:'xuiLabel4', name:'xforms:label'},{id:'default26', name:'xforms:value'}]},{id:'gridSelect5', name:'xforms:gridselect1', children:[{id:'xuiLabel5', name:'xforms:label'},{id:'default37', name:'xforms:value'}]},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'xuiLabel2', name:'xforms:label'},{id:'default4', name:'xforms:value'}]},{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars'}]},{id:'filter-pattern-bd8bd923-7933-4c39-ab16-3c69c5f77bf0', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'694657f3f26b41319adf580c5740ab49', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N371436505', name:'xforms:menu'}]},{id:'GLOBAL_ID_N1004653214', name:'xforms:dialog'}]},{id:'filter-dialog-8330045f-d199-49dd-9651-4fbe23d06ca8', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N156282261', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'rOOMAREA');xf._a(null,'771dff78815a4701a938d929a2bc5a09');xf._a('771dff78815a4701a938d929a2bc5a09','cd502c008765463780ce891ccc330715');xf._a(null,'db113df8de024d4fafa0197be3b4dc49');xf._a('db113df8de024d4fafa0197be3b4dc49','aded88fbb25f49459480738252ba5b9c');xf._a(null,'gridSelect4');xf._a('gridSelect4','xuiLabel4');xf._a('gridSelect4','default27');xf._a(null,'gridSelect5');xf._a('gridSelect5','xuiLabel5');xf._a('gridSelect5','default38');xf._a(null,'gridSelect1');xf._a('gridSelect1','xuiLabel2');xf._a('gridSelect1','default5');function init() {	
...
var xf_menu_GLOBAL_ID_N371436505 = new xforms.XFMenu('GLOBAL_ID_N371436505','context');xf_menu_GLOBAL_ID_N371436505.menu.addContextZone('694657f3f26b41319adf580c5740ab49');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N371436505.hide()});xf_menu_GLOBAL_ID_N371436505.menu.setOpenMode('web');	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N1004653214");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N371436505'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'GLOBAL_ID_N371436505', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N1004653214',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1793859369');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_1793859369", "");}));xf._p(justep('GLOBAL_ID_N1004653214'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_3,'GLOBAL_ID_N1004653214', evt,false)});	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1793859369');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N1004653214'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_4,'GLOBAL_ID_N1004653214', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N156282261',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_1158688044');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_1158688044", "");}));xf._p(justep('GLOBAL_ID_N156282261'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_5,'GLOBAL_ID_N156282261', evt,false)});	
...
var xf_trigger_771dff78815a4701a938d929a2bc5a09=new xforms.XFTrigger('771dff78815a4701a938d929a2bc5a09',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_0=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){justep.xbl('blob-blobImage1').dialogCancel();}));xf._p(justep('771dff78815a4701a938d929a2bc5a09'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_0,'771dff78815a4701a938d929a2bc5a09', evt,false)});	
var xf_trigger_db113df8de024d4fafa0197be3b4dc49=new xforms.XFTrigger('db113df8de024d4fafa0197be3b4dc49',null,null,null,false,false,false,null,null,null);	
var xf_action_xf_action_1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){justep.xbl('blob-blobImage1').dialogOk();}));xf._p(justep('db113df8de024d4fafa0197be3b4dc49'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_1,'db113df8de024d4fafa0197be3b4dc49', evt,false)});	
new xforms.XFExtSelect({id:'gridSelect4',type:'gridselect1',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('bizData1')/aPPLYFOROBJECT"),labelRef:xf._q("data('bizData1')/dETECTIONOBJECTCNAME"),extRef:null,valueSeparator:',',labelSeparator:',',extSeparator:',',dataId:'bizData3',columns:'DETECTION_OBJECT_TYPE,dETECTIONOBJECTCNAME,__c_,dETECTIONOBJECTENAME',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'DETECTION_OBJECT_TYPE,dETECTIONOBJECTENAME',valueColumn:'DETECTION_OBJECT_TYPE',labelColumn:'dETECTIONOBJECTCNAME',extColumn:null,labels:',,,',aligns:',,,',types:'ro,ro,ro,ro',widths:{widths:"#,#,*,*",total:0},height:'',dropdownWidth:'',appearance:null,delay:false,autoLoadData:true,independence:false,delayCreateGrid:false,cascade:false,dataXML:null,inputChangeable:true,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:'mainActivity5.gridSelect4Closeup'});	
