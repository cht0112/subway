			...
			"modelRefreshcb" : function(){
				for(var model in this.xformInfo){
					...
					for(var i in infos){
						var info = infos[i];
						if (info.readonly){
							var xpath = xforms.XPath.get(info.readonly);var img = jQuery("#" + info.id + ".xforms-trigger-img,"+"#" + info.id + " .xforms-trigger-img");
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'0cc78016a4bf4395ace6d217e8ae18e1', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTrigger', name:'xforms:trigger', children:[{id:'237ca9c3135040dbb0e92ca17b89f371', name:'xforms:label'}]},{id:'removeTrigger', name:'xforms:trigger', children:[{id:'5ad6882e364443ddac77683eb44cffd8', name:'xforms:label'}]},{id:'a9584ffea0e64c90a0f2b2285f77ac9f', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'trigger8', name:'xforms:trigger', children:[{id:'xuiLabel11', name:'xforms:label'}]}]},{id:'windowDialog2', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'grdMaster', name:'xforms:grid'}]},{id:'borderLayout2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster2', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'saveMas', name:'xforms:trigger', children:[{id:'7c62d09245ba485d8fb1338c2b98977a', name:'xforms:label'}]},{id:'removeTrigr', name:'xforms:trigger', children:[{id:'796ac075931a43b19c8d7581d1eb884f', name:'xforms:label'}]}]},{id:'iptROOMCNAME', name:'xforms:input'},{id:'iptROOMENAME', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default18', name:'xforms:value'}]},{id:'textarea1', name:'xforms:textarea'},{id:'blobImage1', name:'/UI/system/components/blob.xbl.xml#image', children:[{id:'blob-blobImage1', name:'/UI/system/components/blob.xbl.xml#blob', children:[{id:'dlg-blob-blobImage1', name:'/UI/system/components/dialog.xbl.xml#dialog'}]}]},{id:'radio1', name:'xforms:select1', children:[{id:'selectItem1', name:'xforms:item', children:[{id:'default7', name:'xforms:label'},{id:'default10', name:'xforms:value'}]},{id:'selectItem2', name:'xforms:item', children:[{id:'default11', name:'xforms:label'},{id:'default12', name:'xforms:value'}]}]},{id:'gridSelect4', name:'xforms:gridselect1', children:[{id:'default22', name:'xforms:label'},{id:'default24', name:'xforms:value'}]},{id:'windowDialog1', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'tbsDetail', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertMas', name:'xforms:trigger', children:[{id:'c62f0e5ad34f4a0abf04b25af99aa425', name:'xforms:label'}]},{id:'save2Mas', name:'xforms:trigger', children:[{id:'973d94e085be4357b4983d65d26a1a8a', name:'xforms:label'}]},{id:'remove2', name:'xforms:trigger', children:[{id:'3eb2d7f2272b4bd4889567d71b8a04b7', name:'xforms:label'}]}]},{id:'grid1', name:'xforms:grid'}]}]},{id:'windowDialog3', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'windowDialog4', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'windowDialog5', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'windowDialog6', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'filter-dialog-f8b0fda7-1072-41ba-bcba-5a351f2e5f1b', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N624127827', name:'xforms:dialog'}]},{id:'filter-pattern-62121850-808e-4f3d-a135-770eb2687b76', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'2b0e983da23f4e3c872b2f2ee5883aec', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_591340791', name:'xforms:menu'}]},{id:'GLOBAL_ID_N207798498', name:'xforms:dialog'}]},{id:'filter-dialog-754a89c7-84ff-47ba-8fd6-a37d0d017a7d', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N650851498', name:'xforms:dialog'}]},{id:'filter-pattern-445ff72f-aee5-4f7b-9bf2-fc3566ba384e', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'6bacdb23ab574c2081a3b8878a273971', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N718737993', name:'xforms:menu'}]},{id:'GLOBAL_ID_1345253740', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'insertTrigger');xf._a('insertTrigger','237ca9c3135040dbb0e92ca17b89f371');xf._a(null,'removeTrigger');xf._a('removeTrigger','5ad6882e364443ddac77683eb44cffd8');xf._a(null,'trigger8');xf._a('trigger8','xuiLabel11');xf._a(null,'grdMaster');xf._a(null,'saveMas');xf._a('saveMas','7c62d09245ba485d8fb1338c2b98977a');xf._a(null,'removeTrigr');xf._a('removeTrigr','796ac075931a43b19c8d7581d1eb884f');xf._a(null,'iptROOMCNAME');xf._a(null,'iptROOMENAME');xf._a(null,'gridSelect1');xf._a('gridSelect1','xuiLabel3');xf._a('gridSelect1','default19');xf._a(null,'textarea1');xf._a(null,'radio1');xf._a('radio1','selectItem1');xf._a('selectItem1','default7');xf._a('radio1','selectItem2');xf._a('selectItem2','default11');xf._a(null,'gridSelect4');xf._a('gridSelect4','default22');xf._a('gridSelect4','default25');xf._a(null,'insertMas');xf._a('insertMas','c62f0e5ad34f4a0abf04b25af99aa425');xf._a(null,'save2Mas');xf._a('save2Mas','973d94e085be4357b4983d65d26a1a8a');xf._a(null,'remove2');xf._a('remove2','3eb2d7f2272b4bd4889567d71b8a04b7');xf._a(null,'grid1');function init() {	
...
new xforms.XFDialog('GLOBAL_ID_N624127827',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_22=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_415128175');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_415128175", "");}));xf._p(justep('GLOBAL_ID_N624127827'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_22,'GLOBAL_ID_N624127827', evt,false)});	
var xf_menu_GLOBAL_ID_591340791 = new xforms.XFMenu('GLOBAL_ID_591340791','context');xf_menu_GLOBAL_ID_591340791.menu.addContextZone('2b0e983da23f4e3c872b2f2ee5883aec');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_591340791.hide()});xf_menu_GLOBAL_ID_591340791.menu.setOpenMode('web');	
var xf_action_xf_action_23=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N207798498");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();				} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_591340791'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_23,'GLOBAL_ID_591340791', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N207798498',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_24=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1156885831');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N1156885831", "");}));xf._p(justep('GLOBAL_ID_N207798498'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_24,'GLOBAL_ID_N207798498', evt,false)});	
var xf_action_xf_action_25=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1156885831');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N207798498'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_25,'GLOBAL_ID_N207798498', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N650851498',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_26=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_N133835837');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_N133835837", "");}));xf._p(justep('GLOBAL_ID_N650851498'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_26,'GLOBAL_ID_N650851498', evt,false)});	
var xf_menu_GLOBAL_ID_N718737993 = new xforms.XFMenu('GLOBAL_ID_N718737993','context');xf_menu_GLOBAL_ID_N718737993.menu.addContextZone('6bacdb23ab574c2081a3b8878a273971');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N718737993.hide()});xf_menu_GLOBAL_ID_N718737993.menu.setOpenMode('web');	
var xf_action_xf_action_27=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_1345253740");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N718737993'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_27,'GLOBAL_ID_N718737993', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1345253740',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_28=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1169692529');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N1169692529", "");}));xf._p(justep('GLOBAL_ID_1345253740'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_28,'GLOBAL_ID_1345253740', evt,false)});	
var xf_action_xf_action_29=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N1169692529');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_1345253740'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_29,'GLOBAL_ID_1345253740', evt,false)});	
...
var xf_trigger_trigger8=new xforms.XFTrigger('trigger8',null,null,null,false,false);	
...
var xf_trigger_removeTrigr=new xforms.XFTrigger('removeTrigr',null,"/UI/system/images/standardToolbar/standard/remove.gif",null,false,false);	
...
var xf_action_xf_action_19=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){mainActivity4.insertMasClick(event)}));xf._p(justep('insertMas'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_19,'insertMas', evt,false)});	
var xf_trigger_save2Mas=new xforms.XFTrigger('save2Mas',null,"/UI/system/images/standardToolbar/standard/save.gif","/UI/system/images/standardToolbar/standard/un_save.gif",false,false);	
var xf_action_xf_action_20=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){mainActivity4.save2More(event)}));xf._p(justep('save2Mas'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_20,'save2Mas', evt,false)});	
