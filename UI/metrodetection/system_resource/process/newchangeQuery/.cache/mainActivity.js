...
_xbl_JSClassDefine_menu.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				refreshMenuItemset: function(itemsetID){
					...
					var params = this._itemsets[itemsetID]["params"];		var len = params.length;
					for (var i=0; len > i; i++){
...
_xbl_JSClassDefine_dateFilter.prototype = justep.Object.extend(new justep.XBLObject(), eval({
				...
				setDisabled : function(disabled){this.combo.disable(disabled);
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'be7fb319b77d4cf3976c53e8e17a6756', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'dlgChart', name:'/UI/system/components/windowDialog.xbl.xml#windowDialog'},{id:'process', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'process_processControlDialog', name:'xforms:dialog'},{id:'process_processChartDialogID', name:'xforms:dialog'},{id:'process_processConfirmDialog', name:'xforms:dialog', children:[{id:'5a281d83be2248f7950c36d896fb56b5', name:'xforms:trigger', children:[{id:'ebf6884cba35427f91cfe3054c5cb735', name:'xforms:label'}]},{id:'2065a96639d742f491fde687b9dccc1b', name:'xforms:trigger', children:[{id:'9ccdb792423a446bb73546dfe762a15e', name:'xforms:label'}]}]},{id:'process_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]},{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'toolbars1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'b48f6956c15b4e088789ed8415c9d2b9', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'dateFilter1', name:'/UI/system/components/dateFilter.xbl.xml#dateFilter', children:[{id:'dateFilter1_part', name:'xforms:group', children:[{id:'dateFilter1_dialog', name:'xforms:dialog', children:[{id:'7fa3029631104831a9ea89f46cc57036', name:'/UI/system/components/tableLayout.xbl.xml#tableLayout', children:[{id:'a85cb1fcf68b43cc8acfbbf9957bf90b', name:'xforms:input'},{id:'93d1992d4cd94c8ebea7018037561b6b', name:'xforms:input'}]}]}]}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'gridSelect1', name:'xforms:gridselect', children:[{id:'xuiLabel6', name:'xforms:label'},{id:'default2', name:'xforms:value'}]},{id:'smartFilter1', name:'/UI/system/components/smartFilter.xbl.xml#smartFilter', children:[{id:'smartFilter1_input_806629122', name:'xforms:input'}]},{id:'trgSearch', name:'xforms:trigger', children:[{id:'xuiLabel10', name:'xforms:label'}]},{id:'grid', name:'xforms:grid'}]},{id:'filter-pattern-d21f83bc-b05d-41ea-9260-799c395b860a', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'5ce22d32ef514b4fb756106d4a37811c', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N466264133', name:'xforms:menu'}]},{id:'GLOBAL_ID_389482107', name:'xforms:dialog'}]},{id:'filter-dialog-658e362c-8d38-403d-bca8-64946a29807c', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N285680459', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'5a281d83be2248f7950c36d896fb56b5');xf._a('5a281d83be2248f7950c36d896fb56b5','ebf6884cba35427f91cfe3054c5cb735');xf._a(null,'2065a96639d742f491fde687b9dccc1b');xf._a('2065a96639d742f491fde687b9dccc1b','9ccdb792423a446bb73546dfe762a15e');xf._a(null,'dateFilter1_part');xf._a('dateFilter1_part','a85cb1fcf68b43cc8acfbbf9957bf90b');xf._a('dateFilter1_part','93d1992d4cd94c8ebea7018037561b6b');xf._a(null,'gridSelect2');xf._a('gridSelect2','xuiLabel6');xf._a('gridSelect2','default3');xf._a(null,'gridSelect1');xf._a('gridSelect1','xf-label-3');xf._a('gridSelect1','xf-itemset-1');xf._a(null,'smartFilter1_input_806629122');xf._a(null,'trgSearch');xf._a('trgSearch','xuiLabel10');xf._a(null,'grid');function init() {	
...
xf._b("instance('smartFilter1_data_806629122')/value",xf._g(xf._f('instance',xf._i("smartFilter1_data_806629122")),xf._h(false, xf._k("child",xf._j('','value')))),'','http://www.justep.com/xui');	
...
var xf_trigger_5a281d83be2248f7950c36d896fb56b5=new xforms.XFTrigger('5a281d83be2248f7950c36d896fb56b5',null,null,null,false,false);	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('process_processConfirmDialog').close();}));xf._p(justep('5a281d83be2248f7950c36d896fb56b5'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_2,'5a281d83be2248f7950c36d896fb56b5', evt,false)});	
var xf_trigger_2065a96639d742f491fde687b9dccc1b=new xforms.XFTrigger('2065a96639d742f491fde687b9dccc1b',null,null,null,false,false);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('process_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('process_processConfirmDialog').close();}));xf._p(justep('2065a96639d742f491fde687b9dccc1b'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_3,'2065a96639d742f491fde687b9dccc1b', evt,false)});	
...
new xforms.XFExtSelect({id:'gridSelect1',type:'gridselect',defaultLabelRef:null,allSelectedLabelRef:null,ref:xf._q("data('custom_filter')/status"),labelRef:xf._q("data('custom_filter')/statusLabel"),extRef:null,valueSeparator:',',labelSeparator:',',extSeparator:',',dataId:null,columns:'col_0',headerH:null,rowH:null,dropdownClass:null,hiddenColumns:'',valueColumn:'col_0',labelColumn:'col_0',extColumn:null,labels:'',aligns:'',types:'checkbox',widths:{widths:"*",total:0},height:'',dropdownWidth:'',appearance:null,delay:false,autoLoadData:true,independence:false,delayCreateGrid:false,cascade:false,dataXML:'<rows id="default9"><row id="default10"><cell id="default11">编辑中</cell></row><row id="default12"><cell id="default13">处理中</cell></row><row id="default14"><cell id="default15">已完成</cell></row><row id="default16"><cell id="default17">已终止</cell></row></rows>',inputChangeable:false,disabled:false,readonly:false,smartRender:null,onAfterRowFill:null,onRowDisabled:null,onShowNodeImg:null,onRowExpand:null,onRowHasChildren:null,onKeyDown:null,onKeyUp:null,onKeyPress:null,onDropdown:null,onCloseup:'mainActivity.gridSelect1Closeup'});	
var xf_model_smartFilter1_model_806629122 = new xforms.XFModel('smartFilter1_model_806629122',null);	
new xforms.XFInstance2('smartFilter1_data_806629122','smartFilter1_model_806629122',null,'<rows rows=""><row></row></rows>',null,null,null,null,null,null,null,null,null);new SimpleStore('smartFilter1_data_806629122','value');	
xf._d('smartFilter1_input_806629122','text',xf._q("instance('smartFilter1_data_806629122')/value"),null,null,null,null,false,false);	
...
xf._d('a85cb1fcf68b43cc8acfbbf9957bf90b','text',xf._q("instance('dateFilter1_data')/beginDate"),null,null,null,null,false,false);	
xf._d('93d1992d4cd94c8ebea7018037561b6b','text',xf._q("instance('dateFilter1_data')/endDate"),null,null,null,null,false,false);	
}	
...
var __actions__ = {	
		...
		function load_dateFilter1_part_html(){var a = [];a.push('<div class="xforms-group-content" style="" >');a.push('<div id="dateFilter1_dialog" style="display:none" >');a.push('</div>');a.push('<div style="width:238px;height:110px;position:absolute;left:-9000px;top:-9000px" >');a.push('<div class="xforms-dialog" height="135" id="dateFilter1_dialog-content" minmax="false" resizable="false" style="width:100%;height:100%" title="自定义" width="242" >');a.push('<table border="0" cellpadding="0" cellspacing="8" class="component_42908985 tableLayout" component="/UI/system/components/tableLayout.xbl.xml#tableLayout" id="7fa3029631104831a9ea89f46cc57036" style="width:100%;height:100%;tabel-layout:fixed" >');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('开始日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="a85cb1fcf68b43cc8acfbbf9957bf90b" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr style="height: 28px" valign="middle" >');a.push('<td style="width: 56px;" >');a.push('<div style="padding-top:8px" >');a.push('结束日期');a.push('</div>');a.push('</td>');a.push('<td>');a.push('<table cellpadding="0" cellspacing="0" class="xforms-control xforms-input xforms-appearance-minimal xui-input" id="93d1992d4cd94c8ebea7018037561b6b" onmouseout="xforms.showMessage(this,false)" onmouseover="xforms.showMessage(this,true)" >');a.push('<tbody>');a.push('<tr>');a.push('<td class="focus" style="display:none;width:0px" >');a.push('</td>');a.push('<td class="xxf-value" >');a.push('<input accesskey="" class="xforms-value" tabindex="" type="text" >');a.push('</input>');a.push('</td>');a.push('<td class="xxf-alert" >');a.push('<span class="xforms-alert" >');a.push('<span class="xforms-alert-icon" onmouseout="show(this, null, false)" onmouseover="show(this, null, true)" >');a.push('</span>');a.push('<div class="xforms-alert-value" id="" >');a.push('</div>');a.push('</span>');a.push('</td>');a.push('<td class="xui-ie-input-bug" >');a.push('</td>');a.push('</tr>');a.push('</tbody>');a.push('</table>');a.push('</td>');a.push('</tr>');a.push('<tr valign="middle" >');a.push('<td align="right" colspan="2" >');a.push('<button class="xui-button" onclick="xforms.blur(true); if (justep.xbl(\'dateFilter1\')._doDialogCheck())xforms(\'dateFilter1_dialog\').close();" style="width: 75px;margin-right:8px;" >');a.push('确定');a.push('</button>');a.push('<button class="xui-button" onclick="xforms(\'dateFilter1_dialog\').close();" style="width: 75px" >');a.push('取消');a.push('</button>');a.push('</td>');a.push('</tr>');a.push('</table>');a.push('</div>');a.push('</div>');a.push('</div>');justep('dateFilter1_part').innerHTML = a.join('');}