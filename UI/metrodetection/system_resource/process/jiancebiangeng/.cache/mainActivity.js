...
_xbl_JSClassDefine_toolbars.prototype = justep.Object.extend(new justep.XBLObject(), eval({
	...
	var ids=[{id:'a261e035dd5f4fcaabdae6e3946dec80', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'saveTrigger', name:'xforms:trigger', children:[{id:'98fb41ae4b4f4626ba7b6cb4a8ff16b6', name:'xforms:label'}]}]},{id:'CHANGE_APPLY_DOC_NO2', name:'xforms:input'},{id:'CHANGE_APPLY_NOAPPLYNO2', name:'xforms:input'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'default13', name:'xforms:label'},{id:'default14', name:'xforms:value'}]},{id:'input5', name:'xforms:input'},{id:'APPLY_PERSONPERSON2', name:'xforms:input'},{id:'APPLY_DATEDATE2', name:'xforms:input'},{id:'input4', name:'xforms:input'},{id:'CHANGE_TITLETITLE2', name:'xforms:input'},{id:'CHANGE_OBJECTOBJECT2', name:'xforms:input'},{id:'gridSelect2', name:'xforms:gridselect', children:[{id:'default16', name:'xforms:label'},{id:'default17', name:'xforms:value'}]},{id:'textarea2', name:'xforms:textarea'},{id:'textarea3', name:'xforms:textarea'},{id:'textarea4', name:'xforms:textarea'},{id:'textarea5', name:'xforms:textarea'},{id:'textarea6', name:'xforms:textarea'},{id:'textarea7', name:'xforms:textarea'},{id:'input1', name:'xforms:input'},{id:'input3', name:'xforms:input'}]},{id:'flw', name:'/UI/system/components/process.xbl.xml#process', children:[{id:'flw_processControlDialog', name:'xforms:dialog'},{id:'flw_processChartDialogID', name:'xforms:dialog'},{id:'flw_processConfirmDialog', name:'xforms:dialog', children:[{id:'1d2b71f0f4c64fda9220cc47b2541bbf', name:'xforms:trigger', children:[{id:'16167aee811f4a8087e185855ad02968', name:'xforms:label'}]},{id:'670f637421d147cba3032676236fbbea', name:'xforms:trigger', children:[{id:'fd63ed7e523b4b22a8d538110e93c401', name:'xforms:label'}]}]},{id:'flw_customizedDialogID', name:'/UI/system/components/dialog.xbl.xml#dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 		
xforms.Core.fileName='form.js';	
xf._a(null,'saveTrigger');xf._a('saveTrigger','98fb41ae4b4f4626ba7b6cb4a8ff16b6');xf._a(null,'CHANGE_APPLY_DOC_NO2');xf._a(null,'CHANGE_APPLY_NOAPPLYNO2');xf._a(null,'gridSelect1');xf._a('gridSelect1','default13');xf._a('gridSelect1','default15');xf._a(null,'input5');xf._a(null,'APPLY_PERSONPERSON2');xf._a(null,'APPLY_DATEDATE2');xf._a(null,'input4');xf._a(null,'CHANGE_TITLETITLE2');xf._a(null,'CHANGE_OBJECTOBJECT2');xf._a(null,'gridSelect2');xf._a('gridSelect2','default16');xf._a('gridSelect2','default19');xf._a(null,'textarea2');xf._a(null,'textarea3');xf._a(null,'textarea4');xf._a(null,'textarea5');xf._a(null,'textarea6');xf._a(null,'textarea7');xf._a(null,'input1');xf._a(null,'input3');xf._a(null,'1d2b71f0f4c64fda9220cc47b2541bbf');xf._a('1d2b71f0f4c64fda9220cc47b2541bbf','16167aee811f4a8087e185855ad02968');xf._a(null,'670f637421d147cba3032676236fbbea');xf._a('670f637421d147cba3032676236fbbea','fd63ed7e523b4b22a8d538110e93c401');function init() {	
...
var xf_trigger_1d2b71f0f4c64fda9220cc47b2541bbf=new xforms.XFTrigger('1d2b71f0f4c64fda9220cc47b2541bbf',null,null,null,false,false);	
var xf_action_xf_action_4=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('flw_processConfirmDialog').xformsObject; processConfirmDialog._isOk = true; xforms('flw_processConfirmDialog').close();}));xf._p(justep('1d2b71f0f4c64fda9220cc47b2541bbf'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_4,'1d2b71f0f4c64fda9220cc47b2541bbf', evt,false)});	
var xf_trigger_670f637421d147cba3032676236fbbea=new xforms.XFTrigger('670f637421d147cba3032676236fbbea',null,null,null,false,false);	
var xf_action_xf_action_5=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var processConfirmDialog = justep('flw_processConfirmDialog').xformsObject; processConfirmDialog._isOk = false; xforms('flw_processConfirmDialog').close();}));xf._p(justep('670f637421d147cba3032676236fbbea'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_5,'670f637421d147cba3032676236fbbea', evt,false)});	
}	
