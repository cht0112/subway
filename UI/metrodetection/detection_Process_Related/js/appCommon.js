...
appCommon.GridUtils.getCellBtnHTML = function(label, clickFunName) {
	return "<table width='100%' cellpadding='0' cellspacing='0' height='100%' border='0' style='table-layout: fixed;margin: 0;'>"
			...
			+ label
			+ "		</span></td>"
			+ "	<td width='20' style='border-style: none;' valign='middle'>"
			+ "		<input onclick='" + clickFunName + "()' type='button' value='…' style='width: 20px; height: 18px; font-size: 9pt; text-align: center;'>"
			+ "	</td></tr></table>";
};
