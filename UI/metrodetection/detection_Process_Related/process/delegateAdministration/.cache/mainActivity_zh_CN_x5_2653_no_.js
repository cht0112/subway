...
_xbl_JSClassDefine_window.prototype.__code__={v:{name:'_xbl_JSClassDefine_window',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'5163e9b9ea3186432796fc280f2744aa'};
...
_xbl_JSClassDefine_tabs.prototype.__code__={v:{name:'_xbl_JSClassDefine_tabs',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'fcb0eb2548173a6578462b4d0e4c1f9e'};
...
_xbl_JSClassDefine_menu.prototype.__code__={v:{name:'_xbl_JSClassDefine_menu',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'89a5647f2190d5219f3aef61dde2777d'};
...
_xbl_JSClassDefine_bizDataFilterPattern.prototype.__code__={v:{name:'_xbl_JSClassDefine_bizDataFilterPattern',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'08360f19ccdabfe06d4a327928cbf415'};
...
_xbl_JSClassDefine_borderLayout.prototype.__code__={v:{name:'_xbl_JSClassDefine_borderLayout',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'bd75a121a3fae93c08b794ee6aefd35a'};
...
_xbl_JSClassDefine_toolbars.prototype.__code__={v:{name:'_xbl_JSClassDefine_toolbars',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'be9da17bf0fcb5667e9caaf79ac06742'};
...
_xbl_JSClassDefine_export.prototype.__code__={v:{name:'_xbl_JSClassDefine_export',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'cf82cf824a7924c319aeebcec59034a9'};
...
_xbl_JSClassDefine_bizDataFilterDialog.prototype.__code__={v:{name:'_xbl_JSClassDefine_bizDataFilterDialog',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'4b1c64c2523dc4c6deba94b687f356b8'};
...
_xbl_JSClassDefine_pageNavigator.prototype.__code__={v:{name:'_xbl_JSClassDefine_pageNavigator',key:'a4e255492ce6df9d8585b63470355fd6',time:1528080086},m:'570692538b136b2de04abbc5edf04d87'};
	var ids=[{id:'87cbf80126694bb4bb09ff9ec8ee4c9d', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'tabpanel1', name:'/UI/system/components/tabs.xbl.xml#tabs', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster1', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertTrigger', name:'xforms:trigger', children:[{id:'9f57d48c06b548949f2c4a0de9c66f70', name:'xforms:label'}]},{id:'removeTrigger', name:'xforms:trigger', children:[{id:'de035cc3790e4d10bb425096fdc2236e', name:'xforms:label'}]},{id:'16d958c7ffdf4b269ed383211acc16e0', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'},{id:'excelExport1', name:'/UI/system/components/excel.xbl.xml#export', children:[{id:'trigger-excelExport1', name:'xforms:trigger', children:[{id:'4d319b1da3164fc98d2eaff8def82b72', name:'xforms:label'}]}]}]},{id:'grdMaster', name:'xforms:grid'}]},{id:'borderLayout2', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMaster2', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'insertMas', name:'xforms:trigger', children:[{id:'ece4556deb1a471090c2d47abd7dd405', name:'xforms:label'}]},{id:'saveMas', name:'xforms:trigger', children:[{id:'751822d9e5264c6a92ffc03750022ac8', name:'xforms:label'}]}]},{id:'iptMANUFACTUREIDCNAME', name:'xforms:input'},{id:'iptMANUFACTUREIDENAME', name:'xforms:input'},{id:'iptMANUFACTUREADDRESS', name:'xforms:input'},{id:'iptMANUFACTUREPOSTCODE', name:'xforms:input'},{id:'iptCONTACTTELEPHONE', name:'xforms:input'},{id:'iptCONTACTMOBILE', name:'xforms:input'},{id:'iptFAXNUMBER', name:'xforms:input'},{id:'iptCONTACTEMAIL', name:'xforms:input'},{id:'textarea1', name:'xforms:textarea'},{id:'gridSelect1', name:'xforms:gridselect1', children:[{id:'xuiLabel3', name:'xforms:label'},{id:'default12', name:'xforms:value'}]},{id:'gridSelect2', name:'xforms:gridselect1', children:[{id:'default35', name:'xforms:label'},{id:'default36', name:'xforms:value'}]},{id:'input1', name:'xforms:input'}]}]},{id:'filter-dialog-06fcefb7-43d8-4b2f-9f6f-11e0c21a008a', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_N278149811', name:'xforms:dialog'}]},{id:'filter-pattern-8eedf625-642a-4566-9d0d-cb6ad0599706', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'f3630f06e9b44b1b8563d102358331cc', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_856997242', name:'xforms:menu'}]},{id:'GLOBAL_ID_1253512360', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
justep.XBLObject.code='a4e255492ce6df9d8585b63470355fd6';
xforms.Core.fileName='form.js';	
xf._a(null,'insertTrigger');xf._a('insertTrigger','9f57d48c06b548949f2c4a0de9c66f70');xf._a(null,'removeTrigger');xf._a('removeTrigger','de035cc3790e4d10bb425096fdc2236e');xf._a(null,'trigger-excelExport1');xf._a('trigger-excelExport1','4d319b1da3164fc98d2eaff8def82b72');xf._a(null,'grdMaster');xf._a(null,'insertMas');xf._a('insertMas','ece4556deb1a471090c2d47abd7dd405');xf._a(null,'saveMas');xf._a('saveMas','751822d9e5264c6a92ffc03750022ac8');xf._a(null,'iptMANUFACTUREIDCNAME');xf._a(null,'iptMANUFACTUREIDENAME');xf._a(null,'iptMANUFACTUREADDRESS');xf._a(null,'iptMANUFACTUREPOSTCODE');xf._a(null,'iptCONTACTTELEPHONE');xf._a(null,'iptCONTACTMOBILE');xf._a(null,'iptFAXNUMBER');xf._a(null,'iptCONTACTEMAIL');xf._a(null,'textarea1');xf._a(null,'gridSelect1');xf._a('gridSelect1','xuiLabel3');xf._a('gridSelect1','default15');xf._a(null,'gridSelect2');xf._a('gridSelect2','default35');xf._a('gridSelect2','default37');xf._a(null,'input1');function init() {	
...
new xforms.XFDialog('GLOBAL_ID_N278149811',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_7=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_16804640');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_16804640", "");}));xf._p(justep('GLOBAL_ID_N278149811'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_7,'GLOBAL_ID_N278149811', evt,false)});	
var xf_menu_GLOBAL_ID_856997242 = new xforms.XFMenu('GLOBAL_ID_856997242','context');xf_menu_GLOBAL_ID_856997242.menu.addContextZone('f3630f06e9b44b1b8563d102358331cc');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_856997242.hide()});xf_menu_GLOBAL_ID_856997242.menu.setOpenMode('web');	
var xf_action_xf_action_8=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_1253512360");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_856997242'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_8,'GLOBAL_ID_856997242', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1253512360',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_9=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1969136124');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_1969136124", "");}));xf._p(justep('GLOBAL_ID_1253512360'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_9,'GLOBAL_ID_1253512360', evt,false)});	
var xf_action_xf_action_10=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_1969136124');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_1253512360'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_10,'GLOBAL_ID_1253512360', evt,false)});	
