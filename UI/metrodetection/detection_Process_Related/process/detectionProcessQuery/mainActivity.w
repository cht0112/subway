...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model1" style="height:auto;top:282px;left:207px;"> 
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereVersion"
      auto-load="false" id="main" concept="SA_Task" order-by="sCreateTime desc" filter-relations="sName,sCreateTime,sLastModifyTime,sCreatorPersonName,sESField05"> 
      <reader id="default1" action="/metrodetection/system_code/logic/action/detectionProcessQueryAction"/>  
  ...
  <xui:view id="rootView"> 
    ...
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column"
      ...
      <xui:column id="gridColumn3" ref="sStatusName1" label="状态" type="ro" width="60px"
        align="center"/>  
      <xui:column id="gridColumn12" ref="sESField05" label="申请单据号" type="html" width="121px"
        onRender="mainActivity.grid_sESField05Render"/>  
