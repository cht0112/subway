...
<window xmlns="http://www.justep.com/xui" xmlns:ev="http://www.w3.org/2001/xml-events"
  ...
  <view auto-load="true" id="rootView"> 
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="flow" style="position:relative;" id="layout1"> 
        <xhtml:div component="/UI/system/components/excelLayout.xbl.xml#excelLayout"
          id="excelLayout1" src="excelLayout1.xls" style="width:100%; height: 100%;;;"/> 
         <xhtml:iframe xmlns:xhtml="http://www.w3.org/1999/xhtml" id="iframe1" name="iframea" src="about:blank" style="display:none;width:0px;height:0px;"/>   
      </layout>  
      ...
      <xui:view auto-load="false" id="view2" class="xui-container" style="border-color:#000000 #000000 #000000 #000000;border-style:double double double double;border-width:1px 1px 1px 1px;width:919px;height:207px;"> 
        <layout type="absolute" style="position:relative;" id="layout2"> 
          <xui:place control="toolbars1" id="controlPlace3" style="position:absolute;left:10px;top:5px;width:619px;height:37px;"/>  
        ...
        <xhtml:div component="/UI/system/components/toolbars.xbl.xml#toolbars" id="toolbars1"> 
          <xui:bar component="/UI/system/components/reportBar.xbl.xml#printBar"
            id="printBar1" report="report1" mode="IMG_TXT_LR"> 
          ...
          <xui:bar component="/UI/system/components/reportBar.xbl.xml#exportBar"
            id="exportBar1" report="report1" mode="IMG_TXT_LR"> 
      ...
      <xforms:trigger appearance="image" id="trigger1" image-text-mode="LR" style="width:31px;"
        src="/UI/metrodetection/detection_Process_Related/process/detectionProcessQuery/images/move_down.gif"> 
   ...
   <xforms:label id="default2"><![CDATA[导出word]]></xforms:label>
  <xforms:action id="action3" ev:event="DOMActivate"><xforms:script id="xformsScript3"><![CDATA[detectionProcessQueryDetail.trigger2Click(event)]]></xforms:script></xforms:action></xforms:trigger></xui:view> 
  </view>  
