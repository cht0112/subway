<window 
  ...
  <div id="borderLayout1" xui:update-mode="delete"/>
   <xforms:model id="mdDefault" style="width:208px;top:224px;left:832px;height:296px;"  xui:update-mode="merge"/>
...
<cell id="default3_2" />
    ...
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData" concept="TEST_SCHEME_BASE_INFO" id="testSchemeData" limit="-1" store-type="simple" update-mode="whereAll" xui:parent="mdDefault" xui:update-mode="insert" >
...
<rule alert="'项目名称不能为空!'" id="dataBizRule2_46" relation="pROJECTNAME" required="true()" />
...
<rule alert="'联系人不能为空!'" id="dataBizRule6_46" relation="cONTACTPERSON" required="true()" />
<rule alert="'联系手机不能为空!'" id="dataBizRule7_46" relation="cONTACTMOBILE" required="true()" />
...
<rule alert="'质量负责人不能为空!'" id="dataBizRule4_1" relation="qAMANAGER" required="true()" />
<rule alert="'检测负责人不能为空!'" id="dataBizRule5_1" relation="tESTMANAGER" required="true()" />
<rule alert="'技术负责人不能为空!'" id="dataBizRule6_1" relation="tECHMANAGER" required="true()" />
<rule alert="'结项日期不能为空!'" id="dataBizRule1_3" relation="eNDINGDATE" required="true()" />
</data>
...
<writer action="/metrodetection/system_code/logic/action/saveOPERATOR_PASSWORDAction" id="default11_1" />
    ...
    <xforms:action xmlns:xforms="http://www.justep.com/xforms" ev:event="onload" id="action3_2" xui:parent="mdDefault" xui:update-mode="insert" >
<xforms:script xmlns:xforms="http://www.justep.com/xforms" id="xformsScript3_2" >
<![CDATA[bizActivity9.mdDefaultLoad(event)]]>
</xforms:script>
</xforms:action>
...
<writer action="/metrodetection/system_code/logic/action/saveTEST_PROJECT_MEMBER_INFOAction" id="default6_2" />
    ...
    <data auto-load="false" component="/UI/system/components/data.xbl.xml#bizData" concept="TEST_PROJECT_TASK_INFO" data-type="json" id="taskData" onValueChanging="bizActivity9.taskDataValueChanging" store-type="simple" update-mode="whereAll" xui:parent="mdDefault" xui:update-mode="insert" >
...
<creator action="/metrodetection/system_code/logic/action/createTEST_PROJECT_MEMBER_INFOAction" id="default1_8" />
<reader action="/metrodetection/system_code/logic/action/myQueryProjectMemberForPlanAction" id="default2_8" />
<writer action="/metrodetection/system_code/logic/action/saveTEST_PROJECT_MEMBER_INFOAction" id="default3_8" />
<calculate-relation id="calculate-relation1_9" relation="calculate0" />
</data>
    <data auto-load="false" component="/UI/system/components/data.xbl.xml#bizData" concept="RECURRENCE_TEST_SCHEME" data-type="xml" id="recurrenceTestScheme" store-type="simple" update-mode="whereAll" xui:parent="mdDefault" xui:update-mode="insert" >
<creator action="/metrodetection/system_code/logic/action/createRECURRENCE_TEST_SCHEMEAction" id="default35_1" />
<reader action="/metrodetection/system_code/logic/action/queryRECURRENCE_TEST_SCHEMEAction" id="default36_1" />
<writer action="/metrodetection/system_code/logic/action/saveRECURRENCE_TEST_SCHEMEAction" id="default37_1" />
</data>
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData" concept="TEST_TASK_CASE_INFO" data-type="json" id="taskCase" update-mode="whereAll" xui:parent="mdDefault" xui:update-mode="insert" >
<creator action="/metrodetection/system_code/logic/action/createTEST_TASK_CASE_INFOAction" id="default4_4" />
<reader action="/metrodetection/system_code/logic/action/queryTEST_TASK_CASE_INFOAction" id="default5_4" />
<writer action="/metrodetection/system_code/logic/action/saveTEST_TASK_CASE_INFOAction" id="default6_4" />
</data>
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData" concept="TEST_SCHEME_CASE_INFO" data-type="json" id="schemeCase" update-mode="whereAll" xui:parent="mdDefault" xui:update-mode="insert" >
<creator action="/metrodetection/system_code/logic/action/createTEST_SCHEME_CASE_INFOAction" id="default9_4" />
<reader action="/metrodetection/system_code/logic/action/queryTEST_SCHEME_CASE_INFOAction" id="default12_4" />
<writer action="/metrodetection/system_code/logic/action/saveTEST_SCHEME_CASE_INFOAction" id="default15_4" />
</data>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-tabPanel" component="/UI/system/components/tabs.xbl.xml#tabs" id="tabPanel4_9" style="position:absolute;position:absolute;left:5px;top:47px;height:621px;width:1200px;" >
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage7_9" xforms-select="bizActivity9.tabPage7_9Select" >
<xui:label xmlns:xui="http://www.justep.com/xui" id="xuiLabel7_9" >
<![CDATA[项目信息]]>
</xui:label>
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/borderLayout.xbl.xml#borderLayout" id="borderLayout1" style="width:100%; height: 100%;;;" >
<center id="borderLayout-center1" >
<xui:place xmlns:xui="http://www.justep.com/xui" control="view2_7" id="controlPlace3_7" style="width:1017px;height:456px;" />
</center>
</xhtml:div>
</xui:tab>
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage1_8" xforms-select="bizActivity9.tabPage1_8Select" >
...
项目成员</xui:label>
<xui:place xmlns:xui="http://www.justep.com/xui" control="view1_8" id="controlPlace1_8" style="height:100%;width:100%;" />
</xui:tab>
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage8_9" xforms-select="planJS.tabPage8_9Select" >
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="view2_3" id="controlPlace17_3" style="height:41px;width:978px;" />
<xui:place xmlns:xui="http://www.justep.com/xui" control="grid13_2" id="controlPlace14_2" style="height:88%;width:107%;" />
...
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage1_2" xforms-select="bizActivity9.tabPage1_2Select" >
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="windowDialog2" id="controlPlace11_1" style="position:absolute;top:227px;left:569px;" />
</layout>
...
<item id="barItem1_1" name="execute-list-item" />
</xui:bar>
</xhtml:div>
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="view1_22" id="controlPlace1_22" style="width:100%;position:absolute;left:5px;top:5px;height:213px;" />
<xui:place xmlns:xui="http://www.justep.com/xui" control="view1_24" id="controlPlace1_24" style="height:220px;width:100%;position:absolute;left:5px;top:218px;" />
</layout>
<xui:view xmlns:xui="http://www.justep.com/xui" auto-load="true" class="xui-container" id="view1_22" >
<layout id="layout1_22" src="hg-apply.xls" style="height:246px;width:100%;position:relative;left:50px;" type="cell.excel" />
...
<layout id="layout1_24" src="hg-proInfo.xls" style="height:220px;width:100%;position:relative;left:50px;" type="cell.excel" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="pROJECTNAME" readonly="true" ref="data('pData')/pROJECTNAME" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="cONTACTPERSON" readonly="true" ref="data('pData')/cONTACTPERSON" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="cONTACTMOBILE" readonly="true" ref="data('pData')/cONTACTMOBILE" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="cONTACTTELEPHONE" readonly="true" ref="data('pData')/cONTACTTELEPHONE" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="cONTACTEMAIL" readonly="true" ref="data('pData')/cONTACTEMAIL" />
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-autofill" component="/UI/system/components/select.xbl.xml#gridSelect" ext-separator="," id="gridSelect2_24" label-ref="data('pData')/cname1" label-separator="," readonly="true" ref="data('pData')/mANUFACTUREID" value-separator="," >
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-autofill" component="/UI/system/components/select.xbl.xml#gridSelect" ext-separator="," id="gridSelect3_24" label-separator="," readonly="true" ref="data('pData')/nOTIFYTYPE" value-separator="," >
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-autofill" component="/UI/system/components/select.xbl.xml#gridSelect" ext-separator="," id="gridSelect5_24" label-separator="," onCloseup="bizActivity4.gridSelect5_24Closeup" readonly="true" ref="data('pData')/tESTSCHEMEID" value-separator="," >
...
<xforms:textarea xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="textarea1_24" readonly="true" ref="data('pData')/mEMO" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="input1_24" readonly="true" ref="data('pData')/lINEID" />
<xforms:input xmlns:xforms="http://www.justep.com/xforms" class="xui-autofill" id="input1_3" readonly="true" ref="data('pData')/lINEID" />
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="triggerOut" id="controlPlace1_1" style="position:absolute;top:10px;left:895px;" />
<xui:place xmlns:xui="http://www.justep.com/xui" control="triggerinput" id="controlPlace4_1" style="position:absolute;top:10px;left:823px;" />
</layout>
...
<xforms:label xmlns:xforms="http://www.justep.com/xforms" id="default28_1" >
<![CDATA[导出计划]]>
</xforms:label>
<xforms:action xmlns:xforms="http://www.justep.com/xforms" ev:event="DOMActivate" id="action2_1" >
<xforms:script xmlns:xforms="http://www.justep.com/xforms" id="xformsScript2_1" >
<![CDATA[bizActivity9.triggerOutClick(event)]]>
</xforms:script>
</xforms:action>
</xforms:trigger>
<xforms:trigger xmlns:xforms="http://www.justep.com/xforms" id="triggerinput" >
<xforms:label xmlns:xforms="http://www.justep.com/xforms" id="default32_1" >
<![CDATA[导入计划]]>
</xforms:label>
<xforms:action xmlns:xforms="http://www.justep.com/xforms" ev:event="DOMActivate" id="action3_1" >
<xforms:script xmlns:xforms="http://www.justep.com/xforms" id="xformsScript3_1" >
<![CDATA[bizActivity9.triggerinputClick(event)]]>
</xforms:script>
</xforms:action>
</xforms:trigger>
</xui:view>
...
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn2_4" label="检测任务" ref="tASKID" type="ed" width="65px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn38_2" label="测试用例名称" ref="tESTCASENAME" type="tree" width="251px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn1_4" label="检测方面" readonly="true" ref="rANGENAME" type="ed" width="100px" />
...
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn1_3" label="前置任务" ref="qZRW" type="ed" width="65" />
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/select.xbl.xml#gridSelect" ext-separator="," id="hrselect" label-ref="data('vData')/pName" label-separator="," onCloseup="bizActivity4.hrselectCloseup" ref="data('vData')/oPERATORNAME" value-separator="," >
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="trigger9_1" id="controlPlace22_1" style="position:absolute;width:93px;height:26px;left:424px;top:13px;" />
...
<xhtml:span xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-container" id="span1_2" style="position:absolute;top:52px;height:21px;width:433px;left:212px;color:red;" >
...
注:若本项目已制定完计划则重新制定时与上次计划有关的数据将会全部清除。</xhtml:span>
</layout>
...
bizActivity9.trigger9_1Click(event)</xforms:script>
</xforms:action>
</xforms:trigger>
</xui:view>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/grid.xbl.xml#grid" data="taskData" id="grid2_2" show-header-menu="hide-column,save-layout,group-column,adjust-column" smart-render="20" >
...
<xui:column xmlns:xui="http://www.justep.com/xui" editor="gridSelect1_1" id="gridColumn3_1" label="样品序号" ref="dEVICEID" type="select" width="111px" >
...
<xforms:column xmlns:xforms="http://www.justep.com/xforms" id="default33_1" ref="SAMPLE_DEVICE_INFO" visible="false" />
<xforms:column xmlns:xforms="http://www.justep.com/xforms" id="default34_1" ref="dEVICEID" />
</xforms:itemset>
</xhtml:div>
</xui:column>
</xhtml:div>
...
bizActivity4.trigger2_2Click(event)</xforms:script>
</xforms:action>
</xforms:trigger>
...
bizActivity4.trigger3_2Click(event)</xforms:script>
</xforms:action>
</xforms:trigger>
...
bizActivity4.trigger4_2Click(event)</xforms:script>
</xforms:action>
</xforms:trigger>
...
<xhtml:img xmlns:xhtml="http://www.w3.org/1999/xhtml" align="absmiddle" dis-src="/UI/system/images/standardToolbar/standard/un_save.gif" id="saveRoomAndTool" onclick="bizActivity4.saveItemClick(event)" src="/UI/system/images/standardToolbar/standard/save.gif" style="border:none" title="新建" />
</item>
...
<layout id="layout1_8" style="position:relative;" type="absolute" >
<xui:place xmlns:xui="http://www.justep.com/xui" control="grid1_10" id="controlPlace1_10" style="position:absolute;left:5px;height:100%;width:98%;top:50px;" />
<xui:place xmlns:xui="http://www.justep.com/xui" control="toolbars1_2" id="controlPlace11_2" style="width:400px;height:25px;position:absolute;top:8px;left:5px;" />
<xui:place xmlns:xui="http://www.justep.com/xui" control="hrDialog" id="controlPlace10_2" style="position:absolute;top:120px;left:252px;" />
</layout>
...
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn7_10" label="计划占用起始日期时间" ref="oCCUPYSTARTDATETIME" type="ed" width="181px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn8_10" label="计划占用结束日期时间" ref="oCCUPYENDDATETIME" type="ed" width="175px" />
</xhtml:div>
...
<xforms:label xmlns:xforms="http://www.justep.com/xforms" id="default38_1" >
...
新建</xforms:label>
<xforms:action xmlns:xforms="http://www.justep.com/xforms" ev:event="DOMActivate" id="action4_1" >
<xforms:script xmlns:xforms="http://www.justep.com/xforms" id="xformsScript4_1" >
...
bizActivity9.insertTriggerClick(event)</xforms:script>
</xforms:action>
<xforms:action xmlns:xforms="http://www.justep.com/xforms" ev:event="DOMActivate" id="action5_1" >
<xforms:script xmlns:xforms="http://www.justep.com/xforms" id="xformsScript5_1" >
<![CDATA[bizActivity9.insertTriggerClick(event)]]>
</xforms:script>
</xforms:action>
</xforms:trigger>
</item>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/windowDialog.xbl.xml#windowDialog" height="300px" id="hrDialog" modal="true" onClose="bizActivity9.hrDialogClose" onReceive="bizActivity9.hrDialogReceive" title="" url="/UI/metrodetection/detection_Process_Related/process/detectionManager/projectMemberDialog.w" width="400px" />
</xui:view>
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/windowDialog.xbl.xml#windowDialog" height="300px" id="windowDialog2" modal="true" onClose="bizActivity9.windowDialog2Close" title="" url="/UI/metrodetection/detection_Process_Related/process/detectionManager/importMppDialog.w" width="400px" />
</xui:view>
   ...
   <place id="controlPlace7" style="width:24px;top:229px;left:893px;"  xui:update-mode="merge"/>
    ...
    <xhtml:script xmlns:xhtml="http://www.w3.org/1999/xhtml" id="htmlScript1_1" src="bizActivity9.js" xui:parent="rsMain" xui:update-mode="insert" />
    <xhtml:script xmlns:xhtml="http://www.w3.org/1999/xhtml" id="htmlScript1_4_1" src="planJS.js" xui:parent="rsMain" xui:update-mode="insert" />
