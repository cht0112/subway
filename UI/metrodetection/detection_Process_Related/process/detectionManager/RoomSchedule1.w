...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdMain" style="width:150px;top:239px;height:105px;left:132px;"> 
    ...
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      auto-load="true" id="dSchedule" concept="DETECTION_ROOM_INFO" store-type="simple"
      limit="200"> 
      <creator id="default4" action="/metrodetection/system_code/logic/action/createDETECTION_ROOM_INFOAction"/>  
      <reader id="default5" action="/metrodetection/system_code/logic/action/myQueryRoomScheduleAction"/>  
      <writer id="default6" action="/metrodetection/system_code/logic/action/saveDETECTION_ROOM_INFOAction"/> 
    </data>  
    <data component="/UI/system/components/data.xbl.xml#bizData" update-mode="whereAll"
      auto-load="true" id="hrBaseData" concept="DETECTION_ROOM_INFO" is-tree="false"
      store-type="simple"> 
      <creator id="default1" action="/metrodetection/system_code/logic/action/createDETECTION_ROOM_INFOAction"/>  
      <reader id="default2" action="/metrodetection/system_code/logic/action/myQueryRoomScheduleLeftName"/>  
      <writer id="default3" action="/metrodetection/system_code/logic/action/saveDETECTION_ROOM_INFOAction"/> 
    </data> 
  </xforms:model>  
  <xui:view id="rootView" auto-load="true"> 
    <view id="vSchedule"> 
      ...
      <xhtml:div component="/UI/system/components/windowReceiver.xbl.xml#windowReceiver"
        id="windowReceiver1" style="top:163px;left:119px;" onReceive="RoomSchedule1.windowReceiver1Receive">
      </xhtml:div>
      </xhtml:div>  
    </view>  
    <layout style="height:100%;"> 
      <xhtml:div id="tabpanel1" style="height:100%;width:100%"> 
  ...
  <resource id="resource1"> 
    <xhtml:script id="htmlScript1" src="RoomSchedule1.js"/>  
