<window 
  ...
  <div id="borderLayout1" xui:update-mode="delete"/>
   <xforms:model id="mdDefault" style="width:208px;top:224px;height:auto;left:832px;"  xui:update-mode="merge"/>
...
<![CDATA[bizActivity4.mdDefaultLoad(event)]]>
</xforms:script>
</xforms:action>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-tabPanel" component="/UI/system/components/tabs.xbl.xml#tabs" id="tabPanel4_9" style="position:absolute;position:absolute;height:621px;left:5px;top:47px;width:1200px;" >
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage7_9" xforms-select="bizActivity4.tabPage7_9Select" >
...
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage1_2" xforms-select="bizActivity4.tabPage1_2Select" >
...
<xui:tab xmlns:xui="http://www.justep.com/xui" id="tabPage1_8" xforms-select="bizActivity4.tabPage1_8Select" >
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="windowDialog2" id="controlPlace5_1" style="position:absolute;left:375px;top:193px;" />
</layout>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/toolbars.xbl.xml#toolbars" id="tbsMain" >
<xui:bar xmlns:xui="http://www.justep.com/xui" component="/UI/system/components/bar.xbl.xml#navigatorBar" data="pData" id="navigatorBar1" mode="IMG_TXT_LR" >
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" class="xui-autofill" component="/UI/system/components/select.xbl.xml#gridSelect" ext-separator="," id="gridSelect5_24" label-separator="," onCloseup="bizActivity4.gridSelect5_24Closeup" ref="data('pData')/tESTSCHEMEID" value-separator="," >
...
<![CDATA[bizActivity4.triggerOutClick(event)]]>
</xforms:script>
</xforms:action>
</xforms:trigger>
...
<![CDATA[bizActivity4.triggerinputClick(event)]]>
</xforms:script>
</xforms:action>
</xforms:trigger>
</xui:view>
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/grid.xbl.xml#grid" data="vData" delay="false" id="grid13_2" show-header-menu="hide-column,save-layout,group-column,adjust-column" smart-render="0" >
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn2_1" label="序号" ref="calculate0" show-index="true" type="ed" width="74px" />
<xui:column xmlns:xui="http://www.justep.com/xui" align="center" id="gridColumn5_1" label="检测任务" ref="tASKID" type="ed" width="65px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn38_2" label="测试用例名称" ref="tESTCASENAME" type="tree" width="251px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn4_1" label="检测方面" readonly="true" ref="rANGENAME" type="ed" width="100px" />
<xui:column xmlns:xui="http://www.justep.com/xui" id="gridColumn6_1" label="检测对象" readonly="true" ref="dETOBJNAME" type="ed" width="100px" />
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="radio2_1" id="controlPlace3_1" style="position:absolute;top:15px;left:240px;" />
...
bizActivity4.trigger9_1Click(event)</xforms:script>
</xforms:action>
</xforms:trigger>
</xui:view>
...
<xui:place xmlns:xui="http://www.justep.com/xui" control="grid1_10" id="controlPlace1_10" style="position:absolute;top:8px;left:5px;height:100%;width:98%;" />
</layout>
...
<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml" component="/UI/system/components/windowDialog.xbl.xml#windowDialog" height="180px" id="windowDialog2" modal="true" onClose="bizActivity4.windowDialog2Close" title="" url="/UI/metrodetection/detection_Process_Related/process/detectionManager/importMppDialog.w" width="400px" />
</xui:view>
   ...
   <place id="controlPlace7" style="width:24px;top:229px;left:893px;"  xui:update-mode="merge"/>
    ...
    <xhtml:script xmlns:xhtml="http://www.w3.org/1999/xhtml" id="htmlScript1_4" src="planJS.js" xui:parent="rsMain" xui:update-mode="insert" />
