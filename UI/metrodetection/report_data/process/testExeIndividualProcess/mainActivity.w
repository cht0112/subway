...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdDefault" style="width:143px;top:151px;height:auto;left:88px;"> 
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData"
      concept="TEST_TASK_EXECUTE_INDIVIDUAL" direct-delete="true" id="dataMain" limit="20"
      offset="0" update-mode="whereVersion" filter-relations="rEPORTDATE,sUBTESTCASEPASS,sUBTESTCASEFAILED,sUBTESTCASEBLOCKED,aCTUALSUBTESTCASETIME,pROJECTNAME,tESTCASENAME,pLANOPERATORID"> 
      <creator action="/metrodetection/system_code/logic/action/createTEST_TASK_EXECUTE_INDIVIDUALAction"
        id="default1"/>  
      <reader action="/metrodetection/system_code/logic/action/myQueryTestTaskExeIndividualAction"
        id="default2"/>  
      <writer action="/metrodetection/system_code/logic/action/saveTEST_TASK_EXECUTE_INDIVIDUALAction"
        id="default3"/> 
    </data> 
  </xforms:model>  
  <xui:view auto-load="true" id="rootView"> 
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dataMain"
      ...
      <column id="default4" label="上报日期" ref="rEPORTDATE" type="ed" width="100px"/>  
      <xui:column id="gridColumn1" ref="pROJECTNAME" label="项目名称" type="ed" width="100"/>
      <xui:column id="gridColumn3" ref="pLANOPERATORID" label="计划执行人" type="ed" width="100"/>
      <xui:column id="gridColumn2" ref="tESTCASENAME" label="测试用例名称" type="ed" width="100"/>
      <column id="default8" label="测试子用例成功数" ref="sUBTESTCASEPASS" type="ed" width="100px"/>  
      <column id="default9" label="测试子用例失败数" ref="sUBTESTCASEFAILED" type="ed"
        width="100px"/>  
      <column id="default10" label="测试子用例阻碍数" ref="sUBTESTCASEBLOCKED" type="ed"
        width="100px"/>  
      <column id="default11" label="测试子用例实际总工时数" ref="aCTUALSUBTESTCASETIME" type="ed"
        width="100px"/> 
    </xhtml:div>  
      ...
      <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dataMain"
        ...
        <item id="barItem12"> 
          <xhtml:div class="xui-input" component="/UI/system/components/smartFilter.xbl.xml#smartFilter"
            filter-data="dataMain" filter-relations="rEPORTDATE,pROJECTID,tASKID,tESTCASEID,sUBTESTCASEPASS,sUBTESTCASEFAILED,sUBTESTCASEBLOCKED,aCTUALSUBTESTCASETIME"
            id="smartFilter1"/> 
        </item>  
        <item id="barItem13"> 
