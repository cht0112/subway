...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="mdDefault" style="width:143px;top:151px;height:auto;left:88px;"> 
    <data auto-load="true" component="/UI/system/components/data.xbl.xml#bizData"
      concept="TEST_PROJECT_STAT" direct-delete="true" id="dataMain" limit="20" offset="0"
      update-mode="whereAll" filter-relations="rEPORTDATE,pROJECTDATE,pROJECTNUMBER,sUBTESTCASENUMBER,sUBTESTCASETIME,bUSINESSIDCNAME,dEVICETYPECNAME,bUSINESSSTAGECNAME,mANUFACTUREPOSTCODE"> 
      <creator action="/metrodetection/system_code/logic/action/createTEST_PROJECT_STATAction"
        id="default1"/>  
      <reader action="/metrodetection/system_code/logic/action/myQueryTestProjectStatAction"
        id="default2"/>  
      <writer action="/metrodetection/system_code/logic/action/saveTEST_PROJECT_STATAction"
        id="default3"/> 
    </data> 
  </xforms:model>  
  <xui:view auto-load="true" id="rootView"> 
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" data="dataMain"
      ...
      <column id="default4" label="统计报告日期" ref="rEPORTDATE" type="ed" width="100px"/>  
      <column id="default5" label="立项日期" ref="pROJECTDATE" type="ed" width="100px"/>  
      <xui:column id="gridColumn1" ref="bUSINESSIDCNAME" label="业务类型" type="ed" width="100"/>
      <xui:column id="gridColumn2" ref="dEVICETYPECNAME" label="检测对象" type="ed" width="100"/>
      ...
      <xui:column id="gridColumn4" ref="mANUFACTUREPOSTCODE" label="厂商邮编" type="ed"
        width="100"/>
      <column id="default10" label="项目总数" ref="pROJECTNUMBER" type="ed" width="100px"/>  
      <column id="default11" label="测试子用例数" ref="sUBTESTCASENUMBER" type="ed"
        width="100px"/>  
      <column id="default12" label="测试子用例工时" ref="sUBTESTCASETIME" type="ed" width="100px"/> 
    </xhtml:div>  
      ...
      <xui:bar component="/UI/system/components/bar.xbl.xml#navigatorBar" data="dataMain"
        ...
        <item id="barItem12"> 
          <xhtml:div class="xui-input" component="/UI/system/components/smartFilter.xbl.xml#smartFilter"
            filter-data="dataMain" filter-relations="rEPORTDATE,pROJECTDATE,bUSINESSID,bUSINESSSTAGE,aPPLYFORDEVICETYPE,mANUFACTUREID,pROJECTNUMBER,sUBTESTCASENUMBER,sUBTESTCASETIME"
            id="smartFilter1"/> 
        </item>  
        <item id="barItem13"> 
