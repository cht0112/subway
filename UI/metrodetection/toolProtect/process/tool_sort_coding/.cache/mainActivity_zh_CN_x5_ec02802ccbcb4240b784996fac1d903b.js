				...
				if (filterData) {
					if (typeof(filterData.advanceFilter) != "undefined") {
						...
						if(dialog) {
							...
							if (frameEl) {
								frameEl.dialogId = this.dialogId;
								frameEl.filterData = filterData;			frameEl.callBack = callBack;
								dialog.open();
								return true;
							}
						}
...
_xbl_JSClassDefine_pageNavigator.prototype = justep.Object.extend(new justep.XBLObject(), eval({ 
	...
	var ids=[{id:'window', name:'/UI/system/components/window.xbl.xml#window', children:[{id:'borderLayout1', name:'/UI/system/components/borderLayout.xbl.xml#borderLayout', children:[{id:'tbsMain', name:'/UI/system/components/toolbars.xbl.xml#toolbars', children:[{id:'fbcd09fffdd84f1a873614dae4eaf821', name:'/UI/system/components/pageNavigator.xbl.xml#pageNavigator'}]},{id:'grdMain', name:'xforms:grid'}]},{id:'filter-pattern-1891b856-9ddc-44ef-9a4e-9f494d4deefd', name:'/UI/system/components/bizDataFilterPattern.xbl.xml#bizDataFilterPattern', children:[{id:'6a3d4e7af3f44bf091d40df7f34c57a6', name:'/UI/system/components/menu.xbl.xml#menu', children:[{id:'GLOBAL_ID_N1095481158', name:'xforms:menu'}]},{id:'GLOBAL_ID_N1971399987', name:'xforms:dialog'}]},{id:'filter-dialog-39e1ddf8-2a5e-47bb-917c-367aa3089086', name:'/UI/system/components/bizDataFilterDialog.xbl.xml#bizDataFilterDialog', children:[{id:'GLOBAL_ID_1031565075', name:'xforms:dialog'}]}]}]; 
justep.XBLObject.initXBL(ids);
}; 
xforms.Core.fileName='form.js';	
xf._a(null,'grdMain');function init() {	
...
var xf_menu_GLOBAL_ID_N1095481158 = new xforms.XFMenu('GLOBAL_ID_N1095481158','context');xf_menu_GLOBAL_ID_N1095481158.menu.addContextZone('6a3d4e7af3f44bf091d40df7f34c57a6');xforms.Event.attach(document.body, "click", function(){xf_menu_GLOBAL_ID_N1095481158.hide()});xf_menu_GLOBAL_ID_N1095481158.menu.setOpenMode('web');	
var xf_action_xf_action_0=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){									var menuItemId = event.getData().itemId;									if (menuItemId == "glglms") {										var dialog = xforms("GLOBAL_ID_N1971399987");										if(dialog) {											event.getData().menuitem.dhtmlxMenu.$needLoad=true;											dialog.open();																					}									} else if (menuItemId == "qkdqgl") {										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.clear();										data.filters.deleteFilter(data.advanceFilter.filterName);										data.refreshData();									} else if (menuItemId == "zdycx"){										var dlgId = event.getData().menuitem.dhtmlxMenu.filterDlgId;										var dataId = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(dataId) == "object") {											dataId = dataId.id;										}										if(dlgId) justep.xbl(dlgId).show(dataId);									} else {										var advanceFilter = generateFilterText(event.getData().menuitem.filterExpr);										var data = event.getData().menuitem.dhtmlxMenu.filterData;										if (typeof(data) == "string") {											data = justep.xbl(data);										}										data.advanceFilter.setFilter(advanceFilter, true, true);									}}));xf._p(justep('GLOBAL_ID_N1095481158'),"DOMActivate",null,function(evt) { xforms.run(xf_action_xf_action_0,'GLOBAL_ID_N1095481158', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_N1971399987',"过滤模式",'modal',true,false,true,true,false,null,'550','440',null,null,null,null);	
var xf_action_xf_action_1=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N596128342');									if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.body) {										iframe.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";									}justep.Request.callURL("/system/components/bizDataFilterPattern/bizDataFilterPattern.w?process=/SA/filterPattern/filterPatternProcess&activity=mainActivity", "GLOBAL_ID_N596128342", "");}));xf._p(justep('GLOBAL_ID_N1971399987'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_1,'GLOBAL_ID_N1971399987', evt,false)});	
var xf_action_xf_action_2=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var iframe = document.getElementById('GLOBAL_ID_N596128342');									if (iframe) {										var data = iframe.currData;										data.advanceFilter.setFilter(iframe.advanceFilter);									}}));xf._p(justep('GLOBAL_ID_N1971399987'),"xforms-dialog-close",null,function(evt) { xforms.run(xf_action_xf_action_2,'GLOBAL_ID_N1971399987', evt,false)});	
new xforms.XFDialog('GLOBAL_ID_1031565075',"查询对话框",'modal',true,false,true,true,false,null,'490','340',null,null,null,null);	
var xf_action_xf_action_3=xf._n(null,null,null,null,false).add(xf._o(null,null,function(element, ctx, event){var frameEl = justep('GLOBAL_ID_662863948');									if (frameEl) {										if(frameEl.contentWindow.document.body){											frameEl.contentWindow.document.body.innerHTML = "<table width='100%' height='100%'><tr><td align='center' style='font-size: 12px'>正在载入页面，请稍候......</td></tr></table>";										}										}justep.Request.callURL("/system/components/bizDataFilterDialog/bizDataFilterDialog.w", "GLOBAL_ID_662863948", "");}));xf._p(justep('GLOBAL_ID_1031565075'),"xforms-dialog-open",null,function(evt) { xforms.run(xf_action_xf_action_3,'GLOBAL_ID_1031565075', evt,false)});	
...
xf._c('xf-bind-1','mdDefault',"instance('oakind')/version","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-2','mdDefault',"instance('oakind')/fLevel","xsd:integer",null,null,null,null,null,null);	
xf._c('xf-bind-3','mdDefault',"instance('oakind')/fCreateTime","xsd:dateTime",null,null,null,null,null,null);	
xf._c('xf-bind-4','mdDefault',"instance('oakind')/fUpdateTime","xsd:dateTime",null,null,null,null,null,null);	
...
xf._c('xf-bind-5','mdDefault',"instance('toolsChangeRecords')/CHANGE_DATE","xsd:dateTime",null,null,null,null,null,null);	
if(callback)callback();}	
...
new xforms.XFGrid({id:'grdMain',instance:'dataMain',systemColumnsPro:'version',onInit:null,type:'grid',smartRender:null,delay:false,ids:'nUMSCODE,tOOLCATEGORYCNAME,tOOLCATEGORYENAME,space-column',headNames:'编码,工具分类,英文名称,&nbsp;',widths:'100,100,100,*',types:'ed,ed,ed,ro',hiddenColumns:'',aligns:',,,',serverSort:true,sorts:'na,na,na,na',fixColumnSize:null,nodeImgCallback:'',multiSelection:'',checkedRef:'',filters:'\u00A0,\u00A0,\u00A0,\u00A0',sysColumns:'',treeColumnReadonly:true,showTreeIndex:null,editMode:null,filterColumn:true,drag:null,beforeDragCallback:null,afterDragCallback:null,afterFillRowCallback:null,beforeIndexChangedCallback:null,afterIndexChangedCallback:null,contextMenuId:null,rightClickSelected:'true',rightClickCallback:null,allowCheckCallback:null,rowHeight:null,hdrRowH:null,hdrFilterH:null,moveColumn:null,rowValueChangedCallback:null,groupColumn:true,adjustColumn:true,saveColumn:true,showHeaderMenu:'hide-column,save-layout,group-column,adjust-column',hintCallback:null,cascade:null,hasChildrenCallback1:null,onRowCheck:null,onRowChecked:null,onRowCheckedAll:null,onRowExpand:null,onRowClick:null,onRowDblClick:null,onLastEditorPressEnter:null,initFun:function(){}});	
}	
