...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myIndexSystemValueProcedure" code-model="/metrodetection/testing_standard/logic/code" code="Testing_standard.myIndexSystemValue"> 
  ...
  <procedure name="myIndexValueProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myIndexValue"> 
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
