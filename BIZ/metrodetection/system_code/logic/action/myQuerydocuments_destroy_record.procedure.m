...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myQuerydocuments_destroy_recordProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQuerydocuments_destroy_record"> 
