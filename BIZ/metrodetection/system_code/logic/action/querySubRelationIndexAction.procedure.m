...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="querySubRelationIndexProcedure" code-model="/metrodetection/system_code/logic/code"
    code="Testing_standard.querySubRelationIndex"> 
  ...
  <procedure name="querySubCaseRelationIndexProcedure" code-model="/metrodetection/system_code/logic/code"
    code="Testing_standard.querySubCaseRelationIndex"> 
    <parameter name="range" type="List"/>  
    <parameter name="concept" type="String"/>  
    <parameter name="select" type="String"/>  
    <parameter name="from" type="String"/>  
