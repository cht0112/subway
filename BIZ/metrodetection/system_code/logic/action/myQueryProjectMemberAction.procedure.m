...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myQueryProjectMemberProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryProjectMember"> 
  ...
  <procedure name="myQueryProjectMemberForPlanProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryProjectMemberForPlan"> 
    <parameter name="range" type="List"/>  
    <parameter name="concept" type="String"/>  
    <parameter name="select" type="String"/>  
    <parameter name="from" type="String"/>  
  ...
  <procedure name="myQueryProjectMemberActionForSelProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryProjectMemberActionForSel">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
