...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myQuerySampleDeviceInfoProcedure" code-model="/metrodetection/system_code/logic/code" code="Asset_information.myQuerySampleDeviceInfo"> 
  ...
  <procedure name="myQuerySampleDeviceInfozfProcedure" code-model="/metrodetection/system_code/logic/code" code="Asset_information.myQuerySampleDeviceInfozf">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
