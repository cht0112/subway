...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryRoomOccupyProcedure" code-model="/metrodetection/system_code/logic/code"
    code="Detection_Process_Related.queryRoomOccupy"> 
  ...
  <procedure name="querytoolOccupyProcedure" code-model="/metrodetection/system_code/logic/code"
    code="Detection_Process_Related.querytoolOccupy"> 
    <parameter name="range" type="List"/>  
    <parameter name="concept" type="String"/>  
    <parameter name="select" type="String"/>  
    <parameter name="from" type="String"/>  
