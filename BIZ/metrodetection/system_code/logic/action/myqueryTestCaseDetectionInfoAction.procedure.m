...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myqueryTestCaseDetectionInfoProcedure" code-model="/metrodetection/system_code/logic/code" code="indexCase.myqueryTestCaseDetectionInfo"> 
  ...
  <procedure name="myQueryTestCaseDetectionObjectProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryTestCaseDetectionObject"> 
    <parameter name="range" type="List"/>  
    <parameter name="concept" type="String"/>  
    <parameter name="select" type="String"/>  
    <parameter name="from" type="String"/>  
  ...
  <procedure name="myQueryTestCaseDetectionDeviceProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryTestCaseDetectionDevice"> 
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
