...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="testSchemeProcessQueryReportProcedure" code-model="/metrodetection/system_code/logic/code" code="testScheme.testSchemeProcessQueryReport"> 
    <parameter name="sFlowID" type="String"/>
  </procedure>  
  <procedure name="testSchemeProcessQueryProcedure" code-model="/metrodetection/system_code/logic/code" code="testScheme.testSchemeProcessQuery"> 
