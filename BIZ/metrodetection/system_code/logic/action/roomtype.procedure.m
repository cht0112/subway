...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="newAction_0Procedure" code-model="/metrodetection/system_code/logic/code" code="System_resource.newAction_0"> 
  ...
  <procedure name="roomtypeProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.roomtype"> 
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
