...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryDetectionCaseInfoProcedure" code-model="/metrodetection/system_code/logic/code" code="QueryTestCaseForView.queryDetectionCaseInfo"> 
  ...
  <procedure name="queryDetectionCaseInfoModifyProcedure" code-model="/metrodetection/system_code/logic/code" code="QueryTestCaseForView.queryDetectionCaseInfoModify">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
