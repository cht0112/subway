...
<action name="myQueryScheduleRoomOccupyAction" global="false" procedure="myQueryScheduleRoomOccupyProcedure">
<label language="zh_CN">自建查询房间占用信息</label>
    <permission name="range" type="List"/>  
    <private name="concept" type="String" value="ROOM_OCCUPY_INFO"/>  
    <private name="select" type="String" value="ROOM_APPLY_INFO,DETECTION_ROOM_INFO,DETECTION_ROOM_INFO.rOOMCNAME as rOOMCNAME,ROOM_APPLY_INFO.rOOMAREA as rOOMAREA,ROOM_OCCUPY_INFO.tESTTASKID as tESTTASKID,ROOM_OCCUPY_INFO.oCCUPYSTARTDATETIME as oCCUPYSTARTDATETIME,ROOM_OCCUPY_INFO.oCCUPYENDDATETIME as oCCUPYENDDATETIME,TEST_PROJECT_INFO.pROJECTNAME as pROJECTNAME,DETECTION_OBJECT_TYPE.dETECTIONOBJECTCNAME as dETECTIONOBJECTCNAME,DEVICE_TYPE_CODE.dEVICETYPECNAME as dEVICETYPECNAME,DETECTION_RANGE_TYPE.dETECTIONRANGECNAME as dETECTIONRANGECNAME,ROOM_TYPE_CODE.rOOMTYPECNAME as rOOMTYPECNAME,DETECTION_ROOM_INFO.iMAGE as iMAGE,case when ROOM_APPLY_INFO.iMAGE is null then '0' else '1' end  as im"/>  
