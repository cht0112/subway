...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryDectionStandardInfoProcedure" code-model="/metrodetection/system_code/logic/code" code="Testing_standard.queryDectionStandardInfo"> 
  ...
  <procedure name="queryDectionStandardMidProcedure" code-model="/metrodetection/system_code/logic/code" code="Testing_standard.queryDectionStandardMid">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
