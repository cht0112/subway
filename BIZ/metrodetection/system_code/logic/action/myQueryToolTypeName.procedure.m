...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myQueryToolTypeNameProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryToolTypeName"> 
  ...
  <procedure name="myQueryToolTypeNamezfProcedure" code-model="/metrodetection/system_code/logic/code" code="System_code.myQueryToolTypeNamezf">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
