...
<action name="detectionProcessQueryAction" global="false" procedure="detectionProcessQueryProcedure"><label language="zh_CN">自定义检测流程查询</label>
		...
		<protected name="condition" type="String" value="SA_Task.sParent is null AND SA_Task.sTypeName = '检测流程'"/>
