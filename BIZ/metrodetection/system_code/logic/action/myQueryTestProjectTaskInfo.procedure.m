...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryTestProJectTaskInfoProcedure" code-model="/metrodetection/system_code/logic/code" code="Detection_Process_Related.queryTestProJectTaskInfo"> 
