...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="select_sampleProcedure" code-model="/metrodetection/system_code/logic/code" code="Asset_information.select_sample"> 
  ...
  <procedure name="select_taskProcedure" code-model="/metrodetection/system_code/logic/code" code="Asset_information.select_task">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
