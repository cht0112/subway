...
<model xmlns="http://www.justep.com/model">
  ...
  <concept name="SA_DocNode" default-value-expr="guid()">
    ...
    <has-relation relation="sSequence" data-type="String"><label language="zh_CN">序号</label></has-relation>
...
<has-relation relation="sCacheName" data-type="String"></has-relation>
<has-relation relation="sRevisionCacheName" data-type="String"></has-relation>
</concept>
...
<has-relation relation="sDefineItems" data-type="Text"><label language="zh_CN">文档关联定义</label>
</has-relation>

<has-relation relation="sDisplayName"><label language="zh_CN">关联名</label>
</has-relation>
</concept>
  <concept name="SA_DocActivityAuth" default-value-expr="guid()">
    <has-relation relation="sProcess"/>
    <has-relation relation="sDocLinkDefineID"/>
    <has-relation relation="sActivity"/>
    <has-relation relation="sAccess" default-value-expr="1"/>
    <has-relation relation="sLimitSize" default-value-expr="0.0"/>
    <has-relation relation="version" default-value-expr="0"/>
  <label language="zh_CN">文档Activity权限</label>
</concept>
  <concept name="SA_DocActivityTemplate" default-value-expr="guid()">
    <has-relation relation="sDocLinkDefineID"/>
    <has-relation relation="sDocID"/>
    <has-relation relation="sDocName"/>
    <has-relation relation="version" default-value-expr="0"/>
  <label language="zh_CN">文档Activity模板</label>
</concept>
  ...
  <concept name="SA_DocActivityTemplateField" default-value-expr="guid()">
    <has-relation relation="sDocLinkDefineID"/>
    <has-relation relation="sFieldID"/>
    <has-relation relation="sFieldName"/>
    <has-relation relation="version" default-value-expr="0"/>
  <label language="zh_CN">文档Activity域</label>
</concept>
...
<has-relation relation="sAccessMode" data-type="String"><label language="zh_CN">访问模式</label>

</has-relation>

<has-relation relation="sUrl" data-type="String" required="false"></has-relation>
</concept>

<relation name="sDefineItems" data-type="Text"><label language="zh_CN">文档关联定义</label>
</relation>

<relation name="sAccessMode" data-type="String"><label language="zh_CN">访问模式</label>
</relation>
<relation name="sCacheName" data-type="String"><label language="zh_CN">文档缓存文件名</label>
</relation>
<relation name="sRevisionCacheName" data-type="String"><label language="zh_CN">文档修订版缓存文件名</label>
</relation>
<relation name="sUrl" data-type="String"><label language="zh_CN">文档服务器地址</label>
</relation>
</model>
