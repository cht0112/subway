...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryDEFECT_TRACK_MODULE_INFOProcedure" code-model="/metrodetection/defect_information/logic/code" code="Defect_information.queryDEFECT_TRACK_MODULE_INFO"> 
  ...
  <procedure name="myQueryDefectModuleAndProductProcedure" code-model="/metrodetection/defect_information/logic/code" code="Defect_information.myQueryDefectModuleAndProduct"> 
    <parameter name="range" type="List"/>  
    <parameter name="concept" type="String"/>  
    <parameter name="select" type="String"/>  
    <parameter name="from" type="String"/>  
  ...
  <procedure name="myQueryMandProjAndProdProcedure" code-model="/metrodetection/defect_information/logic/code" code="Defect_information.myQueryMandProjAndProd">
    <parameter name="range" type="List"/>
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
