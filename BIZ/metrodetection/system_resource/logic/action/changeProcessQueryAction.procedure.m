...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="complaintProcessQueryProcedure" code-model="/metrodetection/system_resource/logic/code" code="System_resource.complaintProcessQuery"> 
  ...
  <procedure name="changeProcessQueryProcedure" code-model="/metrodetection/system_resource/logic/code" code="System_resource.changeProcessQuery">
    <parameter name="concept" type="String"/>
    <parameter name="idColumn" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
