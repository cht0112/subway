...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="myQueryComplaintFeedAndHRProcedure" code-model="/metrodetection/customer_service/logic/code" code="Customer_service.myQueryComplaintFeedAndHR">
