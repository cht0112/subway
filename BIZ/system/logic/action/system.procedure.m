...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  ...
  <procedure name="getActivationPackageProcedure" code-model="/system/logic/code"
    code="SystemProcedure.getActivationPackage"/>  
  <procedure name="getActivationTimeProcedure" code-model="/system/logic/code" code="SystemProcedure.getActivationTime"/>  
  <procedure name="regActivationPackageProcedure" code-model="/system/logic/code"
    code="SystemProcedure.regActivationPackage"> 
