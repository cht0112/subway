...
<model xmlns="http://www.justep.com/model">  
  ...
  <concept name="SA_OPOrg" default-value-expr="guid()"> 
    ...
    <has-relation relation="sParent" data-type="SA_OPOrg"><label language="zh_CN">父节点</label>
</has-relation>  
    <has-relation relation="sChildren" single-valued="false" data-type="SA_OPOrg"><label language="zh_CN">子节点</label>
</has-relation>  
...
<concept name="SA_OrgLevel" default-value-expr="guid()"><has-relation relation="version" default-value-expr="0"><label language="zh_CN">版本</label>
</has-relation>
