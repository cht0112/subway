...
(
  ...
  sOtherSideUrl   VARCHAR2(512),
  sOpmUrl         VARCHAR2(512),
  version         INTEGER not null
);
...
(
  ...
  sPerson   VARCHAR2(36) not null,
  sProcess  VARCHAR2(1024) not null,
  sActivity VARCHAR2(1024) not null,
...
(
  ...
  sOrgFID          VARCHAR2(1024) not null,
  sOrgFName        VARCHAR2(1024),
  sCreatorID       VARCHAR2(65) not null,
  sCreatorName     VARCHAR2(128),
  sCreatorFID      VARCHAR2(1024) not null,
  sCreatorFName    VARCHAR2(1024),
  sCreateTime      DATE,
  sResourceID 	   VARCHAR2(1024) not null,
