...
CREATE TABLE [dbo].[SA_ChatPromission] (
	...
	[sOtherSideUrl] [nvarchar] (512)  NULL ,
	[sOpmUrl] [nvarchar] (512)  NULL ,
	[version] [int] NOT NULL 
) 
...
CREATE TABLE [dbo].[SA_FilterPattern] (
	...
	[sActivity] [nvarchar] (1024)  NOT NULL ,
...
CREATE TABLE [dbo].[SA_OPManagement] (
	...
	[sManageOrgFID] [nvarchar] (2048)  NOT NULL ,
	[sManageOrgFName] [nvarchar] (2048)  NULL ,
...
CREATE TABLE [dbo].[SA_ProcessControl] (
	...
	[sProcess] [nvarchar] (1024)  NULL ,
	sProcessTemplateID2 VARCHAR(32)   NULL,
...
--create index IDX_PC_INDEX on SA_ProcessControl (sProcess, sProcessTemplateID2, sActivity, sAction, sOperatorID);
...
CREATE TABLE [dbo].[SA_Task] (
	...
	[sExecutorFID] [nvarchar] (1024)  NULL ,
	...
	[sWorkTime] [int] NULL ,
	[sVersionNumber] [nvarchar] (64)  NULL ,
	[sSequence] [int] NULL ,
...
--create index IDX_CHATPROMISSION_OPM_OTHER_URL on SA_ChatPromission (sOpmUrl, sOtherSideUrl)
...
(
	...
	[sActivityName] [nvarchar] (128)  NULL ,
	[sAction] [nvarchar] (128)  NULL ,
	[sDeviceType] [nvarchar] (64)  NULL ,
	[sOperatingSystem] [nvarchar] (64)  NULL ,
	[sActionName] [nvarchar] (128)  NULL ,
	[sParameters]    [text] NULL ,
	[sResult]    [text] NULL ,
...
--create index IDX_LOG_CN on SA_Log (sCreatorPersonName)
--create index IDX_LOG_ACTIVITYN on SA_Log (sActivityName)
--create index IDX_LOG_ACTIONN on SA_Log (sActionName)
--create index IDX_LOG_TYPE on SA_Log (sTypeName)
