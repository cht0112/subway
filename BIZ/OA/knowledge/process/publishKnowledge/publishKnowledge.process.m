...
<model xmlns="http://www.justep.com/model">  
  <process name="publishKnowledgeProcess" start="start1" end="end1"> 
    ...
    <has-action action="queryOA_Pub_FirstKeyWordAction" access-permission="public"/>  
    <has-action action="queryOA_Pub_SencondKeyWordAction" access-permission="public"/>  
    <has-action action="queryOA_Pub_EndKeyWordAction" access-permission="public"/>  
