...
<model xmlns="http://www.justep.com/model">
	...
	<concept name="SA_Task">
		...
		<has-relation relation="sData1" ><label language="zh_CN">单据号</label>
</has-relation>
...
<has-relation relation="sESField05" data-type="String"><label language="zh_CN">申请单据号</label>
</has-relation>
...
<has-relation relation="sProcessTemplateID2" data-type="SA_ProcessTemplate"><label language="zh_CN">父任务</label>
</has-relation>
