<model xmlns="http://www.justep.com/model"
	...
	<procedure name="queryWaitTask2Procedure"
		code-model="/SA/task/logic/code"
		code="TaskViewProcedure.queryWaitTask2">
	...
	<procedure name="querySubmitTask2Procedure"
		code-model="/SA/task/logic/code"
		code="TaskViewProcedure.querySubmitTask2">
		<parameter name="concept" type="String"/>
		<parameter name="idColumn" type="String"/>
		<parameter name="select" type="String"/>
		<parameter name="from" type="String"/>
