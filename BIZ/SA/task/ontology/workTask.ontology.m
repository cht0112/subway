<model xmlns="http://www.justep.com/model">
	<concept name="SA_WorkTask" default-value-expr="guid()">
		<label language="zh_CN">工作任务</label>
		<has-relation relation="sName" default-value-expr="'新建工作任务'"/>
		<has-relation relation="sProcess" default-value-expr="'/SA/task/workTask/workTaskProcess'"/>
		...
		<has-relation relation="sTypeName" default-value-expr="'工作任务'"/>
		...
		<has-relation relation="sCURL" default-value-expr="'/SA/task/workTask/useActivity.w'"/>
		<has-relation relation="sEURL" default-value-expr="'/SA/task/workTask/useActivity.w'"/>
