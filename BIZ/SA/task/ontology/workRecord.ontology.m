<model xmlns="http://www.justep.com/model">
	<concept name="SA_WorkRecord" default-value-expr="guid()">
		<label language="zh_CN">工作记录</label>
		<has-relation relation="sName" default-value-expr="'新建工作记录'"/>
		<has-relation relation="sProcess" default-value-expr="'/SA/task/workRecord/workRecordProcess'"/>
		...
		<has-relation relation="sTypeName" default-value-expr="'工作记录'"/>
		...
		<has-relation relation="sStatusID" data-type="SA_TaskStatus" default-value-expr="'tesFinished'">
			<label language="zh_CN">状态</label>
		</has-relation>
		<has-relation relation="sStatusName" default-value-expr="'已完成'">
			<label language="zh_CN">状态</label>
		</has-relation>
		...
		<has-relation relation="sCURL" default-value-expr="'/SA/task/workRecord/useActivity.w'"/>
		<has-relation relation="sEURL" default-value-expr="'/SA/task/workRecord/useActivity.w'"/>
