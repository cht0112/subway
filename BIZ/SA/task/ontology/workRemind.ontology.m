<model xmlns="http://www.justep.com/model">
	<concept name="SA_WorkRemind" default-value-expr="guid()">
		...
		<has-relation relation="sCURL" default-value-expr="'/SA/task/workRemind/useActivity.w'"/>
		<has-relation relation="sEURL" default-value-expr="'/SA/task/workRemind/useActivity.w'"/>
