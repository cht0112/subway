...
public class AttachmentDefine {
	...
	public static Map<String, Object> queryLinkDefineMap(String linkProcess, String linkActivity) throws DocumentException, JSONException {
		...
		for (Iterator<?> it = keys.iterator(); it.hasNext();) {
			...
			itemJson.put("rootName", DocUtils.getNodeText(key.selectSingleNode("rootName")));
			itemJson.put("rootPath", DocUtils.getNodeText(key.selectSingleNode("rootPath")));
			itemJson.put("subPath", DocUtils.getNodeText(rootElement.selectSingleNode("subPath")));
			itemJson.put("access", DocUtils.getNodeText(key.selectSingleNode("access")));
			itemJson.put("limitSize", DocUtils.getNodeText(key.selectSingleNode("limitSize")));
