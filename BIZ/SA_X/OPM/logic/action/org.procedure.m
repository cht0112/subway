...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  ...
  <procedure name="changePersonMainOrgProcedure" code-model="/SA/OPM/logic/code" code="OrgProcedure.changePersonMainOrg"> 
    <parameter name="id" type="String"/>  
    <parameter name="version" type="Integer"/>  
  ...
  <procedure name="physicalDeletePersonProcedure" code-model="/SA/OPM/logic/code" code="OrgProcedure.physicalDeletePerson"> 
    <parameter name="id" type="String"/>  
    <parameter name="version" type="Integer"/> 
  </procedure>  
